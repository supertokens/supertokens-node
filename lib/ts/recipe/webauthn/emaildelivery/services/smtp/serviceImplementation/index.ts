...
import getRecoverAccountEmailContent from "../recoverAccount";
...
export function getServiceImplementation(
    ...
    return {
        ...
        getContent: async function (
            input: TypeWebauthnEmailDeliveryInput & { userContext: UserContext }
        ): Promise<GetContentResult> {
            return getRecoverAccountEmailContent(input);
        },
    };
}
