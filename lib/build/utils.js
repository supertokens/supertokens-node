...
function getDataFromFileIfExists(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
exports.getDataFromFileIfExists = getDataFromFileIfExists;
function storeIntoTempFile(filePath, data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield createTempDirIfNotAlreadyExists();
            yield new Promise((resolve, reject) =>
                __awaiter(this, void 0, void 0, function* () {
                    fs_1.writeFile(filePath, JSON.stringify(data), (err) => {
                        resolve(undefined);
                    });
                })
            );
...
exports.storeIntoTempFile = storeIntoTempFile;
function createTempDirIfNotAlreadyExists() {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.createTempDirIfNotAlreadyExists = createTempDirIfNotAlreadyExists;
...
function removeTempFiles() {
    return __awaiter(this, void 0, void 0, function* () {
        let tempFilesPath = [constants_1.API_VERSION_FILE_PATH, constants_2.HANDSHAKE_INFO_FILE_PATH];
