...
exports.isBuffer = exports.decodeBase64 = exports.encodeBase64 = exports.isTestEnv = exports.getBuffer = exports.getProcess = exports.doFetch = void 0;
...
function normaliseInputAppInfoOrThrowError(appInfo) {
    ...
    let apiGatewayPath = appInfo.apiGatewayPath !== undefined
        ? new normalisedURLPath_1.default(appInfo.apiGatewayPath)
        : new normalisedURLPath_1.default("");
    if (appInfo.origin === undefined && appInfo.websiteDomain === undefined) {
        throw new Error("Please provide either origin or websiteDomain inside the appInfo object when calling supertokens.init");
    }
    ...
    return {
        ...
        apiDomain,
        apiBasePath: apiGatewayPath.appendPath(appInfo.apiBasePath === undefined
            ? new normalisedURLPath_1.default("/auth")
            : new normalisedURLPath_1.default(appInfo.apiBasePath)),
        websiteBasePath: appInfo.websiteBasePath === undefined
            ? new normalisedURLPath_1.default("/auth")
...
function getBackwardsCompatibleUserInfo(req, result, userContext) {
    ...
    if ((hasGreaterThanEqualToFDI(req, "1.18") && !hasGreaterThanEqualToFDI(req, "2.0")) ||
        ...
        let loginMethod = result.user.loginMethods.find((lm) => lm.recipeUserId.getAsString() === result.session.getRecipeUserId(userContext).getAsString());
...
function applyPlugins(recipeId, config, plugins) {
    ...
    let functionLayers = [(_a = config.override) === null || _a === void 0 ? void 0 : _a.functions];
    let apiLayers = [(_b = config.override) === null || _b === void 0 ? void 0 : _b.apis];
