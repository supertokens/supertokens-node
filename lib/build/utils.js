...
const cross_fetch_2 = __importDefault(require("cross-fetch"));
const doFetch = (...args) => {
    if (typeof cross_fetch_1.default !== "undefined") {
        return cross_fetch_1.default(...args);
    }
    return cross_fetch_2.default(...args);
};
...
function postWithFetch(url, headers, body, { successLog, errorLogHeader }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let resp;
        try {
            const fetchResp = yield exports.doFetch(url, {
                method: "POST",
