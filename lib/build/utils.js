...
exports.isBuffer = exports.decodeBase64 = exports.encodeBase64 = exports.isTestEnv = exports.getBuffer = exports.getProcess = void 0;
...
function getTopLevelDomainForSameSiteResolution(url) {
    ...
    if (hostname.startsWith("localhost") || hostname.startsWith("localhost.org") || (0, normalisedURLDomain_1.isAnIpAddress)(hostname)) {
