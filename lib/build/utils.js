...
function getIsHeaderPreferredFromRequestHeaders(req) {
    var _a;
    ...
    return (
        ((_a = req.getHeaderValue(constants_1.HEADER_RID)) === null || _a === void 0 ? void 0 : _a.split(";")[1]) ===
        "header"
    );
}
exports.getIsHeaderPreferredFromRequestHeaders = getIsHeaderPreferredFromRequestHeaders;
function getRidFromHeader(req) {
    ...
    var _a;
    return (_a = req.getHeaderValue(constants_1.HEADER_RID)) === null || _a === void 0 ? void 0 : _a.split(";")[0];
}
