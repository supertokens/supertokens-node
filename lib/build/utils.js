...
function getAPIVersionFromFileIfExists() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let apiVersionFromFile = yield new Promise((resolve, reject) => {
                fs_1.readFile(constants_1.API_VERSION_FILE_PATH, (err, data) => {
...
exports.getAPIVersionFromFileIfExists = getAPIVersionFromFileIfExists;
function storeAPIVersionInFile(apiVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield new Promise((resolve, reject) => {
                fs_1.writeFile(constants_1.API_VERSION_FILE_PATH, apiVersion, {}, () => {
                    resolve(undefined);
                });
            });
        } catch (err) {}
...
exports.storeAPIVersionInFile = storeAPIVersionInFile;
