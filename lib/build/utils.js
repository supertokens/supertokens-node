...
function updateTenantId(user) {
    if (user.user.thirdParty !== undefined && user.user.thirdParty.userId.includes("|")) {
        return Object.assign(Object.assign({}, user), {
            user: Object.assign(Object.assign({}, user.user), { tenantId: user.user.thirdParty.userId.split("|")[1] }),
        });
    }
    return user;
}
