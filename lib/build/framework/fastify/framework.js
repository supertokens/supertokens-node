...
class FastifyRequest extends request_1.BaseRequest {
    constructor(request) {
        ...
        this.getHeaderValue = (key) => {
            return (0, utils_2.normalizeHeaderValue)((0, utils_1.getFromObjectCaseInsensitive)(key, this.request.headers));
        };
        this.getOriginalURL = () => {
    ...
    constructor(response) {
        ...
        this.setCookie = (key, value, domain, secure, httpOnly, expires, path, sameSite) => {
            ...
            if (oldHeaders === undefined)
                oldHeaders = [];
            else if (!(oldHeaders instanceof Array))
                oldHeaders = [oldHeaders.toString()];
