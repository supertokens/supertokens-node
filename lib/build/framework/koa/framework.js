        ...
        this.getFormData = () =>
            __awaiter(this, void 0, void 0, function* () {
                if (this.parsedUrlEncodedFormData === undefined) {
                    this.parsedUrlEncodedFormData = yield utils_2.parseURLEncodedFormData(this.ctx.req);
                }
        ...
        this.getJSONBody = () =>
            __awaiter(this, void 0, void 0, function* () {
                if (this.parsedJSONBody === undefined) {
                    this.parsedJSONBody = yield utils_2.parseJSONBodyFromRequest(this.ctx.req);
                }
...
const middleware = () => {
    return (ctx, next) =>
        __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                let result = yield supertokens.middleware(request, response, userContext);
                if (!result) {
                    return yield next();
                }
            } catch (err) {
