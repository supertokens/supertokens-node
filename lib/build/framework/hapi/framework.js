...
const plugin = {
    ...
    register: function (server, _) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            server.ext("onPreHandler", (req, h) => __awaiter(this, void 0, void 0, function* () {
            ...
            server.ext("onPreResponse", (request, h) => __awaiter(this, void 0, void 0, function* () {
            ...
            server.decorate("toolkit", "lazyHeaderBindings", function (h, key, value, allowDuplicateKey) {
                ...
                if (value === undefined) {
                    anyApp.lazyHeaders = anyApp.lazyHeaders.filter((header) => header.key.toLowerCase() !== key.toLowerCase());
                }
                else {
