...
function assertForDataBodyParserHasBeenUsedForExpressLikeRequest(request) {
    return __awaiter(this, void 0, void 0, function* () {
        let parser = body_parser_1.urlencoded({ extended: true });
        let err = yield new Promise((resolve) => parser(request, new http_1.ServerResponse(request), resolve));
        if (err !== undefined) {
...
exports.assertForDataBodyParserHasBeenUsedForExpressLikeRequest = assertForDataBodyParserHasBeenUsedForExpressLikeRequest;
