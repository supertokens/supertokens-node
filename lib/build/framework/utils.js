...
exports.serializeCookieValue = exports.getCookieValueToSetInHeader = exports.setCookieForServerResponse = exports.getHeaderForExpressLikeResponse = exports.setHeaderForExpressLikeResponse = exports.assertFormDataBodyParserHasBeenUsedForExpressLikeRequest = exports.assertThatBodyParserHasBeenUsedForExpressLikeRequest = exports.parseURLEncodedFormData = exports.parseJSONBodyFromRequest = exports.normalizeHeaderValue = exports.getHeaderValueFromIncomingMessage = exports.getCookieValueFromIncomingMessage = exports.getCookieValueFromHeaders = void 0;
...
function getHeaderForExpressLikeResponse(res, key) {
    var _a;
    const existingHeaders = res.getHeaders();
    return (_a = existingHeaders[key.toLowerCase()]) === null || _a === void 0 ? void 0 : _a.toString();
}
exports.getHeaderForExpressLikeResponse = getHeaderForExpressLikeResponse;
/**
 *
 * @param res
 * @param name
