...
function setIdRefreshTokenInHeaderAndCookie(res, idRefreshToken, expiry, domain, secure, path) {
 ...
 * @param path
 */
function setCookie(res, name, value, domain, secure, httpOnly, expires, path, sameSite = "none") {
    let opts = {
        domain,
        secure,
        httpOnly,
