...
function init(config) {
    querier_1.Querier.initInstance(config.hosts);
        ...
        if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0") {
            try {
                return Object.assign(Object.assign({}, response), {
                    accessToken: Object.assign(Object.assign({}, response.accessToken), { sameSite: "none" }),
                    refreshToken: Object.assign(Object.assign({}, response.refreshToken), { sameSite: "none" }),
                    idRefreshToken: Object.assign(Object.assign({}, response.idRefreshToken), {
