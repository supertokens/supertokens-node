...
function createNewSession(userId, jwtPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0") {
            try {
                return Object.assign(Object.assign({}, response), { accessToken: Object.assign(Object.assign({}, response.accessToken), { sameSite: "none" }), refreshToken: Object.assign(Object.assign({}, response.refreshToken), { sameSite: "none" }), idRefreshToken: Object.assign(Object.assign({}, response.idRefreshToken), { cookiePath: response.accessToken.cookiePath, cookieSecure: response.accessToken.cookieSecure, domain: response.accessToken.domain, sameSite: "none" }) });
            }
            catch (ignored) { }
        }
        return response;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (handShakeInfo.jwtSigningPublicKeyExpiryTime > Date.now()) {
                let accessTokenInfo = yield accessToken_1.getInfoFromAccessToken(accessToken, handShakeInfo.jwtSigningPublicKey, handShakeInfo.enableAntiCsrf && doAntiCsrfCheck);
                ...
                if (handShakeInfo.enableAntiCsrf &&
                    ...
                    if (antiCsrfToken === undefined) {
                        throw error_1.generateError(error_1.AuthError.TRY_REFRESH_TOKEN, new Error("provided antiCsrfToken is undefined. If you do not want anti-csrf check for this API, please set doAntiCsrfCheck to true"));
                    }
                    else {
        ...
        if (response.status == "OK") {
            ...
            delete response.jwtSigningPublicKey;
            delete response.jwtSigningPublicKeyExpiryTime;
            if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0" && response.accessToken !== undefined) {
                try {
                    return Object.assign(Object.assign({}, response), { accessToken: Object.assign(Object.assign({}, response.accessToken), { sameSite: "none" }) });
                }
                catch (ignored) { }
            }
            return response;
...
function getJWTPayload(sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0") {
            throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("the current function is not supported for the core. Please upgrade the supertokens service."));
        }
