...
exports.getRecoverAccountEmailHTML = void 0;
const supertokens_1 = __importDefault(require("../../../../../supertokens"));
function getRecoverAccountEmailContent(input) {
    let supertokens = supertokens_1.default.getInstanceOrThrowError();
    let appName = supertokens.appInfo.appName;
    let body = getRecoverAccountEmailHTML(appName, input.user.email, input.recoverAccountLink);
    return {
        body,
...
exports.default = getRecoverAccountEmailContent;
function getRecoverAccountEmailHTML(appName, email, resetLink) {
    return `
        <!doctype html>
                                                                        ...
                                                                        <div style="padding-left: 15%; padding-right: 15%;">
                                                                            ...
                                                                            <div class="button-td button-td-primary"
                                                                                ...
                                                                                <a class="button-a button-a-primary"
                                                                                    ...
                                                                                    style="background: #52B56E;font-size: 17px;line-height: 24px;font-weight: 700;font-family: 'Helvetica', sans-serif;text-decoration: none;padding: 9px 25px 9px 25px;color: #ffffff;display: block;border-radius: 6px;width: fit-content;margin: 0 auto;">Recover Account</a>
                                                                            </div>
                                                                        </div>
                                                                        <div
...
exports.getRecoverAccountEmailHTML = getRecoverAccountEmailHTML;
