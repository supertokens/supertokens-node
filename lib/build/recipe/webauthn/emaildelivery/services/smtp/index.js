...
class SMTPService {
    constructor(config) {
        this.sendEmail = async (input) => {
            ...
            await this.serviceImpl.sendRawEmail(Object.assign(Object.assign({}, content), { userContext: input.userContext }));
        };
        ...
        let builder = new supertokens_js_override_1.default((0, serviceImplementation_1.getServiceImplementation)(transporter, config.smtpSettings.from));
