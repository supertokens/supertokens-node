...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    let relyingPartyId = validateAndNormaliseRelyingPartyIdConfig(
        recipeInstance,
        appInfo,
        config === null || config === void 0 ? void 0 : config.relyingPartyId
    );
    let relyingPartyName = validateAndNormaliseRelyingPartyNameConfig(
        recipeInstance,
        appInfo,
        config === null || config === void 0 ? void 0 : config.relyingPartyName
    );
...
function validateAndNormaliseRelyingPartyIdConfig(_, __, relyingPartyIdConfig) {
    return (props) => {
...
function validateAndNormaliseRelyingPartyNameConfig(_, __, relyingPartyNameConfig) {
    return (props) => {
...
function validateAndNormaliseGetOriginConfig(_, __, getOriginConfig) {
    return (props) => {
...
function validateAndNormaliseValidateEmailAddressConfig(_, __, validateEmailAddressConfig) {
