    ...
    const sendPostRequest = async (path, body, _userContext) => {
        ...
        if (path.getAsStringDangerous().includes("/recipe/webauthn/options/register")) {
            ...
            return Object.assign(
                { status: "OK", webauthnGeneratedOptionsId: id, createdAt, expiresAt },
                registrationOptions
            );
            ...
            // @ts-ignore
            return Object.assign({ status: "OK", webauthnGeneratedOptionsId: id, createdAt, expiresAt }, signInOptions);
