...
const getMockQuerier = (recipeId) => {
    ...
    const sendPostRequest = async (path, body, _userContext) => {
        ...
        if (path.getAsStringDangerous().includes("/recipe/webauthn/options/register")) {
            ...
            writeDb("generatedOptions", id, Object.assign(Object.assign({}, registrationOptions), { id, origin: body.origin, tenantId: body.tenantId, email: body.email, rpId: registrationOptions.rp.id, createdAt,
                expiresAt }));
            // @ts-ignore
            return Object.assign({ status: "OK", webauthnGeneratedOptionsId: id, createdAt,
                expiresAt }, registrationOptions);
        }
            ...
            const createdAt = now.getTime();
            const expiresAt = createdAt + body.timeout * 1000;
            writeDb("generatedOptions", id, Object.assign(Object.assign({}, signInOptions), { id, origin: body.origin, tenantId: body.tenantId, email: body.email, createdAt,
                expiresAt }));
            // @ts-ignore
            return Object.assign({ status: "OK", webauthnGeneratedOptionsId: id, createdAt,
                expiresAt }, signInOptions);
        }
            ...
            writeDb("credentials", credentialId, {
                ...
                userId: recipeUserId,
                counter: 0,
                publicKey: (_a = registrationVerification.registrationInfo) === null || _a === void 0 ? void 0 : _a.credential.publicKey.toString(),
                rpId: options.rpId,
                transports: (_b = registrationVerification.registrationInfo) === null || _b === void 0 ? void 0 : _b.credential.transports,
