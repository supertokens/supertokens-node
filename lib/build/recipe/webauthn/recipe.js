    ...
    constructor(stInstance, recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, _path, _method, userContext) => {
            ...
            if (id === constants_1.REGISTER_OPTIONS_API) {
                ...
                return await (0, registerCredential_1.default)(
                    this.stInstance,
                    this.apiImpl,
                    tenantId,
                    options,
                ...
                return await (0, listCredentials_1.default)(
                    this.stInstance,
                    this.apiImpl,
                    tenantId,
                    options,
                ...
                return await (0, removeCredential_1.default)(
                    this.stInstance,
                    this.apiImpl,
                    tenantId,
                    options,
        ...
        this.config = (0, utils_1.validateAndNormaliseUserInput)(this, appInfo, config);
        {
            ...
            let builder = new supertokens_js_override_1.default(
                (0, recipeImplementation_1.default)(stInstance, this.querier, getWebauthnConfig)
            );
