...
export default class Wrapper {
    ...
    ): Promise<import("./types").RegisterOptionsResponse>;
    static signInOptions(input: {
        ...
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").SignInOptionsResponse>;
    static getGeneratedOptions(input: {
        webauthnGeneratedOptionsId: string;
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").GetGeneratedOptionsResponse>;
    static signUp(input: {
        webauthnGeneratedOptionsId: string;
        ...
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").SignUpResponse>;
    static signIn(input: {
        webauthnGeneratedOptionsId: string;
        ...
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").SignInResponse>;
    ...
    static generateRecoverAccountToken(input: {
        ...
        email: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").GenerateRecoverAccountTokenResponse>;
    static recoverAccount({
        ...
        | import("./types").RegisterCredentialResponse
    >;
    static consumeRecoverAccountToken(input: {
        tenantId: string;
        token: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").ConsumeRecoverAccountTokenResponse>;
    static registerCredential(input: {
        recipeUserId: string;
        webauthnGeneratedOptionsId: string;
        credential: RegistrationPayload;
        userContext?: Record<string, any>;
    }): Promise<import("./types").RegisterCredentialResponse>;
    ...
    static getUserFromRecoverAccountToken(input: {
        ...
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").GetUserFromRecoverAccountTokenResponse>;
    static removeGeneratedOptions(input: {
        webauthnGeneratedOptionsId: string;
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").RemoveGeneratedOptionsResponse>;
    static removeCredential(input: {
        webauthnCredentialId: string;
        recipeUserId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").RemoveCredentialResponse>;
    static getCredential(input: {
        webauthnCredentialId: string;
        recipeUserId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").GetCredentialResponse>;
    static listCredentials(input: {
        recipeUserId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").ListCredentialsResponse>;
    static updateUserEmail(input: {
        email: string;
        recipeUserId: string;
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").UpdateUserEmailResponse>;
}
