...
exports.updateUserEmail = exports.listCredentials = exports.getCredential = exports.removeCredential = exports.removeGeneratedOptions = exports.getUserFromRecoverAccountToken = exports.getGeneratedOptions = exports.sendEmail = exports.sendRecoverAccountEmail = exports.createRecoverAccountLink = exports.registerCredential = exports.consumeRecoverAccountToken = exports.recoverAccount = exports.generateRecoverAccountToken = exports.verifyCredentials = exports.signUp = exports.signIn = exports.signInOptions = exports.registerOptions = exports.Error = exports.init = void 0;
...
class Wrapper {
    static async registerOptions(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.registerOptions(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async signInOptions(input) {
        return await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.signInOptions(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static getGeneratedOptions(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getGeneratedOptions(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static signUp(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.signUp(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static signIn(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.signIn(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async verifyCredentials(input) {
        const resp = await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.verifyCredentials(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    ...
    static generateRecoverAccountToken(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.generateRecoverAccountToken(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async recoverAccount({ tenantId = constants_1.DEFAULT_TENANT_ID, webauthnGeneratedOptionsId, token, credential, userContext, }) {
    ...
    static consumeRecoverAccountToken(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.consumeRecoverAccountToken(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static registerCredential(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.registerCredential(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    ...
    static async sendEmail(input) {
        ...
        return await recipeInstance.emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async getUserFromRecoverAccountToken(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUserFromRecoverAccountToken(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async removeGeneratedOptions(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.removeGeneratedOptions(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async removeCredential(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.removeCredential(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async getCredential(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getCredential(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async listCredentials(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.listCredentials(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
    static async updateUserEmail(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.updateUserEmail(Object.assign(Object.assign({}, input), { userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
}
