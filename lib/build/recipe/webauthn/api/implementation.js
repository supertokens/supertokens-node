...
function getAPIImplementation() {
    return {
        ...
        signUpPOST: async function ({
            ...
            const errorCodeMap = {
                SIGN_UP_NOT_ALLOWED:
                    "Cannot sign up due to security reasons. Please try logging in, use a different login method or contact support. (ERR_CODE_25)",
                LINKING_TO_SESSION_USER_FAILED: {
                    ...
                    RECIPE_USER_ID_ALREADY_LINKED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_27)",
                    ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_28)",
                    SESSION_USER_ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_29)",
                },
            };
        ...
        signInPOST: async function ({
            ...
            const errorCodeMap = {
                SIGN_IN_NOT_ALLOWED:
                    "Cannot sign in due to security reasons. Please try recovering your account, use a different login method or contact support. (ERR_CODE_30)",
                LINKING_TO_SESSION_USER_FAILED: {
                    EMAIL_VERIFICATION_REQUIRED:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_31)",
                    RECIPE_USER_ID_ALREADY_LINKED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_32)",
                    ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_33)",
                    SESSION_USER_ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR:
                        "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_34)",
                },
            };
        ...
        generateRecoverAccountTokenPOST: async function ({ email, tenantId, options, userContext }) {
            ...
            async function generateAndSendRecoverAccountToken(primaryUserId, recipeUserId) {
                ...
                const recoverAccountLink = utils_2.getRecoverAccountLink({
            ...
            if (webauthnAccount === undefined) {
                ...
                const isSignUpAllowed = await recipe_1.default.getInstance().isSignUpAllowed({
                    newUser: {
                        recipeId: "webauthn",
                        email,
                    },
        ...
        recoverAccountPOST: async function ({
            ...
            async function doRegisterCredentialAndVerifyEmailAndTryLinkIfNotPrimary(recipeUserId) {
                ...
                if (updateResponse.status === "INVALID_AUTHENTICATOR_ERROR") {
                    ...
                    const updatedUserAfterEmailVerification = await __1.getUser(
            ...
            const existingUser = await __1.getUser(tokenConsumptionResponse.userId, userContext);
        ...
        registerCredentialPOST: async function ({
            ...
            const errorCodeMap = {
                ...
                INVALID_AUTHENTICATOR_ERROR:
                    "The device used for authentication is not supported. Please use a different device. (ERR_CODE_26)",
                INVALID_CREDENTIALS_ERROR:
                    "The credentials are incorrect. Please make sure you are using the correct credentials. (ERR_CODE_25)",
            };
            const generatedOptions = await options.recipeImplementation.getGeneratedOptions({
                webauthnGeneratedOptionsId,
                tenantId,
