...
function getRecipeInterface(querier, config, appInfo) {
    return {
        createJWT: function ({ req, payload, validitySeconds, useStaticSigningKey }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let apiDomain = yield appInfo.apiDomain(req, {});
        ...
        getJWKS: function () {
            return __awaiter(this, void 0, void 0, function* () {
                return yield querier.sendGetRequest(new normalisedURLPath_1.default("/.well-known/jwks.json"), {});
            });
        },
    };
}
