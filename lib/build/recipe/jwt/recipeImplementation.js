...
function getRecipeInterface(querier, config, appInfo) {
    return {
        createJWT: async function ({ payload, validitySeconds, useStaticSigningKey, userContext, }) {
            ...
            let response = await querier.sendPostRequest("/recipe/jwt", {
        ...
        getJWKS: async function ({ userContext }) {
            const { body, headers } = await querier.sendGetRequestWithResponseHeaders("/.well-known/jwks.json", {}, undefined, userContext);
