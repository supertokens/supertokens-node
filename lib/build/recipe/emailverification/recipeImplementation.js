...
function getRecipeInterface(querier, getEmailForRecipeUserId) {
    return {
        createEmailVerificationToken: function ({ recipeUserId, email, tenantId }) {
        ...
        verifyEmailUsingToken: function ({ token, attemptAccountLinking, tenantId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let response = yield querier.sendPostRequest(
                ...
                if (response.status === "OK") {
                    if (attemptAccountLinking) {
                        ...
                        let emailInfo = yield getEmailForRecipeUserId(
