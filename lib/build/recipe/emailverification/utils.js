            ...
            sendEmail: (input, userContext) =>
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (createAndSendCustomEmail === undefined) {
                        createAndSendCustomEmail = emailVerificationFunctions_1.createAndSendCustomEmail(appInfo);
                    }
                    yield createAndSendCustomEmail(input.user, input.emailVerifyLink, userContext);
                }),
        };
    }
