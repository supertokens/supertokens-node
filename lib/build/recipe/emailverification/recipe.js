...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleError = (err, _, __, next) => {
            return next(err);
        };
        ...
        this.createEmailVerificationToken = (userId, email) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.createEmailVerificationToken(userId, email);
        ...
        this.verifyEmailUsingToken = (token) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.verifyEmailUsingToken(token);
                if (response.status === "OK") {
        ...
        this.isEmailVerified = (userId, email) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.isEmailVerified(userId, email);
