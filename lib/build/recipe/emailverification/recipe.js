...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, next, _, __) =>
            __awaiter(this, void 0, void 0, function* () {
                if (id === constants_1.GENERATE_EMAIL_VERIFY_TOKEN_API) {
                    return yield generateEmailVerifyToken_1.default(this.apiImpl, this, req, res, next);
                } else {
                    return yield emailVerify_1.default(this.apiImpl, this, req, res, next);
                }
            });
        this.handleError = (err, _, response, next) => {
