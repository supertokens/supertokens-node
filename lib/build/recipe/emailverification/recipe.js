    ...
    constructor(stInstance, recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, _, __, userContext) => {
            ...
            if (id === constants_1.GENERATE_EMAIL_VERIFY_TOKEN_API) {
                return await (0, generateEmailVerifyToken_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            else {
                return await (0, emailVerify_1.default)(this.stInstance, this.apiImpl, tenantId, options, userContext);
            }
        };
        ...
        {
            let builder = new supertokens_js_override_1.default((0, recipeImplementation_1.default)(this.stInstance, this.querier, this.getEmailForRecipeUserId));
        ...
        return (stInstance, appInfo, isInServerlessEnv, plugins) => {
            if (Recipe.instance === undefined) {
                ...
                postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(() => {
                    stInstance.getRecipeInstanceOrThrow("session").addClaimFromOtherRecipe(emailVerificationClaim_1.EmailVerificationClaim);
                    if (config.mode === "REQUIRED") {
                        stInstance
                            .getRecipeInstanceOrThrow("session")
                            .addClaimValidatorFromOtherRecipe(emailVerificationClaim_1.EmailVerificationClaim.validators.isVerified());
                    }
                });
                return Recipe.instance;
            }
