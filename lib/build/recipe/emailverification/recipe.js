...
const recipe_1 = require("../session/recipe");
...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.getEmailForUserIdFuncsFromOtherRecipes = [];
        ...
        this.handleAPIRequest = (id, req, res, _, __) => __awaiter(this, void 0, void 0, function* () {
            let options = {
                config: this.config,
        ...
        this.handleError = (err, _, __) => __awaiter(this, void 0, void 0, function* () {
            throw err;
        });
        ...
        this.getEmailForUserId = (userId, userContext) => __awaiter(this, void 0, void 0, function* () {
            if (this.config.getEmailForUserId !== undefined) {
                const userRes = yield this.config.getEmailForUserId(userId, userContext);
                if (userRes.status !== "UNKNOWN_USER_ID_ERROR") {
                    return userRes;
                }
            }
            for (const getEmailForUserId of this.getEmailForUserIdFuncsFromOtherRecipes) {
                const res = yield getEmailForUserId(userId, userContext);
        ...
        this.addGetEmailForUserIdFunc = (func) => {
            this.getEmailForUserIdFuncsFromOtherRecipes.push(func);
        };
        this.config = utils_1.validateAndNormaliseUserInput(this, appInfo, config);
        this.isInServerlessEnv = isInServerlessEnv;
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipeId)));
