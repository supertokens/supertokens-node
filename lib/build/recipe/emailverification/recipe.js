...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.handleAPIRequest = (id, tenantId, req, res, _, __, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.GENERATE_EMAIL_VERIFY_TOKEN_API) {
                    return yield generateEmailVerifyToken_1.default(this.apiImpl, options, userContext);
                } else {
                    return yield emailVerify_1.default(this.apiImpl, tenantId, options, userContext);
                }
            });
        ...
        this.getEmailForRecipeUserId = (recipeUserId, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                if (this.config.getEmailForRecipeUserId !== undefined) {
                    const userRes = yield this.config.getEmailForRecipeUserId(recipeUserId, userContext);
                    if (userRes.status !== "UNKNOWN_USER_ID_ERROR") {
                        return userRes;
                    }
                }
                let user = yield __1.getUser(recipeUserId.getAsString(), userContext);
                if (user === undefined) {
                    return {
        ...
        this.getPrimaryUserIdForRecipeUser = (recipeUserId, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                let primaryUser = yield __1.getUser(recipeUserId.getAsString(), userContext);
        ...
        this.updateSessionIfRequiredPostEmailVerification = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                let primaryUserId = yield this.getPrimaryUserIdForRecipeUser(
                ...
                if (input.session !== undefined) {
                    ...
                    if (
                        input.session.getRecipeUserId().getAsString() ===
                        ...
                        if (input.session.getUserId() === primaryUserId) {
                            ...
                            if (
                                (yield input.session.getClaimValue(emailVerificationClaim_1.EmailVerificationClaim)) !==
                                true
                            ) {
                                try {
                                    // EmailVerificationClaim will be based on the recipeUserId
                                    // and not the primary user ID.
                                    yield input.session.fetchAndSetClaim(
                            ...
                            yield session_1.default.revokeAllSessionsForUser(
                                input.recipeUserIdWhoseEmailGotVerified.getAsString(),
                                false,
                                input.userContext
                            );
                            // create a new session and return that..
                            return yield session_1.default.createNewSession(
                                input.req,
                                input.res,
