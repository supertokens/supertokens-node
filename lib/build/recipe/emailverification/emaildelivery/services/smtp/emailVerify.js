...
function getEmailVerifyEmailContent(input, from) {
...
exports.default = getEmailVerifyEmailContent;
function getEmailVerifyEmailHTML(appName, email, verificationLink) {
    return `
    <!DOCTYPE html>
    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: white;">
        ...
        <![endif]-->
            ...
            <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
                Email Verification Request for ${appName}
            </div>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="text-align: center; font-size: 17px; line-height: 24px; color: #000000;">
                                    <p style="margin: 0 0 0px; color: #000000; font-family: 'Rubik', sans-serif; font-weight: 500; padding: 40px 50px 40px 50px;">Please verify your email address by clicking the button below.</p>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                        <tr>
                                            <td class="button-td button-td-primary" style="border-radius: 6px;">
                                                <a class="button-a button-a-primary" href="${verificationLink}" target="_blank" style="background: rgb(82, 181, 110); font-size: 17px; line-height: 24px; font-weight: 500; font-family: 'Rubik', sans-serif; text-decoration: none; padding: 9px 25px 9px 25px; color: #ffffff; display: block; border-radius: 6px;">Verify My Email</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Button : END -->
