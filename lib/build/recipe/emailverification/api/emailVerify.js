...
function emailVerify(apiImplementation, options) {
    return __awaiter(this, void 0, void 0, function* () {
        let result;
        if (utils_1.normaliseHttpMethod(options.req.method) === "post") {
            ...
            let response = yield apiImplementation.verifyEmailPOST({ token, options });
            ...
            result = yield apiImplementation.isEmailVerifiedGET({ options });
        }
