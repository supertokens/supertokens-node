...
function getAPIInterface() {
    return {
        verifyEmailPOST: function ({ token, tenantId, options, session, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield options.recipeImplementation.verifyEmailUsingToken({ tenantId, token, userContext });
        ...
        generateEmailVerifyTokenPOST: function ({ options, userContext, session }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (emailInfo.status === "EMAIL_DOES_NOT_EXIST_ERROR") {
                    ...
                    let response = yield emailverification_1.default.createEmailVerificationLink(
                        userId,
                        emailInfo.email,
                        tenantId,
                        userContext
