    ...
    return {
        ...
        isEmailVerifiedGET: function ({ userContext, session, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const isVerified = yield session.getClaimValue(emailVerificationClaim_1.EmailVerificationClaim, userContext);
        ...
        generateEmailVerifyTokenPOST: function ({ options, userContext, session, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const emailInfo = yield recipe_1.default.getInstanceOrThrowError().getEmailForUserId(userId, userContext);
                if (emailInfo.status === "EMAIL_DOES_NOT_EXIST_ERROR") {
                    logger_1.logDebugMessage(`Email verification email not sent to user ${userId} because it doesn't have an email address.`);
                    return {
                    ...
                    if (response.status === "EMAIL_ALREADY_VERIFIED_ERROR") {
                        ...
                        logger_1.logDebugMessage(`Email verification email not sent to ${emailInfo.email} because it is already verified.`);
                        return response;
                    }
