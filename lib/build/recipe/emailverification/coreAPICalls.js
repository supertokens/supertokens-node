...
function createEmailVerificationToken(recipeInstance, userId, email) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default(recipeInstance, "/recipe/user/email/verify/token"), {
                userId,
                email,
            });
...
function verifyEmailUsingToken(recipeInstance, token) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default(recipeInstance, "/recipe/user/email/verify"), {
                method: "token",
                token,
            });
        if (response.status === "OK") {
...
function isEmailVerified(recipeInstance, userId, email) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendGetRequest(new normalisedURLPath_1.default(recipeInstance, "/recipe/user/email/verify"), {
                userId,
                email,
            });
