...
class Wrapper {
    static createEmailVerificationToken(userId, email) {
        return recipe_1.default
            ...
            .recipeInterfaceImpl.createEmailVerificationToken(userId, email);
    }
    static verifyEmailUsingToken(token) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.verifyEmailUsingToken(token);
    }
    static isEmailVerified(userId, email) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.isEmailVerified(userId, email);
    }
}
