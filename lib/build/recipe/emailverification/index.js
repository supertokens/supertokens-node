...
class Wrapper {
    static createEmailVerificationToken(tenantId, recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (email === undefined) {
                const emailInfo = yield recipeInstance.getEmailForRecipeUserId(recipeUserId, userContext);
    ...
    static getEmailVerificationTokenInfo(token, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getEmailVerificationTokenInfo({
                token,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    }
    static createEmailVerificationLink(tenantId, recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipeInstance = recipe_1.default.getInstanceOrThrowError();
    ...
    static sendEmailVerificationEmail(tenantId, userId, recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (email === undefined) {
                const recipeInstance = recipe_1.default.getInstanceOrThrowError();
                const emailInfo = yield recipeInstance.getEmailForRecipeUserId(recipeUserId, userContext);
            ...
            let emailVerificationLink = yield this.createEmailVerificationLink(
                tenantId,
                recipeUserId,
                email,
                userContext
    ...
    static verifyEmailUsingToken(tenantId, token, attemptAccountLinking = true, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static isEmailVerified(recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof recipeUserId === "string" && process.env.TEST_MODE === "testing") {
                // This is there cause for tests, we pass in a string in most tests.
                recipeUserId = new recipeUserId_1.default(recipeUserId);
    ...
    static revokeEmailVerificationTokens(tenantId, recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof recipeUserId === "string" && process.env.TEST_MODE === "testing") {
                // This is there cause for tests, we pass in a string in most tests.
                recipeUserId = new recipeUserId_1.default(recipeUserId);
    ...
    static unverifyEmail(recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof recipeUserId === "string" && process.env.TEST_MODE === "testing") {
                // This is there cause for tests, we pass in a string in most tests.
                recipeUserId = new recipeUserId_1.default(recipeUserId);
...
exports.getEmailVerificationTokenInfo = Wrapper.getEmailVerificationTokenInfo;
