...
class Wrapper {
    ...
    static async createEmailVerificationLink(tenantId, recipeUserId, email, userContext) {
        ...
        let emailVerificationToken = await exports.createEmailVerificationToken(tenantId, recipeUserId, email, ctx);
    ...
    static async sendEmail(input) {
        ...
        return await recipeInstance.emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign(Object.assign({}, input), { userContext: utils_2.getUserContext(input.userContext) }));
    }
}
