...
class Wrapper {
    ...
    static async createEmailVerificationLink(tenantId, recipeUserId, email, userContext) {
        ...
        let emailVerificationToken = await (0, exports.createEmailVerificationToken)(tenantId, recipeUserId, email, ctx);
...
Object.defineProperty(exports, "EmailVerificationClaim", { enumerable: true, get: function () { return emailVerificationClaim_2.EmailVerificationClaim; } });
