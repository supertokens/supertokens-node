...
exports.EmailVerificationClaim = exports.getEmailVerificationTokenInfo = exports.sendEmail = exports.unverifyEmail = exports.revokeEmailVerificationTokens = exports.isEmailVerified = exports.verifyEmailUsingToken = exports.createEmailVerificationToken = exports.Error = exports.init = void 0;
const recipe_1 = __importDefault(require("./recipe"));
const error_1 = __importDefault(require("./error"));
const emailVerificationClaim_1 = require("./emailVerificationClaim");
const recipeUserId_1 = __importDefault(require("../../recipeUserId"));
class Wrapper {
    static createEmailVerificationToken(recipeUserId, email, userContext) {
    ...
    static verifyEmailUsingToken(token, attemptAccountLinking = true, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static revokeEmailVerificationTokens(recipeUserId, email, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof recipeUserId === "string" && process.env.TEST_MODE === "testing") {
                // This is there cause for tests, we pass in a string in most tests.
                recipeUserId = new recipeUserId_1.default(recipeUserId);
