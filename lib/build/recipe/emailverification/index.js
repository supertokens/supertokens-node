...
class Wrapper {
    static createEmailVerificationToken(userId, email) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().createEmailVerificationToken(userId, email);
        });
    }
    static verifyEmailUsingToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().verifyEmailUsingToken(token);
        });
    }
    static isEmailVerified(userId, email) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.isEmailVerified(userId, email);
        });
    }
}
