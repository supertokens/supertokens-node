...
function usersGet(_, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let usersResponse = timeJoinedOrder === "DESC"
            ? yield __1.getUsersNewestFirst({
                limit: parseInt(limit),
                paginationToken,
            })
            : yield __1.getUsersOldestFirst({
                limit: parseInt(limit),
                paginationToken,
            });
        ...
        for (let i = 0; i < usersResponse.users.length; i++) {
            ...
            metaDataFetchPromises.push(() => new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const userMetaDataResponse = yield usermetadata_1.default.getUserMetadata(userObj.id);
