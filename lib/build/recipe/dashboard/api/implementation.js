    ...
    return {
        dashboardGET: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let telemetryId = "";
                try {
                    let querier = querier_1.Querier.getNewInstanceOrThrowError(input.options.recipeId);
                    const response = yield querier.sendGetRequest(new normalisedURLPath_1.default("/telemetry"), {});
