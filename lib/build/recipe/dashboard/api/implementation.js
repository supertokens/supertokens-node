...
const recipe_4 = __importDefault(require("../../../recipe/multifactorauth/recipe"));
const recipe_5 = __importDefault(require("../../../recipe/totp/recipe"));
const recipe_6 = __importDefault(require("../../../recipe/thirdpartyemailpassword/recipe"));
const recipe_7 = __importDefault(require("../../../recipe/thirdpartypasswordless/recipe"));
...
function getAPIImplementation() {
    return {
        dashboardGET: async function (input) {
            ...
            try {
                const instance = recipe_7.default.getInstanceOrThrowError();
                initializedRecipes.thirdParty = true;
                initializedRecipes.passwordless = {
                    enabled: true,
                    contactMethod: instance.config.contactMethod,
