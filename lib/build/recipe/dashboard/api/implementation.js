...
function getAPIImplementation() {
    return {
        dashboardGET: async function (input) {
            ...
            '<span class="csp-point"><strong>Blocked URI:</strong> ' + event.blockedURI + '<br></span>' +
            '<span class="csp-point"><strong>Violated Directive:</strong> ' + event.violatedDirective + '<br></span>' +
            '<span class="csp-point"><strong>Original Policy:</strong> ' + event.originalPolicy + '<br></span>' +
