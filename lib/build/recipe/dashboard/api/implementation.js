...
const recipe_5 = __importDefault(require("../../../recipe/thirdpartyemailpassword/recipe"));
const recipe_6 = __importDefault(require("../../../recipe/thirdpartypasswordless/recipe"));
...
function getAPIImplementation() {
    return {
        dashboardGET: async function (input) {
            ...
            try {
                const instance = recipe_6.default.getInstanceOrThrowError();
                initializedRecipes.thirdParty = true;
                initializedRecipes.passwordless = {
                    enabled: true,
                    contactMethod: instance.config.contactMethod,
