    ...
    return {
        ...
        dashboardGET: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                const bundleDomain = new normalisedURLDomain_1.default(
                    yield input.options.recipeImplementation.getDashboardBundleDomain({
        ...
        validateKeyPOST: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                const isValidKey = yield input.options.recipeImplementation.isValidAuth({
                    key: input.key,
