...
const userGet = (_, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        user = Object.assign(Object.assign({}, user), { firstName: "FEATURE_NOT_ENABLED", lastName: "FEATURE_NOT_ENABLED" });
        return {
            status: "OK",
            recipeId: recipeId,
            user,
    ...
    user = Object.assign(Object.assign({}, user), { firstName: first_name === undefined ? "" : first_name, lastName: last_name === undefined ? "" : last_name });
    return {
        status: "OK",
        recipeId: recipeId,
        user,
