...
const __1 = require("../../../..");
const userDelete = (_, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const removeAllLinkedAccounts = removeAllLinkedAccountsQueryValue === undefined ? undefined : removeAllLinkedAccountsQueryValue === "true";
    if (userId === undefined) {
