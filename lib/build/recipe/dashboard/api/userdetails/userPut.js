...
const userPut = async (_, tenantId, options, userContext) => {
    ...
    let userResponse = await utils_1.getUserForRecipeId(new recipeUserId_1.default(recipeUserId), recipeId);
    ...
    if (firstName.trim() !== "" || lastName.trim() !== "") {
        ...
        if (isRecipeInitialised) {
            ...
            await usermetadata_1.default.updateUserMetadata(recipeUserId, metaDataUpdate, userContext);
        }
    }
    if (email.trim() !== "") {
