...
const updateEmailForRecipeId = (recipeId, recipeUserId, email) =>
...
const updatePhoneForRecipeId = (recipeId, recipeUserId, phone) =>
    __awaiter(void 0, void 0, void 0, function* () {
        if (recipeId === "passwordless") {
    ...
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (firstName.trim() !== "" || lastName.trim() !== "") {
            ...
            if (isRecipeInitialised) {
                ...
                yield usermetadata_1.default.updateUserMetadata(recipeUserId, metaDataUpdate);
            }
        }
        if (email.trim() !== "") {
