...
const updateEmailForRecipeId = (recipeId, recipeUserId, email, tenantId, userContext) =>
...
const updatePhoneForRecipeId = (recipeId, recipeUserId, phone, tenantId, userContext) =>
    __awaiter(void 0, void 0, void 0, function* () {
        if (recipeId === "passwordless") {
...
const userPut = (_, tenantId, options, userContext) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        let userResponse = yield utils_1.getUserForRecipeId(new recipeUserId_1.default(recipeUserId), recipeId);
        ...
        if (firstName.trim() !== "" || lastName.trim() !== "") {
            ...
            if (isRecipeInitialised) {
                ...
                yield usermetadata_1.default.updateUserMetadata(recipeUserId, metaDataUpdate, userContext);
            }
        }
        if (email.trim() !== "") {
            const emailUpdateResponse = yield updateEmailForRecipeId(
                userResponse.recipe,
        ...
        if (phone.trim() !== "") {
            const phoneUpdateResponse = yield updatePhoneForRecipeId(
                userResponse.recipe,
                new recipeUserId_1.default(recipeUserId),
                phone.trim(),
                tenantId,
