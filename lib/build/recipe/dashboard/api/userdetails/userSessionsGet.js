...
const userSessionsGet = (_, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < response.length; i++) {
        sessionInfoPromises.push(new Promise((res, rej) => __awaiter(void 0, void 0, void 0, function* () {
            try {
