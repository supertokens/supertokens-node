...
const userEmailVerifyPut = (_, options) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (verified) {
            const tokenResponse = yield emailverification_1.default.createEmailVerificationToken(userId, email);
            ...
            yield emailverification_1.default.unverifyEmail(userId, email);
        }
        return {
            status: "OK",
        };
