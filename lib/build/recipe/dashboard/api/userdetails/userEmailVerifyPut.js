...
const userEmailVerifyPut = (_, options) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (verified) {
            const tokenResponse = yield emailverification_1.default.createEmailVerificationToken(recipeUserId, email);
            ...
            yield emailverification_1.default.unverifyEmail(recipeUserId, email);
        }
        return {
            status: "OK",
        };
