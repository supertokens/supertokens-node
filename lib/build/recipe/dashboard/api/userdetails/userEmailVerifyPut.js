...
exports.userEmailVerifyPut = (_, options) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (verified) {
            const tokenResponse = yield emailverification_1.default.createEmailVerificationToken(recipeUserId);
            ...
            yield emailverification_1.default.unverifyEmail(recipeUserId);
        }
        return {
            status: "OK",
        };
