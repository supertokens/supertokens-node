...
const __1 = require("../../../..");
const userEmailVerifyTokenPost = async ({ stInstance, tenantId, options, userContext, }) => {
    ...
    return await emailverification_1.default.sendEmailVerificationEmail(tenantId, user.id, (0, __1.convertToRecipeUserId)(recipeUserId), undefined, userContext);
};
