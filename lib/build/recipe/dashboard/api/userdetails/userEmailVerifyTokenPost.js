...
exports.userEmailVerifyTokenPost = (_, options) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        let emailResponse = yield recipe_1.default.getInstanceOrThrowError().getEmailForUserId(recipeUserId, {});
        if (emailResponse.status !== "OK") {
            throw new Error("Should never come here");
        }
        let emailVerificationToken = yield emailverification_1.default.createEmailVerificationToken(recipeUserId);
