    ...
    if (enable === true) {
        ...
        if (!allAvailableSecondaryFactors.includes(factorId)) {
            return {
                ...
                message: utils_1.getFactorNotAvailableMessage(factorId, allAvailableSecondaryFactors),
            };
        }
    }
    let secondaryFactors = utils_1.getNormalisedRequiredSecondaryFactorsBasedOnTenantConfigFromCoreAndSDKInit(tenantRes);
    if (enable === true) {
