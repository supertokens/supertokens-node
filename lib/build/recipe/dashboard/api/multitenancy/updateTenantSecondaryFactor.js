...
async function updateTenantSecondaryFactor({ stInstance, tenantId, options, userContext, }) {
    ...
    let secondaryFactors = (0, utils_1.getNormalisedRequiredSecondaryFactorsBasedOnTenantConfigFromCoreAndSDKInit)(stInstance, tenantRes);
    if (enable === true) {
