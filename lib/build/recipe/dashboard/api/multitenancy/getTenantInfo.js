...
async function getTenantInfo(_, __, options, userContext) {
    ...
    const validFirstFactors = await utils_1.getValidFirstFactors({
        firstFactorsFromCore: tenantRes.firstFactors,
        staticFirstFactors: mtRecipe === null || mtRecipe === void 0 ? void 0 : mtRecipe.staticFirstFactors,
        allAvailableFirstFactors:
            (_d = mtRecipe === null || mtRecipe === void 0 ? void 0 : mtRecipe.allAvailableFirstFactors) !== null &&
            _d !== void 0
                ? _d
                : [],
        userContext,
