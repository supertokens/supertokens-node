...
const createPasswordlessUser = async ({ stInstance, tenantId, options, userContext, }) => {
    ...
    return await passwordlessRecipe.signInUp(email !== undefined ? { email, tenantId, userContext } : { phoneNumber: phoneNumber, tenantId, userContext });
};
