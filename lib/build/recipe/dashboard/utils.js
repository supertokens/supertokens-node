...
function getUserForRecipeId(recipeUserId, recipeId) {
    return __awaiter(this, void 0, void 0, function* () {
        let userResponse = yield _getUserForRecipeId(recipeUserId, recipeId);
        let user = undefined;
...
function _getUserForRecipeId(recipeUserId, recipeId) {
    return __awaiter(this, void 0, void 0, function* () {
        let user;
        let recipe;
        const globalUser = yield recipe_1.default.getInstance().recipeInterfaceImpl.getUser({
        ...
        if (recipeId === recipe_2.default.RECIPE_ID) {
            try {
                ...
                if (globalUser !== undefined) {
                    ...
                    if (loginMethod !== undefined) {
                        user = Object.assign({}, loginMethod);
            ...
            try {
                const userResponse = yield thirdparty_1.default.getUserById(recipeUserId.getAsString());
                if (userResponse !== undefined) {
                    user = Object.assign(Object.assign({}, userResponse), {
                        recipeUserId: new recipeUserId_1.default(userResponse.id),
                        recipeId: "thirdparty",
                    });
                    recipe = "thirdparty";
                }
            ...
            if (user === undefined) {
                try {
                    const userResponse = yield thirdpartypasswordless_1.default.getUserById(recipeUserId.getAsString());
                    if (userResponse !== undefined) {
                        user = Object.assign(Object.assign({}, userResponse), {
                            recipeUserId: new recipeUserId_1.default(userResponse.id),
                            recipeId: "thirdparty",
