...
function isApiPath(path, appInfo) {
    const dashboardRecipeBasePath = appInfo.apiBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DASHBOARD_API));
...
function getUserForRecipeId(userId, recipeId) {
    return __awaiter(this, void 0, void 0, function* () {
        let userResponse = yield _getUserForRecipeId(userId, recipeId);
        let user = undefined;
...
function _getUserForRecipeId(userId, recipeId) {
    return __awaiter(this, void 0, void 0, function* () {
        let user;
        let recipe;
        const globalUser = yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUser({
            userId,
            userContext: {},
        });
