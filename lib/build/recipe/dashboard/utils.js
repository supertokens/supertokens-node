...
exports.getApiPathWithDashboardBase = exports.validateApiKey = exports.isRecipeInitialised = exports.getUserForRecipeId = exports.isValidRecipeId = exports.sendUnauthorisedAccess = exports.getApiIdIfMatched = exports.validateAndNormaliseUserInput = void 0;
...
function getApiIdIfMatched(path, method) {
    if (path.getAsStringDangerous() === constants_1.VALIDATE_KEY_API && method === "post") {
        return constants_1.VALIDATE_KEY_API;
    }
    if (path.getAsStringDangerous() === constants_1.SIGN_IN_API && method === "post") {
        return constants_1.SIGN_IN_API;
    }
    if (path.getAsStringDangerous() === constants_1.SIGN_OUT_API && method === "post") {
        return constants_1.SIGN_OUT_API;
    }
    if (path.getAsStringDangerous() === constants_1.USERS_LIST_GET_API && method === "get") {
        return constants_1.USERS_LIST_GET_API;
    }
    if (path.getAsStringDangerous() === constants_1.USERS_COUNT_API && method === "get") {
        return constants_1.USERS_COUNT_API;
    }
    if (path.getAsStringDangerous() === constants_1.USER_API) {
        if (method === "get" || method === "delete" || method === "put") {
            return constants_1.USER_API;
        }
    }
    if (path.getAsStringDangerous() === constants_1.USER_EMAIL_VERIFY_API) {
        if (method === "get" || method === "put") {
            return constants_1.USER_EMAIL_VERIFY_API;
        }
    }
    if (path.getAsStringDangerous() === constants_1.USER_METADATA_API) {
        if (method === "get" || method === "put") {
            return constants_1.USER_METADATA_API;
        }
    }
    if (path.getAsStringDangerous() === constants_1.USER_SESSIONS_API) {
        if (method === "get" || method === "post") {
            return constants_1.USER_SESSIONS_API;
        }
    }
    if (path.getAsStringDangerous() === constants_1.USER_PASSWORD_API && method === "put") {
        return constants_1.USER_PASSWORD_API;
    }
    if (path.getAsStringDangerous() === constants_1.USER_EMAIL_VERIFY_TOKEN_API && method === "post") {
        return constants_1.USER_EMAIL_VERIFY_TOKEN_API;
    }
    if (path.getAsStringDangerous() === constants_1.USER_PASSWORD_API && method === "put") {
        return constants_1.USER_PASSWORD_API;
    }
    if (path.getAsStringDangerous() === constants_1.SEARCH_TAGS_API && method === "get") {
        return constants_1.SEARCH_TAGS_API;
    }
    if (path.getAsStringDangerous() === constants_1.DASHBOARD_ANALYTICS_API && method === "post") {
