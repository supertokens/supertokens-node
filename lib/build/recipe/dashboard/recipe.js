...
const boxySamlUpload_1 = __importDefault(require("./api/multitenancy/boxySamlUpload"));
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    id: constants_1.BOXY_SAML_UPLOAD,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.BOXY_SAML_UPLOAD)
                    ),
                    disabled: false,
                    method: "put",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.BOXY_SAML_UPLOAD) {
                apiFunction = boxySamlUpload_1.default;
            }
