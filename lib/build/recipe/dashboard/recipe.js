    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, __, ___) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                function getApiResponse(apiImplementation) {
                    return __awaiter(this, void 0, void 0, function* () {
                        // For these APIs we dont need API key validation
                        if (id === constants_1.DASHBOARD_API) {
                            return yield dashboard_1.default(apiImplementation, options);
                        }
                        if (id === constants_1.VALIDATE_KEY_API) {
                            return yield validateKey_1.default(apiImplementation, options);
                        }
                        ...
                        return yield apiKeyProtector_1.default(apiImplementation, options, apiFunction);
                    });
                }
                const apiResponse = yield getApiResponse(this.apiImpl);
