...
const getLoginMethodsInfo_1 = require("./api/getLoginMethodsInfo");
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    id: constants_1.GET_LOGIN_METHODS,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.GET_LOGIN_METHODS)
                    ),
                    disabled: false,
                    method: "get",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.GET_LOGIN_METHODS) {
                if (req.getMethod() === "get") {
                    {
                        apiFunction = getLoginMethodsInfo_1.getLoginMethodsInfo;
                    }
                }
            }
