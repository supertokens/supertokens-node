...
const listAllTenantsWithUserCount_1 = __importDefault(require("./api/multitenancy/listAllTenantsWithUserCount"));
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    id: constants_1.LIST_TENANTS_WITH_USER_COUNT,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.LIST_TENANTS_WITH_USER_COUNT)
                    ),
                    disabled: false,
                    method: "get",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.LIST_TENANTS_WITH_USER_COUNT) {
                if (req.getMethod() === "get") {
                    apiFunction = listAllTenantsWithUserCount_1.default;
                }
            } else if (id === constants_1.ASSOCIATE_USER_TO_TENANT) {
                apiFunction = associateUserToTenant_1.default;
            }
            if (id === constants_1.DISASSOCIATE_USER_FROM_TENANT) {
