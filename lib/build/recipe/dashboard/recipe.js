    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    id: constants_1.USERROLES_USER_ROLES_LIST_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.USERROLES_USER_ROLES_LIST_API)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    id: constants_1.USERROLES_ADD_ROLE_TO_USER_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.USERROLES_ADD_ROLE_TO_USER_API)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    id: constants_1.USERROLES_REMOVE_ROLE_FROM_USER_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.USERROLES_REMOVE_ROLE_FROM_USER_API)
                    ),
                    disabled: false,
                    method: "delete",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.USERROLES_ADD_ROLE_TO_USER_API) {
                apiFunction = addRoleToUser_1.default;
            } else if (id === constants_1.USERROLES_USER_ROLES_LIST_API) {
                apiFunction = getRolesForUser_1.default;
            } else if (id === constants_1.USERROLES_REMOVE_ROLE_FROM_USER_API) {
