...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.LIST_TENANTS_WITH_LOGIN_METHODS)
                    ),
                    disabled: false,
                    method: "get",
                },
                ...
                {
                    id: constants_1.GET_OR_UPDATE_TENANT_CORE_CONFIG_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.GET_OR_UPDATE_TENANT_CORE_CONFIG_API)
                    ),
                    disabled: false,
                    method: "put",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.GET_OR_UPDATE_TENANT_CORE_CONFIG_API) {
                if (req.getMethod() === "get") {
