...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, __, ___) => __awaiter(this, void 0, void 0, function* () {
            let options = {
                config: this.config,
        ...
        this.returnAPIIdIfCanHandleRequest = (path, method) => {
            const dashboardBundlePath = this.getAppInfo().apiBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DASHBOARD_API));
