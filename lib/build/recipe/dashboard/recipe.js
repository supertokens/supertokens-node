...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.UPDATE_TENANT_FIRST_FACTOR_API)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    id: constants_1.UPDATE_TENANT_SECONDARY_FACTOR_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.UPDATE_TENANT_SECONDARY_FACTOR_API)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.UPDATE_TENANT_CORE_CONFIG_API)
                    ),
                    disabled: false,
                    method: "put",
                },
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.TENANT_THIRD_PARTY_CONFIG_API)
                    ),
                    disabled: false,
                    method: "get",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            } else if (id === constants_1.UPDATE_TENANT_SECONDARY_FACTOR_API) {
