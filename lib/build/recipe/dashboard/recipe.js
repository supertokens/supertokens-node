    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                {
                    method: "get",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(constants_1.DASHBOARD_API),
        ...
        this.returnAPIIdIfCanHandleRequest = (path, method) => {
            ...
            const dashboardAPIPath = dashboardBundlePath.appendPath(new normalisedURLPath_1.default("/api"));
