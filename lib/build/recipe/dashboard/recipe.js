    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.returnAPIIdIfCanHandleRequest = (path, method) => {
            ...
            if (utils_1.isApiPath(path, this.getAppInfo())) {
                let id = utils_1.getApiIdIfMatched(path, method);
                if (id !== undefined) {
                    return { id, tenantId: constants_2.DEFAULT_TENANT_ID };
                }
                if (remainingPath !== undefined) {
                    id = utils_1.getApiIdIfMatched(remainingPath, method);
                    if (id !== undefined) {
                        return { id, tenantId };
                    }
                }
