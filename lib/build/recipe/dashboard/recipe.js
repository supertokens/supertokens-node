...
const listTenants_1 = __importDefault(require("./api/multitenancy/listTenants"));
const getTenantLoginMethodsInfo_1 = __importDefault(require("./api/multitenancy/getTenantLoginMethodsInfo"));
...
const createOrUpdateTenant_1 = __importDefault(require("./api/multitenancy/createOrUpdateTenant"));
const associateUserToTenant_1 = __importDefault(require("./api/multitenancy/associateUserToTenant"));
const disassociateUserFromTenant_1 = __importDefault(require("./api/multitenancy/disassociateUserFromTenant"));
...
const listAllCoreConfigProperties_1 = __importDefault(require("./api/multitenancy/listAllCoreConfigProperties"));
const getAllThirdPartyProviders_1 = __importDefault(require("./api/multitenancy/getAllThirdPartyProviders"));
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                },
                {
                    id: constants_1.DASHBOARD_API,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase("/tenants")
                    ),
                    disabled: false,
                    method: "get",
                },
                ...
                },
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.TENANT_API)
                    ),
                    disabled: false,
                    method: "get",
                },
                ...
                {
                    id: constants_1.ASSOCIATE_USER_TO_TENANT,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.ASSOCIATE_USER_TO_TENANT)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    id: constants_1.DISASSOCIATE_USER_FROM_TENANT,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.DISASSOCIATE_USER_FROM_TENANT)
                    ),
                    disabled: false,
                    method: "put",
                },
                {
                    id: constants_1.TENANT_THIRD_PARTY,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.TENANT_THIRD_PARTY)
                    ),
                    disabled: false,
                    method: "put",
                },
                ...
                {
                    id: constants_1.LIST_ALL_CORE_CONFIG_PROPERTIES,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.LIST_ALL_CORE_CONFIG_PROPERTIES)
                    ),
                    disabled: false,
                    method: "get",
                },
                {
                    id: constants_1.LIST_ALL_THIRD_PARTY_PROVIDERS,
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        utils_1.getApiPathWithDashboardBase(constants_1.LIST_ALL_THIRD_PARTY_PROVIDERS)
                    ),
                    disabled: false,
                    method: "get",
                },
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, __, ___, userContext) => {
            ...
            if (id === constants_1.USERS_LIST_GET_API) {
                ...
                if (req.getMethod() === "put") {
                    apiFunction = createOrUpdateTenant_1.default;
                }
                if (req.getMethod() === "get") {
            ...
            } else if (id === constants_1.ASSOCIATE_USER_TO_TENANT) {
                apiFunction = associateUserToTenant_1.default;
            } else if (id === constants_1.DISASSOCIATE_USER_FROM_TENANT) {
                apiFunction = disassociateUserFromTenant_1.default;
            } else if (id === constants_1.TENANT_THIRD_PARTY) {
                if (req.getMethod() === "delete") {
            ...
            } else if (id === constants_1.LIST_ALL_CORE_CONFIG_PROPERTIES) {
                apiFunction = listAllCoreConfigProperties_1.default;
            } else if (id === constants_1.LIST_ALL_THIRD_PARTY_PROVIDERS) {
                apiFunction = getAllThirdPartyProviders_1.default;
            }
