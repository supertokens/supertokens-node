    ...
    return {
        ...
        shouldAllowAccess: async function (input) {
            ...
            if (!input.config.apiKey) {
                ...
                const authHeaderValue = (_a = input.req.getHeaderValue("authorization")) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
                const sessionVerificationResponse = await querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/dashboard/session/verify"), {
                ...
                if (utils_1.normaliseHttpMethod(input.req.getMethod()) !== "get") {
                    ...
                    if (admins.length === 0) {
                        logger_1.logDebugMessage("User Dashboard: Throwing OPERATION_NOT_ALLOWED because user is not an admin");
                        throw new error_1.default();
                    }
                    const userEmail = sessionVerificationResponse.email;
                    if (userEmail === undefined || typeof userEmail !== "string") {
                        logger_1.logDebugMessage("User Dashboard: Returning Unauthorised because no email was returned from the core. Should never come here");
                        return false;
                    }
            ...
            return await utils_2.validateApiKey(input);
        },
    };
}
