        ...
        shouldAllowAccess: async function (input) {
            ...
            if (!input.config.apiKey) {
                ...
                if ((0, utils_1.normaliseHttpMethod)(input.req.getMethod()) !== "get") {
                    ...
                    if (admins.length === 0) {
                        (0, logger_1.logDebugMessage)("User Dashboard: Throwing OPERATION_NOT_ALLOWED because user is not an admin");
                        throw new error_1.default();
                    }
                    const userEmail = sessionVerificationResponse.email;
                    if (userEmail === undefined || typeof userEmail !== "string") {
                        (0, logger_1.logDebugMessage)("User Dashboard: Returning Unauthorised because no email was returned from the core. Should never come here");
                        return false;
                    }
