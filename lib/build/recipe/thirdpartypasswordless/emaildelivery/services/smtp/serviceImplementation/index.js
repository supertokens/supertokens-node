...
function getServiceImplementation(transporter, from) {
    let emailVerificationServiceImpl = serviceImplementation_1.getServiceImplementation(transporter, from);
    let passwordlessServiceImpl = serviceImplementation_2.getServiceImplementation(transporter, from);
    return {
        ...
        getContent: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                if (input.type === "EMAIL_VERIFICATION") {
                    return yield emailVerificationServiceImpl.getContent.bind(
                        emailVerificationServiceImplementation_1.default(this)
                    )(input);
                }
                return yield passwordlessServiceImpl.getContent.bind(passwordlessServiceImplementation_1.default(this))(
                    input
                );
            });
        },
