...
function getServiceImplementation(transporter, from) {
    let emailVerificationSeriveImpl = serviceImplementation_1.getServiceImplementation(transporter, from);
    let passwordlessSeriveImpl = serviceImplementation_2.getServiceImplementation(transporter, from);
    return {
