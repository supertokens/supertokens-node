...
const passwordlessServiceImplementation_1 = __importDefault(require("./serviceImplementation/passwordlessServiceImplementation"));
class SMTPService {
    constructor(config) {
        ...
        let builder = new supertokens_js_override_1.default(serviceImplementation_1.getServiceImplementation(transporter, config.smtpSettings.from));
