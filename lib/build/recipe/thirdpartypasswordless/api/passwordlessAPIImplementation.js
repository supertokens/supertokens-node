...
function getIterfaceImpl(apiImplmentation) {
    ...
    return {
        emailExistsGET: (_a = apiImplmentation.passwordlessUserEmailExistsGET) === null || _a === void 0 ? void 0 : _a.bind(apiImplmentation),
        ...
        resendCodePOST: (_e = apiImplmentation.resendCodePOST) === null || _e === void 0 ? void 0 : _e.bind(apiImplmentation),
