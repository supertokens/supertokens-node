...
function validateAndNormaliseUserInput(appInfo, config) {
    ...
    function getEmailDeliveryConfig() {
        ...
        if (emailService === undefined) {
            emailService = new backwardCompatibility_1.default(appInfo, {
                createAndSendCustomEmail: (config === null || config === void 0 ? void 0 : config.contactMethod) !== "PHONE" ? config === null || config === void 0 ? void 0 : config.createAndSendCustomEmail : undefined,
            });
        }
    ...
    function getSmsDeliveryConfig() {
        var _a;
        let smsService = (_a = config === null || config === void 0 ? void 0 : config.smsDelivery) === null || _a === void 0 ? void 0 : _a.service;
        /**
         * following code is for backward compatibility.
        ...
        if (smsService === undefined) {
            smsService = new backwardCompatibility_2.default(appInfo, {
                createAndSendCustomTextMessage: (config === null || config === void 0 ? void 0 : config.contactMethod) !== "EMAIL" ? config === null || config === void 0 ? void 0 : config.createAndSendCustomTextMessage : undefined,
            });
        }
