...
const passwordlessRecipeImplementation_1 = __importDefault(require("./recipeImplementation/passwordlessRecipeImplementation"));
const thirdPartyRecipeImplementation_1 = __importDefault(require("./recipeImplementation/thirdPartyRecipeImplementation"));
const thirdPartyAPIImplementation_1 = __importDefault(require("./api/thirdPartyAPIImplementation"));
const passwordlessAPIImplementation_1 = __importDefault(require("./api/passwordlessAPIImplementation"));
...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes, ingredients) {
        ...
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipe_1.default.RECIPE_ID), querier_1.Querier.getNewInstanceOrThrowError(recipe_2.default.RECIPE_ID)));
        ...
        this.emailDelivery =
            ingredients.emailDelivery === undefined
                ? new emaildelivery_1.default(this.config.getEmailDeliveryConfig(this.recipeInterfaceImpl, this.isInServerlessEnv))
        ...
        this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe_1.default(recipeId, appInfo, isInServerlessEnv, Object.assign(Object.assign({}, this.config), { override: {
                        functions: (_) => {
        ...
        if (this.config.providers.length !== 0) {
            this.thirdPartyRecipe =
                recipes.thirdPartyInstance !== undefined
                    ...
                    : new recipe_2.default(recipeId, appInfo, isInServerlessEnv, {
                        override: {
                            functions: (_) => {
