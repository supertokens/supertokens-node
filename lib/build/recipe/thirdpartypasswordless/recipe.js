...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes) {
        ...
        this.handleAPIRequest = (id, req, res, path, method) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.handleError = (err, request, response) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.isErrorFromThisRecipe = (err) => {
            return (error_1.default.isErrorFromSuperTokens(err) &&
        ...
        // helper functions...
        this.getEmailForUserIdForEmailVerification = (userId, userContext) => __awaiter(this, void 0, void 0, function* () {
        ...
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipe_2.default.RECIPE_ID), querier_1.Querier.getNewInstanceOrThrowError(recipe_3.default.RECIPE_ID)));
        ...
        this.emailVerificationRecipe =
            recipes.emailVerificationInstance !== undefined
                ...
                : new recipe_1.default(recipeId, appInfo, isInServerlessEnv, Object.assign(Object.assign({}, this.config.emailVerificationFeature), { override: Object.assign(Object.assign({}, this.config.emailVerificationFeature.override), { functions: (oI, builder) => {
                            var _a;
                            let passwordlessOverride = (oI) => {
                                return Object.assign(Object.assign({}, oI), { createEmailVerificationToken: function (input) {
                            ...
                            if (((_a = emailVerificationConfig.override) === null || _a === void 0 ? void 0 : _a.functions) !== undefined) {
        ...
        this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe_2.default(recipeId, appInfo, isInServerlessEnv, Object.assign(Object.assign({}, this.config), { override: {
                        functions: (_) => {
        ...
        if (this.config.providers.length !== 0) {
            this.thirdPartyRecipe =
                recipes.thirdPartyInstance !== undefined
                    ...
                    : new recipe_3.default(recipeId, appInfo, isInServerlessEnv, {
                        override: {
                            functions: (_) => {
    ...
    static init(config) {
        return (appInfo, isInServerlessEnv) => {
            if (Recipe.instance === undefined) {
                ...
                throw new Error("ThirdPartyPasswordless recipe has already been initialised. Please check your code for bugs.");
            }
        };
    }
    static reset() {
