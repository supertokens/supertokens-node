...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes, ingredients) {
        ...
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipe_1.default.RECIPE_ID), querier_1.Querier.getNewInstanceOrThrowError(recipe_2.default.RECIPE_ID), this.config.providers));
