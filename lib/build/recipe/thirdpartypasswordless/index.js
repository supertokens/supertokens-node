...
class Wrapper {
    static thirdPartyGetProvider(thirdPartyId, tenantId, clientType, userContext = {}) {
    ...
    static thirdPartyManuallyCreateOrUpdateUser(thirdPartyId, thirdPartyUserId, email, userContext = {}) {
    ...
    static getUserByPhoneNumber(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUserByPhoneNumber(
            Object.assign(Object.assign({ userContext: {} }, input), {
                tenantId: input.tenantId === undefined ? constants_1.DEFAULT_TENANT_ID : input.tenantId,
            })
        );
    ...
    static sendSms(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().smsDelivery.ingredientInterfaceImpl.sendSms(
                Object.assign(Object.assign({ userContext: {} }, input), {
                    tenantId: input.tenantId === undefined ? constants_1.DEFAULT_TENANT_ID : input.tenantId,
                })
            );
