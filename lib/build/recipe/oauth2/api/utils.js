...
function getCookieStringFromSetCookieString(setCookie) {
    if (!setCookie) {
        return "";
    }
    const cookies = set_cookie_parser_1.default.parse(set_cookie_parser_1.default.splitCookiesString(setCookie));
