        ...
        authorization: async function (input) {
            ...
            if (consentChallenge !== null && input.session !== undefined) {
                ...
                if (
                    ...
                    const idToken = {};
                    if (
                        (_b = consentRequest.requestedScope) === null || _b === void 0 ? void 0 : _b.includes("email")
                    ) {
                        idToken.email = user === null || user === void 0 ? void 0 : user.emails[0];
                        idToken.email_verified = user.loginMethods.some(
                            (lm) => lm.hasSameEmailAs(idToken.email) && lm.verified
                        );
                    }
                    if (
                        (_c = consentRequest.requestedScope) === null || _c === void 0
                            ? void 0
                            : _c.includes("phoneNumber")
                    ) {
                        idToken.phoneNumber = user === null || user === void 0 ? void 0 : user.phoneNumbers[0];
