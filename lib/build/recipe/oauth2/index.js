...
exports.deleteOAuth2Client = exports.updateOAuth2Client = exports.createOAuth2Client = exports.getOAuth2Clients = exports.init = void 0;
const recipe_1 = __importDefault(require("./recipe"));
class Wrapper {
    static async getOAuth2Clients(input, userContext) {
        return await recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.getOAuth2Clients(input, userContext);
    }
    static async createOAuth2Client(input, userContext) {
        return await recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.createOAuth2Client(input, userContext);
    }
    static async updateOAuth2Client(input, userContext) {
        return await recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.updateOAuth2Client(input, userContext);
    }
    static async deleteOAuth2Client(input, userContext) {
        return await recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.deleteOAuth2Client(input, userContext);
    }
}
