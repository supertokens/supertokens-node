...
function getRecipeInterface(querier, config) {
    ...
    void config;
    return {
        createOrUpdateClient: async function ({ tenantId, clientId, clientSecret, redirectURIs, defaultRedirectURI, metadataXML, allowIDPInitiatedLogin, enableRequestSigning, userContext, }) {
        ...
        listClients: async function ({ tenantId, userContext }) {
            return await querier.sendGetRequest({
                path: "/<tenantId>/recipe/saml/clients/list",
                params: { tenantId },
            }, {}, userContext);
        },
        removeClient: async function ({ tenantId, clientId, userContext }) {
