...
exports.default = callbackAPI;
const utils_1 = require("../../../utils");
async function callbackAPI(apiImplementation, tenantId, options, userContext) {
    if (apiImplementation.callbackPOST === undefined) {
        return false;
    }
    const inputBody = await options.req.getBodyAsJSONOrFormData();
    const samlResponse = inputBody.SAMLResponse;
    const relayState = inputBody.RelayState;
