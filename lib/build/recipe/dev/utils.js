...
function isUsingDevelopmentClientId() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (
                var thirdPartyProvidersClientIds_1 = __asyncValues(utils_1.thirdPartyProvidersClientIds),
                    thirdPartyProvidersClientIds_1_1;
                (thirdPartyProvidersClientIds_1_1 = yield thirdPartyProvidersClientIds_1.next()),
                    !thirdPartyProvidersClientIds_1_1.done;

            ) {
                const clientId = thirdPartyProvidersClientIds_1_1.value;
            ...
            try {
                if (
                    thirdPartyProvidersClientIds_1_1 &&
                    !thirdPartyProvidersClientIds_1_1.done &&
                    (_a = thirdPartyProvidersClientIds_1.return)
                )
                    yield _a.call(thirdPartyProvidersClientIds_1);
            } finally {
