...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (_, __, ___, ____, _____) => __awaiter(this, void 0, void 0, function* () {
    ...
    static getInstanceOrThrowError() {
        ...
        throw new Error("Initialisation not done. Did you forget to call the UserMetadata.init or SuperTokens.init function?");
    }
    static init(config) {
