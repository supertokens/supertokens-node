...
function getRecipeImplementation(_querier, config) {
    ...
    return {
        ...
        getProviderConfig: async function ({ clientId }) {
            ...
            const providerConfig = config.providerConfigs.find((providerConfig) => providerConfig.clientId === clientId);
            ...
            providerConfigsWithOIDCInfo[clientId] = Object.assign(Object.assign({}, providerConfig), { authorizationEndpoint: oidcInfo.authorization_endpoint, tokenEndpoint: oidcInfo.token_endpoint, userInfoEndpoint: oidcInfo.userinfo_endpoint, jwksURI: oidcInfo.jwks_uri });
            return providerConfigsWithOIDCInfo[clientId];
        },
        ...
        getUserInfo: async function ({ providerConfig, oAuthTokens }) {
            ...
            if (idToken && providerConfig.jwksURI !== undefined) {
                ...
                rawUserInfo.fromIdTokenPayload = await thirdpartyUtils_1.verifyIdTokenFromJWKSEndpointAndGetPayload(idToken, jwks, {
