...
function getAPIInterface(stInstance, multiFactorAuthClaim) {
    return {
        resyncSessionAndFetchMFAInfoPUT: async ({ options, session, userContext }) => {
            ...
            const nextSetOfUnsatisfiedFactors = multiFactorAuthClaim.getNextSetOfUnsatisfiedFactors(mfaInfo.completedFactors, mfaInfo.mfaRequirementsForAuth);
