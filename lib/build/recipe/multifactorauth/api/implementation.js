...
function getAPIInterface() {
    return {
        resyncSessionAndFetchMFAInfoPUT: async ({ options, session, userContext }) => {
            ...
            const completedFactorsClaimValue = await session.getClaimValue(multiFactorAuthClaim_1.MultiFactorAuthClaim, userContext);
            ...
            for (const id of availableFactors) {
                try {
                    await options.recipeImplementation.assertAllowedToSetupFactorElseThrowInvalidClaimError({
                        ...
                        factorId: id,
                        completedFactors: completedFactors,
                        requiredSecondaryFactorsForTenant: (_c = tenantInfo === null || tenantInfo === void 0 ? void 0 : tenantInfo.requiredSecondaryFactors) !== null && _c !== void 0 ? _c : [],
                        requiredSecondaryFactorsForUser,
                        factorsSetUpForUser: isAlreadySetup,
            ...
            const c = (_e = (_d = (await session.getClaimValue(multiFactorAuthClaim_1.MultiFactorAuthClaim, userContext))) === null || _d === void 0 ? void 0 : _d.c) !== null && _e !== void 0 ? _e : {};
            const nextSetOfUnsatisfiedFactors = multiFactorAuthClaim_1.MultiFactorAuthClaim.getNextSetOfUnsatisfiedFactors(c, mfaRequirementsForAuth);
            await session.fetchAndSetClaim(multiFactorAuthClaim_1.MultiFactorAuthClaim, userContext); // updates `v` in the MFA claim
            ...
            return {
                status: "OK",
                factors: {
                    next: nextSetOfUnsatisfiedFactors.factorIds.filter((factorId) => isAllowedToSetup.includes(factorId) || isAlreadySetup.includes(factorId)),
                    isAlreadySetup,
                    isAllowedToSetup,
                },
