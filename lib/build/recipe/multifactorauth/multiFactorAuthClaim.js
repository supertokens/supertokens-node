...
class MultiFactorAuthClaimClass extends claims_1.SessionClaim {
    constructor(stInstanceGetter, key) {
        super(key !== null && key !== void 0 ? key : "st-mfa");
        this.stInstanceGetter = stInstanceGetter;
                ...
                validate: async (payload) => {
                    ...
                    if (nextSetOfUnsatisfiedFactors.type === "string") {
                        return {
                            isValid: false,
                            reason: {
                                message: "Factor validation failed: " +
                        ...
                        return {
                            isValid: false,
                            reason: {
                                message: "None of these factors are complete in the session: " +
                        ...
                        return {
                            isValid: false,
                            reason: {
                                message: "Some of the factors are not complete in the session: " +
                                    nextSetOfUnsatisfiedFactors.factorIds.join(", "),
