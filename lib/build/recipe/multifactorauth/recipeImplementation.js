...
function getRecipeInterface(recipeInstance) {
    return {
        ...
        markFactorAsCompleteInSession: async function ({ session, factorId, userContext }) {
            const currentClaimValue = await session.getClaimValue(multiFactorAuthClaim_1.MultiFactorAuthClaim);
            const updatedCompletedFactors = Object.assign(
                Object.assign(
                    {},
                    currentClaimValue === null || currentClaimValue === void 0 ? void 0 : currentClaimValue.c
                ),
            ...
            await session.setClaimValue(multiFactorAuthClaim_1.MultiFactorAuthClaim, {
                ...
                v:
                    (currentClaimValue === null || currentClaimValue === void 0 ? void 0 : currentClaimValue.v) ==
                    undefined
                        ? false
                        : currentClaimValue.v,
            });
            await session.fetchAndSetClaim(multiFactorAuthClaim_1.MultiFactorAuthClaim, userContext); // updates value for `v`
        },
