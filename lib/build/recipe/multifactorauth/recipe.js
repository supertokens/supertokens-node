...
const utils_2 = require("../accountlinking/utils");
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getFactorsSetupForUser = async (user, userContext) => {
            let factorIds = [];
        ...
        this.verifyEmailForRecipeUserIfLinkedAccountsAreVerified =
            utils_2.verifyEmailForRecipeUserIfLinkedAccountsAreVerified;
        this.config = utils_1.validateAndNormaliseUserInput(config);
        this.isInServerlessEnv = isInServerlessEnv;
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(this.config, this));
