...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = async (id, _tenantId, req, res, _, __, userContext) => {
            ...
            if (id === constants_1.RESYNC_SESSION_AND_FETCH_MFA_INFO) {
                return await resyncSessionAndFetchMFAInfo_1.default(this.apiImpl, options, userContext);
            }
    ...
    async checkIfLinkingAllowed(session, user, factorIds, accountInfo, userContext) {
        logger_1.logDebugMessage("checkIfLinkingAllowed called");
        ...
        for (const id of factorIds) {
            ...
            logger_1.logDebugMessage(
                `checkIfLinkingAllowed checking assertAllowedToSetupFactorElseThrowInvalidClaimError`
            );
            try {
