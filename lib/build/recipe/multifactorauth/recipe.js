...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
            ...
            return [
                {
                    ...
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        constants_1.UPDATE_SESSION_AND_GET_MFA_INFO
                    ),
                    id: constants_1.UPDATE_SESSION_AND_GET_MFA_INFO,
        ...
        this.handleAPIRequest = async (id, _tenantId, req, res, _, __, userContext) => {
            ...
            if (id === constants_1.UPDATE_SESSION_AND_GET_MFA_INFO) {
        ...
        this.getEmailsForFactors = (_user) => {
            let result = {};
            for (const func of this.getEmailsForFactorFromOtherRecipesFunc) {
                result = Object.assign(Object.assign({}, result), func(_user));
            }
            return result;
        };
        ...
        this.getPhoneNumbersForFactors = (_user) => {
            let result = {};
