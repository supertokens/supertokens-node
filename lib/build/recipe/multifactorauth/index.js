...
exports.MultiFactorAuthClaim = exports.addToDefaultRequiredFactorsForUser = exports.markFactorAsCompleteInSession = exports.init = void 0;
...
const __1 = require("../..");
class Wrapper {
    static async getFactorsSetUpByUser(userId, userContext) {
    ...
    static async addToDefaultRequiredFactorsForUser(userId, factorId, userContext) {
        ...
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.addToDefaultRequiredFactorsForUser({
            factorId,
            user,
            userContext: ctx,
        });
