...
class Wrapper {
    static async checkAllowedToSetupFactorElseThrowInvalidClaimError(session, factorId, userContext) {
        var _a, _b;
        ...
        recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.checkAllowedToSetupFactorElseThrowInvalidClaimError({
                session,
                factorId,
                completedFactors,
...
exports.checkAllowedToSetupFactorElseThrowInvalidClaimError =
