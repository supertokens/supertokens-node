...
class Wrapper {
    static async assertAllowedToSetupFactorElseThrowInvalidClaimError(session, factorId, userContext) {
        ...
        await recipe_1.default
            ...
            .assertAllowedToSetupFactorElseThrowInvalidClaimError(session, factorId, ctx);
    }
...
Wrapper.MultiFactorAuthClaim = new multiFactorAuthClaim_1.MultiFactorAuthClaimClass(() =>
    supertokens_1.default.getInstanceOrThrowError()
);
