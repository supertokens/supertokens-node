...
export type ValidateOAuth2AccessTokenResponse = {
    status: "OK";
    payload: JSONObject;
};
export type RevokeTokensByClientIdResponse = {
    status: "OK";
};
export type RevokeTokensBySessionHandleResponse = {
    status: "OK";
};
export type RejectLogoutRequestResponse = {
    status: "OK";
};
