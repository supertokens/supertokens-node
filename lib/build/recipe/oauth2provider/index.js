...
exports.revokeTokensBySessionHandle = exports.revokeTokensByClientId = exports.revokeToken = exports.createTokenForClientCredentials = exports.validateOAuth2RefreshToken = exports.validateOAuth2AccessToken = exports.deleteOAuth2Client = exports.updateOAuth2Client = exports.createOAuth2Client = exports.getOAuth2Clients = exports.getOAuth2Client = exports.init = void 0;
...
class Wrapper {
    ...
    static async getOAuth2Clients(input, userContext) {
        return await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getOAuth2Clients(Object.assign(Object.assign({}, input), { userContext: (0, utils_1.getUserContext)(userContext) }));
    }
    static async createOAuth2Client(input, userContext) {
        return await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.createOAuth2Client(Object.assign(Object.assign({}, input), { userContext: (0, utils_1.getUserContext)(userContext) }));
    }
    static async updateOAuth2Client(input, userContext) {
        return await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.updateOAuth2Client(Object.assign(Object.assign({}, input), { userContext: (0, utils_1.getUserContext)(userContext) }));
    }
    static async deleteOAuth2Client(input, userContext) {
        return await recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.deleteOAuth2Client(Object.assign(Object.assign({}, input), { userContext: (0, utils_1.getUserContext)(userContext) }));
    }
