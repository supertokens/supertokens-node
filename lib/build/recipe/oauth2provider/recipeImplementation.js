...
function getRecipeInterface(
    ...
    return {
        ...
        endSession: async function (input) {
             ...
             */
            const resp = await querier.sendGetRequestWithResponseHeaders(
                new normalisedURLPath_1.default(`/recipe/oauth2/pub/sessions/logout`),
                input.params,
                {},
                input.userContext
            );
        ...
        acceptLogoutRequest: async function (input) {
            const resp = await querier.sendPutRequest(
                new normalisedURLPath_1.default(`/recipe/oauth2/admin/oauth2/auth/requests/logout/accept`),
                {},
        ...
        rejectLogoutRequest: async function (input) {
            const resp = await querier.sendPutRequest(
                new normalisedURLPath_1.default(`/recipe/oauth2/admin/oauth2/auth/requests/logout/reject`),
                {},
                { logout_challenge: input.challenge },
                input.userContext
            );
