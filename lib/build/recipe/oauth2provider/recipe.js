...
class Recipe extends recipeModule_1.default {
    constructor(stInstance, recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, _path, method, userContext) => {
            ...
            if (id === constants_1.LOGIN_PATH) {
                return (0, login_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            if (id === constants_1.TOKEN_PATH) {
                return (0, token_1.default)(this.apiImpl, options, userContext);
            }
            if (id === constants_1.AUTH_PATH) {
                return (0, auth_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            ...
            if (id === constants_1.USER_INFO_PATH) {
                return (0, userInfo_1.default)(this.stInstance, this.apiImpl, tenantId, options, userContext);
            }
            ...
            if (id === constants_1.END_SESSION_PATH && method === "get") {
                return (0, endSession_1.endSessionGET)(this.stInstance, this.apiImpl, options, userContext);
            }
            if (id === constants_1.END_SESSION_PATH && method === "post") {
                return (0, endSession_1.endSessionPOST)(this.stInstance, this.apiImpl, options, userContext);
            }
            if (id === constants_1.LOGOUT_PATH && method === "post") {
                return (0, logout_1.logoutPOST)(this.stInstance, this.apiImpl, options, userContext);
            }
        ...
        {
            let builder = new supertokens_js_override_1.default((0, recipeImplementation_1.default)(this.stInstance, this.querier, this.config, appInfo, this.getDefaultAccessTokenPayload.bind(this), this.getDefaultIdTokenPayload.bind(this), this.getDefaultUserInfoPayload.bind(this)));
    ...
    async getDefaultAccessTokenPayload(user, scopes, sessionHandle, userContext) {
        ...
        if (scopes.includes("email")) {
            ...
            payload.email_verified = user.loginMethods.some((lm) => lm.hasSameEmailAs(user === null || user === void 0 ? void 0 : user.emails[0]) && lm.verified);
        ...
        if (scopes.includes("phoneNumber")) {
            ...
            payload.phoneNumber_verified = user.loginMethods.some((lm) => lm.hasSamePhoneNumberAs(user === null || user === void 0 ? void 0 : user.phoneNumbers[0]) && lm.verified);
    ...
    async getDefaultUserInfoPayload(user, accessTokenPayload, scopes, tenantId, userContext) {
        ...
        for (const fn of this.userInfoBuilders) {
            payload = Object.assign(Object.assign({}, payload), (await fn(user, accessTokenPayload, scopes, tenantId, userContext)));
        }
        return payload;
    }
}
