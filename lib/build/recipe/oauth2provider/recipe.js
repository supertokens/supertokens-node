    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = async (id, tenantId, req, res, _path, method, userContext) => {
            ...
            if (id === constants_1.END_SESSION_PATH && method === "get") {
                return endSession_1.endSessionGET(this.apiImpl, options, userContext);
            }
            if (id === constants_1.END_SESSION_PATH && method === "post") {
                return endSession_1.endSessionPOST(this.apiImpl, options, userContext);
            }
            if (id === constants_1.LOGOUT_PATH && method === "post") {
                return logout_1.logoutPOST(this.apiImpl, options, userContext);
            }
        ...
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipeId), this.config, appInfo, this.getDefaultAccessTokenPayload.bind(this), this.getDefaultIdTokenPayload.bind(this), this.getDefaultUserInfoPayload.bind(this)));
