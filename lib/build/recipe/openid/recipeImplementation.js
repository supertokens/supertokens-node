...
function getRecipeInterface(stInstance, appInfo) {
    return {
        getOpenIdDiscoveryConfiguration: async function () {
            ...
            let jwks_uri = appInfo.apiDomain.getAsStringDangerous() +
                appInfo.apiBasePath.appendPath(new normalisedURLPath_1.default(constants_1.GET_JWKS_API)).getAsStringDangerous();
