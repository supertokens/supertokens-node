...
function getRecipeInterface(config, jwtRecipeImplementation) {
    return {
        getOpenIdDiscoveryConfiguration: function ({ options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let issuerDomain = yield config.issuerDomain(options.req, userContext);
        ...
        createJWT: function ({ req, payload, validitySeconds, useStaticSigningKey, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                payload = payload === undefined || payload === null ? {} : payload;
                let issuerDomain = yield config.issuerDomain(req, userContext);
                let issuer = issuerDomain.getAsStringDangerous() + config.issuerPath.getAsStringDangerous();
