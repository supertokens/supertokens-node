...
class OpenIdRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, response, path, method) => __awaiter(this, void 0, void 0, function* () {
            let apiOptions = {
        ...
        this.handleError = (error, request, response) => __awaiter(this, void 0, void 0, function* () {
        ...
        let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(this.config, this.jwtRecipe.recipeInterfaceImpl));
