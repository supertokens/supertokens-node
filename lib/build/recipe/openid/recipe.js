...
class OpenIdRecipe extends recipeModule_1.default {
    constructor(stInstance, recipeId, appInfo, config) {
        ...
        let builder = new supertokens_js_override_1.default((0, recipeImplementation_1.default)(stInstance, appInfo));
    ...
    static init(config) {
        return (stInstance, appInfo, _isInServerlessEnv, plugins) => {
            if (OpenIdRecipe.instance === undefined) {
                OpenIdRecipe.instance = new OpenIdRecipe(stInstance, OpenIdRecipe.RECIPE_ID, appInfo, (0, plugins_1.applyPlugins)(OpenIdRecipe.RECIPE_ID, config, plugins !== null && plugins !== void 0 ? plugins : []));
                return OpenIdRecipe.instance;
            }
            else {
