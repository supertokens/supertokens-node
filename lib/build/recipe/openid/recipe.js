...
class OpenIdRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, tenantId, req, response, path, method, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.GET_DISCOVERY_CONFIG_URL) {
                    return yield getOpenIdDiscoveryConfiguration_1.default(this.apiImpl, apiOptions, userContext);
                } else {
