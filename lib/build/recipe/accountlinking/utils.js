...
async function defaultOnAccountLinked(_user, _newAccountInfo, _userContext) {}
async function defaultShouldDoAutomaticAccountLinking(_newAccountInfo, _user, _session, _userContext) {
    return {
