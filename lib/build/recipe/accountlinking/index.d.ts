...
export default class Wrapper {
     ...
     */
    static createPrimaryUserIdOrLinkAccounts(tenantId: string, recipeUserId: RecipeUserId, userContext?: Record<string, any>): Promise<import("../../types").User>;
    /**
    ...
    static isSignUpAllowed(tenantId: string, newUser: AccountInfoWithRecipeId, isVerified: boolean, userContext?: Record<string, any>): Promise<boolean>;
    static isSignInAllowed(tenantId: string, recipeUserId: RecipeUserId, userContext?: Record<string, any>): Promise<boolean>;
    static isEmailChangeAllowed(recipeUserId: RecipeUserId, newEmail: string, isVerified: boolean, userContext?: Record<string, any>): Promise<boolean>;
}
