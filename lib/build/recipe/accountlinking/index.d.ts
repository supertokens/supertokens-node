...
export default class Wrapper {
    ...
    static canCreatePrimaryUser(
        recipeUserId: RecipeUserId,
        userContext?: Record<string, any>
    ): Promise<import("./types").CanCreatePrimaryUserResponse>;
    static createPrimaryUser(
        recipeUserId: RecipeUserId,
        userContext?: Record<string, any>
    ): Promise<import("./types").CreatePrimaryUserResponse>;
    static canLinkAccounts(
        recipeUserId: RecipeUserId,
        primaryUserId: string,
        userContext?: Record<string, any>
    ): Promise<import("./types").CanLinkAccountsResponse>;
    static linkAccounts(
        recipeUserId: RecipeUserId,
        primaryUserId: string,
        userContext?: Record<string, any>
    ): Promise<import("./types").LinkAccountsResponse>;
    static unlinkAccount(
        recipeUserId: RecipeUserId,
        userContext?: Record<string, any>
    ): Promise<import("./types").UnlinkAccountResponse>;
