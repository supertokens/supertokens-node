...
function getRecipeImplementation(querier, config) {
    return {
        ...
        linkAccounts: function ({ recipeUserId, primaryUserId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (accountsLinkingResult.status === "OK") {
                    ...
                    let recipeUser = yield __1.getUserForRecipeId(
        ...
        getPrimaryUserIdLinkedOrCanBeLinkedToRecipeUserId: function ({ recipeUserId }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(
                    new normalisedURLPath_1.default("/recipe/accountlinking/user/linked_or_linkable"),
                    {
                        recipeUserId,
                    }
                );
