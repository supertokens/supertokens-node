    ...
    return {
        getRecipeUserIdsForPrimaryUserIds: function ({ primaryUserIds, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/users"), {
        ...
        canCreatePrimaryUserId: function ({ recipeUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/primary/check"), {
                    recipeUserId,
                });
                return result;
            });
        ...
        createPrimaryUser: function ({ recipeUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/primary"), {
                    recipeUserId,
                });
                return result;
            });
        ...
        canLinkAccounts: function ({ recipeUserId, primaryUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link/check"), {
                    recipeUserId,
                    primaryUserId,
                });
                return result;
        ...
        linkAccounts: function ({ recipeUserId, primaryUserId, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let accountsLinkingResult = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link"), {
                    recipeUserId,
                    primaryUserId,
                });
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (primaryUserId === null) {
                    return {
                        ...
                        description: "The input recipeUserId is not linked to any primary user, or is not a primary user itself",
                    };
                }
                ...
                let accountsUnlinkingResult = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/unlink"), {
                    recipeUserId,
                    primaryUserId,
                });
        ...
        getUser: function ({ userId }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user"), {
                    userId,
                });
                if (result.status === "OK") {
                    return result.user;
        ...
        listUsersByAccountInfo: function ({ accountInfo }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/users/accountinfo"), Object.assign({}, accountInfo));
                return result.users;
            });
        },
        ...
        fetchFromAccountToLinkTable: function ({ recipeUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link/table"), {
                    recipeUserId,
                });
                return result.user;
            });
        ...
        storeIntoAccountToLinkTable: function ({ recipeUserId, primaryUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link/table"), {
                    recipeUserId,
                    primaryUserId,
                });
                return result;
