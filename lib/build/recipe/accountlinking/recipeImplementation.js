...
function getRecipeImplementation(querier, config) {
    return {
        ...
        createPrimaryUser: function ({ recipeUserId, session, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (session !== undefined) {
                    let recipeIdToLinkTo = yield session.getClaimValue(accountLinkingClaim_1.AccountLinkingClaim);
                    if (recipeIdToLinkTo !== undefined) {
                        ...
                        let primaryUserToLinkTo = yield this.fetchFromAccountToLinkTable({
                        ...
                        if (primaryUserToLinkTo === undefined || primaryUserToLinkTo !== session.getUserId()) {
                            ...
                            yield session.removeClaim(accountLinkingClaim_1.AccountLinkingClaim);
                        }
                    }
                }
                return response;
        ...
        linkAccounts: function ({ recipeUserId, primaryUserId, session, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
