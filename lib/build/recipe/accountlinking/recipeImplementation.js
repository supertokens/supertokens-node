...
function getRecipeImplementation(querier, config) {
    return {
        ...
        createPrimaryUser: function ({ recipeUserId, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let primaryUser = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/primary"), {
                    recipeUserId,
                });
        ...
        linkAccounts: function ({ recipeUserId, primaryUserId, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (accountsLinkingResult.status === "OK") {
                    ...
                    let recipeUser = yield __1.getUserForRecipeId(loginMethodInfo.recipeUserId, loginMethodInfo.recipeId);
                    if (recipeUser.user === undefined) {
                        throw Error("this error should never be thrown");
                    }
                    yield config.onAccountLinked(user, recipeUser.user, userContext);
                }
                else {
        ...
        listUsersByAccountInfo: function ({ info }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/users/accountinfo"), Object.assign({}, info));
                if (result.status === "OK") {
                    return result.users;
                }
                return undefined;
        ...
        getUserByAccountInfo: function ({ info }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/users/accountinfo"), Object.assign({}, info));
                if (result.status === "OK") {
        ...
        fetchFromAccountToLinkTable: function ({ recipeUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link"), {
                    recipeUserId,
                });
                return result.user;
            });
        ...
        storeIntoAccountToLinkTable: function ({ recipeUserId, primaryUserId, }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/accountlinking/user/link"), {
                    recipeUserId,
                    primaryUserId,
                });
                return result;
