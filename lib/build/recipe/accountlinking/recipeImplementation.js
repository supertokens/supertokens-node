...
function getRecipeImplementation(querier, config, recipeInstance) {
    return {
        ...
        getUser: async function ({ userId, userContext, useCoreCallCache }) {
            var _a, _b, _c, _d, _e;
            if (useCoreCallCache) {
                if (
                    (((_b = (_a = userContext._default) === null || _a === void 0 ? void 0 : _a.coreCache) === null ||
                    _b === void 0
                        ? void 0
                        : _b.userById) || {})[userId]
                ) {
            ...
            if (result.status === "OK") {
                ...
                if (useCoreCallCache) {
                    userContext._default = Object.assign(Object.assign({}, userContext._default), {
                        coreCache: Object.assign(
                            Object.assign(
                                {},
                                (_c = userContext._default) === null || _c === void 0 ? void 0 : _c.coreCache
                            ),
                            {
                                userById: Object.assign(
                                    Object.assign(
                                        {},
                                        (_e =
                                            (_d = userContext._default) === null || _d === void 0
                                                ? void 0
                                                : _d.coreCache) === null || _e === void 0
                                            ? void 0
                                            : _e.userById
                                    ),
                                    { [userId]: userResult }
