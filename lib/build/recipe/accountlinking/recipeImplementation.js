...
function getRecipeImplementation(querier, config) {
    return {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i < user.emails.length; i++) {
                    usersForAccountInfo.push(
                        ...(yield this.listUsersByAccountInfo({
                            info: {
                                email: user.emails[i],
                            },
                            userContext,
        ...
        linkAccounts: function ({ recipeUserId, primaryUserId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (accountsLinkingResult.status === "OK") {
                    ...
                    let recipeUser = yield utils_1.getUserForRecipeId(
                        recipeUserObj.recipeUserId,
                        recipeUserObj.recipeId
                    );
        ...
        getUser: function ({ userId }) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/user"), {
                    userId,
                });
                if (result.status === "OK") {
                    return result.user;
        ...
        listUsersByAccountInfo: function ({ info }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let result = yield querier.sendGetRequest(
                    new normalisedURLPath_1.default("/recipe/users"),
                    Object.assign({}, info)
                );
                if (result.status === "OK") {
                    return result.user;
