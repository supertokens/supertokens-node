...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.isSignUpAllowed = ({ info, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            let identifier;
            ...
            let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(info, primaryUser, undefined, userContext);
        ...
        this.doPostSignUpAccountLinkingOperations = ({ info, infoVerified, recipeUserId, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(info, undefined, undefined, userContext);
            ...
            shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(info, primaryUser, undefined, userContext);
        ...
        this.accountLinkPostSignInViaSession = ({ session, info, infoVerified, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user.isPrimaryUser) {
                ...
                shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(recipeUser.user, undefined, session, userContext);
                if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                    return {
                        createRecipeUser: false,
                        accountsLinked: false,
             ...
             * and new login info
             */
            let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(info, user, session, userContext);
            if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                return {
                    createRecipeUser: false,
                    accountsLinked: false,
            ...
            if (recipeUser === undefined) {
                ...
                if (info.email !== undefined) {
                    let result = identitiesForPrimaryUser.verified.emails.includes(info.email) ||
                ...
                if (info.phoneNumber !== undefined) {
                    let result = identitiesForPrimaryUser.verified.phoneNumbers.includes(info.phoneNumber) ||
        ...
        this.getPrimaryUserIdThatCanBeLinkedToRecipeUserId = ({ recipeUserId, userContext, }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.createPrimaryUserIdOrLinkAccounts = ({ recipeUserId, session, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (primaryUser === undefined) {
                ...
                let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(Object.assign({}, user.loginMethods[0]), undefined, session, userContext);
                if (shouldDoAccountLinking.shouldAutomaticallyLink) {
                ...
                if (recipeUser === undefined) {
                    ...
                    let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(Object.assign({}, user.loginMethods[0]), primaryUser, session, userContext);
                    if (shouldDoAccountLinking.shouldAutomaticallyLink) {
