            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (primaryUser === undefined) {
                    ...
                    if (user.isPrimaryUser) {
                        ...
                        return yield this.createPrimaryUserIdOrLinkAccountsAfterEmailVerification({
                            recipeUserId,
                            session,
                            userContext,
                        });
                    ...
                    if (recipeUser === undefined) {
                        ...
                        if (shouldDoAccountLinking.shouldAutomaticallyLink) {
                            ...
                            if (linkAccountsResult.status === "OK") {
                                ...
                                if (session !== undefined) {
                                    let existingSessionClaimValue = yield session.getClaimValue(
                                        accountLinkingClaim_1.AccountLinkingClaim,
                                        userContext
                                    );
                                    if (existingSessionClaimValue !== undefined) {
                                        yield session.removeClaim(
                                            accountLinkingClaim_1.AccountLinkingClaim,
                                            userContext
                                        );
                                    } else {
