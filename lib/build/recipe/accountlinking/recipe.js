...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.createPrimaryUserIdOrLinkByAccountInfoOrLinkToSessionIfProvided = async ({
            ...
            logger_1.logDebugMessage("createPrimaryUserIdOrLinkAccounts got session");
            ...
            if (sessionUser.isPrimaryUser) {
                logger_1.logDebugMessage("createPrimaryUserIdOrLinkAccounts session user already primary");
                ...
                logger_1.logDebugMessage("createPrimaryUserIdOrLinkAccounts trying to make session user primary");
