    ...
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.createPrimaryUserIdOrLinkAccounts = ({
            ...
            __awaiter(this, void 0, void 0, function* () {
                let recipeUser = yield this.recipeInterfaceImpl.getUser({ userId: recipeUserId, userContext });
        ...
        this.getPrimaryUserIdThatCanBeLinkedToRecipeUserId = ({
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                let user = yield this.recipeInterfaceImpl.getUser({ userId: recipeUserId, userContext });
                if (user === undefined) {
                    return undefined;
                }
