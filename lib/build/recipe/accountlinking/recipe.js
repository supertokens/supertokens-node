    ...
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.createPrimaryUserIdOrLinkByAccountInfoOrLinkToSessionIfProvided = async ({
            ...
            if (authTypeRes.isFirstFactor) {
                ...
                const linkRes = await this.tryLinkingByAccountInfoOrCreatePrimaryUser({
                    inputUser: inputUser,
                    session,
                    tenantId,
                    userContext,
         ...
         */
        this.tryAndMakeSessionUserIntoAPrimaryUser = async function (session, userContext) {
            ...
            if (sessionUser.isPrimaryUser) {
                ...
                if (shouldDoAccountLinking.shouldAutomaticallyLink) {
                    ...
                    const createPrimaryUserRes = await this.recipeInterfaceImpl.createPrimaryUser({
        ...
        while (tries++ < 100) {
            ...
            if (primaryUserThatCanBeLinkedToTheInputUser !== undefined) {
                ...
                if (
                    ...
                    if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                        logger_1.logDebugMessage(
                            "tryLinkAccounts: not linking because shouldAutomaticallyLink is false"
                        );
