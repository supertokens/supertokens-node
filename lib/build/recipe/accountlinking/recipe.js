...
class AccountLinkingRecipe extends recipeModule_1.default {
    constructor() {
        ...
        super(...arguments);
        this.isSignUpAllowed = (input) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.createPrimaryUserIdOrLinkAccountPostSignUp = (input) => __awaiter(this, void 0, void 0, function* () {
            // TODO
        });
        this.accountLinkPostSignInViaSession = (input) => __awaiter(this, void 0, void 0, function* () {
    ...
    handleAPIRequest(id, req, response, path, method) {
        throw new Error("Method not implemented.");
    }
