...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.purgeSessionOfAccountLinkingClaimIfRequired = function (recipeInterface, session, userContext) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (recipeIdToLinkTo !== undefined) {
                    ...
                    let primaryUserToLinkTo = yield recipeInterface.fetchFromAccountToLinkTable({
