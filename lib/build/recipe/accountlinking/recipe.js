...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.createPrimaryUserIdOrLinkAccounts = ({ recipeUserId, isVerified, checkAccountsToLinkTableAsWell, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (primaryUser === undefined) {
                ...
                // not a primary user.
                let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(recipeUser.loginMethods[0], undefined, undefined, userContext);
                ...
                // we can use the 0 index cause this user is
                // not a primary user.
                let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(recipeUser.loginMethods[0], primaryUser, undefined, userContext);
                if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                    return recipeUserId;
                }
                if (shouldDoAccountLinking.shouldRequireVerification && !isVerified) {
        ...
        this.getPrimaryUserIdThatCanBeLinkedToRecipeUserId = ({ recipeUserId, checkAccountsToLinkTableAsWell, userContext, }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.isSignUpAllowed = ({ newUser, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            let shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(newUser, primaryUser, undefined, userContext);
            if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                return true;
            }
        ...
        this.linkAccountsWithUserFromSession = ({ session, newUser, createRecipeUserFunc, userContext, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingUser === undefined) {
                ...
                return {
                    ...
                    description: "We cannot link accounts since the session belongs to a user ID that does not exist in SuperTokens.",
                };
            }
            if (!existingUser.isPrimaryUser) {
                ...
                const shouldDoAccountLinkingOfNewUser = yield this.config.shouldDoAutomaticAccountLinking(newUser, undefined, session, userContext);
                ...
                const shouldDoAccountLinkingOfExistingUser = yield this.config.shouldDoAutomaticAccountLinking(existingUser.loginMethods[0], undefined, session, userContext);
                ...
                if (shouldDoAccountLinkingOfExistingUser.shouldRequireVerification &&
                    ...
                    yield session.assertClaims([emailVerificationClaim_1.EmailVerificationClaim.validators.isVerified(undefined, 0)]);
                }
                ...
                if (createPrimaryUserResult.status === "RECIPE_USER_ID_ALREADY_LINKED_WITH_PRIMARY_USER_ID_ERROR") {
                ...
                else if (createPrimaryUserResult.status === "ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR") {
                    ...
                    return {
                        status: "ACCOUNT_LINKING_NOT_ALLOWED_ERROR",
                        description: "No account can be linked to the session account cause the session account is not a primary account and the account info is already associated with another primary account, so we cannot make this a primary account either. Please contact support.",
                    };
                }
            ...
            const shouldDoAccountLinking = yield this.config.shouldDoAutomaticAccountLinking(newUser, existingUser, session, userContext);
            if (!shouldDoAccountLinking.shouldAutomaticallyLink) {
                return {
                    status: "ACCOUNT_LINKING_NOT_ALLOWED_ERROR",
                    description: "Account linking not allowed by the developer for new user.",
            ...
            const userObjThatHasSameAccountInfoAndRecipeIdAsNewUser = usersArrayThatHaveSameAccountInfoAsNewUser.find((u) => u.loginMethods.find((lU) => {
                let found = false;
        ...
        {
            let builder = new supertokens_js_override_1.default(recipeImplementation_1.default(querier_1.Querier.getNewInstanceOrThrowError(recipeId), this.config));
