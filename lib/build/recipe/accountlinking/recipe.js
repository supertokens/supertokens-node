    ...
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.isSignUpAllowed = ({ info, userContext }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                let identitiesForPrimaryUser = yield this.getIdentitiesForUser(primaryUser);
                if (info.email !== undefined) {
        ...
        this.accountLinkPostSignInViaSession = ({ session, info, infoVerified, userContext }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (!user.isPrimaryUser) {
                    ...
                    let recipeUser = yield utils_1.getUserForRecipeId(user.id, recipeId);
                ...
                if (recipeUser === undefined) {
                     ...
                     */
                    let identitiesForPrimaryUser = yield this.getIdentitiesForUser(user);
                    if (info.email !== undefined) {
                        let result =
