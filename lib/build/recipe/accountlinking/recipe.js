...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config, _recipes, _ingredients) {
        ...
        this.createPrimaryUserIdOrLinkAccounts = ({ tenantId, recipeUserId, userContext }) =>
        ...
        this.isSignInAllowed = ({ recipeUserId, userContext }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    let emailInfo = yield recipe_1.default
                        .getInstanceOrThrowError()
                        .getEmailForRecipeUserId(user.loginMethods[0].recipeUserId, userContext);
                    if (emailInfo.status === "OK") {
                        isVerified = yield recipe_1.default
                            .getInstanceOrThrowError()
                            .recipeInterfaceImpl.isEmailVerified({
                ...
                if (user.isPrimaryUser) {
                    ...
                    if (recipeUserEmail !== undefined) {
                        ...
                        if (shouldVerifyEmail) {
                            let resp = yield recipe_1.default
                                .getInstanceOrThrowError()
                            ...
                            if (resp.status === "OK") {
                                ...
                                yield recipe_1.default
                                    .getInstanceOrThrowError()
                                    .recipeInterfaceImpl.verifyEmailUsingToken({
                                        tenantId: input.tenantId,
                                        token: resp.token,
