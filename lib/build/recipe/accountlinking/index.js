...
class Wrapper {
    ...
    static getPrimaryUserIdsforRecipeUserIds(recipeUserIds, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getPrimaryUserIdsforRecipeUserIds({
                recipeUserIds,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    ...
    static addNewRecipeUserIdWithoutPrimaryUserId(recipeUserId, recipeId, timeJoined, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.addNewRecipeUserIdWithoutPrimaryUserId({
                recipeUserId,
                recipeId,
                timeJoined,
                userContext: userContext === undefined ? {} : userContext,
    ...
    static getPrimaryUserIdLinkedOrCanBeLinkedToRecipeUserId(recipeUserId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().getPrimaryUserIdThatCanBeLinkedToRecipeUserId({
                recipeUserId,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    ...
    static createPrimaryUserIdOrLinkAccounts(recipeUserId, session, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().createPrimaryUserIdOrLinkAccounts({
                recipeUserId,
                session,
                userContext: userContext === undefined ? {} : userContext,
            });
    ...
    static onAccountLinked(user, newAccountInfo, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            userContext = userContext === undefined ? {} : userContext;
            return yield recipe_1.default.getInstanceOrThrowError().config.onAccountLinked(user, newAccountInfo, userContext);
        });
    }
    static shouldDoAutomaticAccountLinking(newAccountInfo, user, session, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            userContext = userContext === undefined ? {} : userContext;
    ...
    static getIdentitiesForUser(user) {
        return recipe_1.default.getInstanceOrThrowError().getIdentitiesForUser(user);
    }
...
exports.getPrimaryUserIdLinkedOrCanBeLinkedToRecipeUserId = Wrapper.getPrimaryUserIdLinkedOrCanBeLinkedToRecipeUserId;
...
exports.onAccountLinked = Wrapper.onAccountLinked;
exports.shouldDoAutomaticAccountLinking = Wrapper.shouldDoAutomaticAccountLinking;
exports.getIdentitiesForUser = Wrapper.getIdentitiesForUser;
