...
class Wrapper {
    ...
    static onAccountLinked(user, newAccountInfo, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield recipe_1.default
                .getInstanceOrThrowError()
                .config.onAccountLinked(user, newAccountInfo, userContext);
        });
    }
    static shouldDoAutomaticAccountLinking(newAccountInfo, user, session, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield recipe_1.default
                .getInstanceOrThrowError()
                .config.shouldDoAutomaticAccountLinking(newAccountInfo, user, session, userContext);
        });
    }
    ...
    static fetchFromAccountToLinkTable(recipeUserId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield recipe_1.default
                .getInstanceOrThrowError()
                .recipeInterfaceImpl.fetchFromAccountToLinkTable({ recipeUserId, userContext });
        });
    }
    static storeIntoAccountToLinkTable(recipeUserId, primaryUserId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield recipe_1.default
                .getInstanceOrThrowError()
                .recipeInterfaceImpl.storeIntoAccountToLinkTable({ recipeUserId, primaryUserId, userContext });
        });
    }
}
