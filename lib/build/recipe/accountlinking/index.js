...
class Wrapper {
    ...
    static createPrimaryUserIdOrLinkAccounts(input) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().createPrimaryUserIdOrLinkAccounts({
                ...
                session: (_b = input.session) !== null && _b !== void 0 ? _b : undefined,
    ...
    static linkAccountsWithUserFromSession(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().linkAccountsWithUserFromSession({
