...
class Wrapper {
    ...
    static getUsers(timeJoinedOrder, limit, paginationToken, includeRecipeIds, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsers({
                timeJoinedOrder,
                limit,
                paginationToken,
                includeRecipeIds,
    ...
    static deleteUser(userId, removeAllLinkedAccounts, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.getUsers = Wrapper.getUsers;
...
exports.getUser = Wrapper.getUser;
exports.listUsersByAccountInfo = Wrapper.listUsersByAccountInfo;
exports.getUserByAccountInfo = Wrapper.getUserByAccountInfo;
exports.deleteUser = Wrapper.deleteUser;
