...
exports.sendEmail = exports.sendPasswordResetEmail = exports.generatePasswordResetLink = exports.updateEmailOrPassword = exports.resetPasswordUsingToken = exports.createResetPasswordToken = exports.getUsersByEmail = exports.getUserByThirdPartyInfo = exports.getUserById = exports.thirdPartyManuallyCreateOrUpdateUser = exports.thirdPartyGetProvider = exports.emailPasswordSignIn = exports.emailPasswordSignUp = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static generatePasswordResetLink(userId, tenantId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static sendPasswordResetEmail(userId, tenantId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            let link = yield exports.generatePasswordResetLink(userId, tenantId, userContext);
...
exports.generatePasswordResetLink = Wrapper.generatePasswordResetLink;
exports.sendPasswordResetEmail = Wrapper.sendPasswordResetEmail;
