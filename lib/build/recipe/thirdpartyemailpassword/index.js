...
exports.sendEmail = exports.sendResetPasswordEmail = exports.createResetPasswordLink = exports.updateEmailOrPassword = exports.consumePasswordResetToken = exports.createResetPasswordToken = exports.thirdPartyManuallyCreateOrUpdateUser = exports.thirdPartyGetProvider = exports.emailPasswordSignIn = exports.emailPasswordSignUp = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static async createResetPasswordLink(tenantId, userId, email, userContext) {
        let token = await exports.createResetPasswordToken(userId, tenantId, email, userContext);
    ...
    static async sendResetPasswordEmail(tenantId, userId, email, userContext) {
        let link = await exports.createResetPasswordLink(userId, tenantId, email, userContext);
