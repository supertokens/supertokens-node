...
exports.sendEmail = exports.GitLab = exports.Bitbucket = exports.GoogleWorkspaces = exports.Discord = exports.Apple = exports.Facebook = exports.Github = exports.Google = exports.getPasswordResetTokenInfo = exports.updateEmailOrPassword = exports.consumePasswordResetToken = exports.createResetPasswordToken = exports.thirdPartySignInUp = exports.emailPasswordSignIn = exports.emailPasswordSignUp = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static emailPasswordSignUp(email, password, attemptAccountLinking = true, userContext = {}) {
    ...
    static emailPasswordSignIn(email, password, attemptAccountLinking = true, userContext = {}) {
    ...
    static getPasswordResetTokenInfo(token, userContext = {}) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getPasswordResetTokenInfo({
            token,
            userContext,
        });
    }
...
exports.getPasswordResetTokenInfo = Wrapper.getPasswordResetTokenInfo;
