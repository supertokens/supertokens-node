...
class Wrapper {
    ...
    static async sendEmail(input) {
        return await recipe_1.default.getInstanceOrThrowError().emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign(Object.assign({}, input), { userContext: utils_2.getUserContext(input.userContext), tenantId: input.tenantId === undefined ? constants_1.DEFAULT_TENANT_ID : input.tenantId }));
    }
}
