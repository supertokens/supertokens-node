...
exports.sendEmail = exports.sendResetPasswordEmail = exports.createResetPasswordLink = exports.updateEmailOrPassword = exports.consumePasswordResetToken = exports.resetPasswordUsingToken = exports.createResetPasswordToken = exports.thirdPartyManuallyCreateOrUpdateUser = exports.thirdPartyGetProvider = exports.emailPasswordVerifyCredentials = exports.emailPasswordSignIn = exports.emailPasswordSignUp = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static emailPasswordSignUp(tenantId, email, password, session, userContext) {
    ...
    static emailPasswordVerifyCredentials(tenantId, email, password, userContext) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.emailPasswordVerifyCredentials({
            email,
            password,
    ...
    static emailPasswordSignIn(tenantId, email, password, session, userContext) {
    ...
    static async resetPasswordUsingToken(tenantId, token, newPassword, session, userContext) {
    ...
    static consumePasswordResetToken(tenantId, token, session, userContext) {
...
exports.emailPasswordVerifyCredentials = Wrapper.emailPasswordVerifyCredentials;
