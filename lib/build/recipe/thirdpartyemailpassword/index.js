...
class Wrapper {
    ...
    static emailPasswordSignUp(email, password, doAutomaticAccountLinking = false, userContext = {}) {
    ...
    static updateEmailOrPassword(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.updateEmailOrPassword(Object.assign({ userContext: {} }, input));
    }
