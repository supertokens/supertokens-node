    ...
    return {
        emailPasswordSignUp: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield originalEmailPasswordImplementation.signUp.bind(emailPasswordRecipeImplementation_1.default(this))(input);
            });
        },
        emailPasswordSignIn: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                return originalEmailPasswordImplementation.signIn.bind(emailPasswordRecipeImplementation_1.default(this))(input);
            });
        },
        ...
        getUserById: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let user = yield originalEmailPasswordImplementation.getUserById.bind(emailPasswordRecipeImplementation_1.default(this))(input);
                if (user !== undefined) {
                    return user;
                }
                if (originalThirdPartyImplementation === undefined) {
        ...
        getUsersByEmail: function ({ email, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let userFromEmailPass = yield originalEmailPasswordImplementation.getUserByEmail.bind(emailPasswordRecipeImplementation_1.default(this))({ email, userContext });
                if (originalThirdPartyImplementation === undefined) {
        ...
        createResetPasswordToken: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                return originalEmailPasswordImplementation.createResetPasswordToken.bind(emailPasswordRecipeImplementation_1.default(this))(input);
            });
        },
        resetPasswordUsingToken: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                return originalEmailPasswordImplementation.resetPasswordUsingToken.bind(emailPasswordRecipeImplementation_1.default(this))(input);
            });
        },
        updateEmailOrPassword: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return originalEmailPasswordImplementation.updateEmailOrPassword.bind(emailPasswordRecipeImplementation_1.default(this))(input);
            });
        },
    };
}
