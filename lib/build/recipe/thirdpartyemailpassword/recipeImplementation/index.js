...
function getRecipeInterface(emailPasswordQuerier, thirdPartyQuerier, formFields) {
    let originalEmailPasswordImplementation = recipeImplementation_1.default(emailPasswordQuerier, formFields);
