...
class RecipeImplementation {
    constructor(emailPasswordRecipeInstance, thirdPartyRecipeInstance) {
        ...
        if (thirdPartyRecipeInstance !== undefined) {
            this.thirdPartyImplementation = new recipeImplementation_2.default(thirdPartyRecipeInstance.getQuerier());
        }
    }
}
