    ...
    constructor(recipeImplementation) {
        this.getUserByThirdPartyInfo = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                let user = yield this.recipeImplementation.getUserByThirdPartyInfo(input);
        ...
        this.signInUp = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                let result = yield this.recipeImplementation.signInUp(input);
        ...
        this.getUserById = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                let user = yield this.recipeImplementation.getUserById(input);
                if (user === undefined || user.thirdParty === undefined) {
