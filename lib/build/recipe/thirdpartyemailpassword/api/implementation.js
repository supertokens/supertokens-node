...
function getAPIImplementation() {
    ...
    return {
        ...
        linkEmailPasswordAccountWithUserFromSessionPOST:
            (_f = emailPasswordImplementation.linkAccountWithUserFromSessionPOST) === null || _f === void 0
                ? void 0
                : _f.bind(emailPasswordAPIImplementation_1.default(this)),
        linkThirdPartyAccountWithUserFromSessionPOST:
            (_g = thirdPartyImplementation.linkAccountWithUserFromSessionPOST) === null || _g === void 0
                ? void 0
                : _g.bind(thirdPartyAPIImplementation_1.default(this)),
        passwordResetPOST:
            (_h = emailPasswordImplementation.passwordResetPOST) === null || _h === void 0
                ? void 0
                : _h.bind(emailPasswordAPIImplementation_1.default(this)),
        thirdPartySignInUpPOST:
            (_j = thirdPartyImplementation.signInUpPOST) === null || _j === void 0
                ? void 0
                : _j.bind(thirdPartyAPIImplementation_1.default(this)),
        appleRedirectHandlerPOST:
            (_k = thirdPartyImplementation.appleRedirectHandlerPOST) === null || _k === void 0
                ? void 0
                : _k.bind(thirdPartyAPIImplementation_1.default(this)),
    };
}
