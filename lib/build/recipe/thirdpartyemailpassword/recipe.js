        ...
        this.handleAPIRequest = (id, req, res, next) =>
            __awaiter(this, void 0, void 0, function* () {
                let path = new normalisedURLPath_1.default(
                    undefined,
                    req.originalUrl === undefined ? req.url : req.originalUrl
                );
                let method = utils_1.normaliseHttpMethod(req.method);
                if (this.emailPasswordRecipe.returnAPIIdIfCanHandleRequest(path, method) !== undefined) {
                    return yield this.emailPasswordRecipe.handleAPIRequest(id, req, res, next);
                }
                if (
                    this.thirdPartyRecipe !== undefined &&
                    this.thirdPartyRecipe.returnAPIIdIfCanHandleRequest(path, method) !== undefined
                ) {
                    return yield this.thirdPartyRecipe.handleAPIRequest(id, req, res, next);
                }
