...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.apiImpl = this.config.override.apis(new implementation_1.default(this.config.providers.length !== 0));
        this.emailPasswordRecipe = new recipe_2.default(recipeId, appInfo, isInServerlessEnv, {
            override: {
                ...
                apis: (_) => {
                    return new emailPasswordAPIImplementation_1.default(this.apiImpl);
                },
            },
            sessionFeature: {
        ...
        if (this.config.providers.length !== 0) {
            this.thirdPartyRecipe = new recipe_3.default(recipeId, appInfo, isInServerlessEnv, {
                override: {
                    ...
                    apis: (_) => {
                        return new thirdPartyAPIImplementation_1.default(this.apiImpl);
                    },
                },
                sessionFeature: {
