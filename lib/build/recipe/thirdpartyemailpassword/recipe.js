...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.signUp = (email, password) =>
            __awaiter(this, void 0, void 0, function* () {
                return yield this.emailPasswordRecipe.recipeInterfaceImpl.signUp(email, password);
            });
        ...
        this.getUserById = (userId) =>
            __awaiter(this, void 0, void 0, function* () {
                let user = yield this.emailPasswordRecipe.recipeInterfaceImpl.getUserById(userId);
                if (user !== undefined) {
                    return user;
                }
                if (this.thirdPartyRecipe === undefined) {
                ...
                return yield this.thirdPartyRecipe.recipeInterfaceImpl.getUserById(userId);
            });
        this.getUserByThirdPartyInfo = (thirdPartyId, thirdPartyUserId) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                return this.thirdPartyRecipe.recipeInterfaceImpl.getUserByThirdPartyInfo(
                    thirdPartyId,
                    thirdPartyUserId
                );
            });
