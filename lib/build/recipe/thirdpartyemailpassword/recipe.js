    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.recipeInterfaceImpl = this.config.override.functions(
            new recipeImplementation_1.default(
                querier_1.Querier.getInstanceOrThrowError(isInServerlessEnv, recipe_2.default.RECIPE_ID),
                querier_1.Querier.getInstanceOrThrowError(isInServerlessEnv, recipe_3.default.RECIPE_ID)
            )
        );
