    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.emailPasswordRecipe = new recipe_2.default(
            ...
            isInServerlessEnv,
            {
                override: {
                    functions: (_) => {
                        return new emailPasswordRecipeImplementation_1.default(this);
                    },
                    apis: (_) => {
                        return new emailPasswordAPIImplementation_1.default(this);
                    },
                },
                sessionFeature: {
        ...
        if (this.config.providers.length !== 0) {
            this.thirdPartyRecipe = new recipe_3.default(
                ...
                isInServerlessEnv,
                {
                    override: {
                        functions: (_) => {
                            return new thirdPartyRecipeImplementation_1.default(this);
                        },
                        apis: (_) => {
                            return new thirdPartyAPIImplementation_1.default(this);
                        },
                    },
                    sessionFeature: {
        ...
        this.recipeInterfaceImpl = this.config.override.functions(
            new recipeImplementation_1.default(this, this.emailPasswordRecipe, this.thirdPartyRecipe)
        );
        this.apiImpl = this.config.override.apis(
            new implementation_1.default(this, this.emailPasswordRecipe, this.thirdPartyRecipe)
        );
