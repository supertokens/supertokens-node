    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes) {
        ...
        this.emailVerificationRecipe =
            recipes.emailVerificationInstance !== undefined
                ...
                : new recipe_1.default(recipeId, appInfo, isInServerlessEnv, Object.assign({}, this.config.emailVerificationFeature));
        this.emailPasswordRecipe =
            recipes.emailPasswordInstance !== undefined
                ...
                : new recipe_2.default(recipeId, appInfo, isInServerlessEnv, {
                    override: {
                        functions: (_) => {
                            return emailPasswordRecipeImplementation_1.default(this.recipeInterfaceImpl);
                        },
                        apis: (_) => {
