...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    function getEmailDeliveryConfig(emailPasswordRecipeImpl, isInServerlessEnv) {
        ...
        if (emailService === undefined) {
            emailService = new backwardCompatibility_1.default(emailPasswordRecipeImpl, appInfo, isInServerlessEnv, config === null || config === void 0 ? void 0 : config.resetPasswordUsingTokenFeature);
        }
