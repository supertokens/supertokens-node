...
const passwordReset_1 = require("../../../../emailpassword/emaildelivery/services/smtp/passwordReset");
...
function getDefaultEmailServiceImplementation(transporter) {
    return {
        ...
        getContent: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                if (input.type === "EMAIL_VERIFICATION") {
                    return emailVerify_1.default(input);
                }
