...
function validateAndNormaliseUserInput(config) {
    ...
    return {
        getAllowedDomainsForTenantId: config === null || config === void 0 ? void 0 : config.getAllowedDomainsForTenantId,
        override,
    };
}
const isValidFirstFactor = async function (stInstance, tenantId, factorId, userContext) {
    var _a;
    ...
    (0, logger_1.logDebugMessage)(`isValidFirstFactor got ${(_a = tenantConfig.firstFactors) === null || _a === void 0 ? void 0 : _a.join(", ")} from tenant config`);
    ...
    let configuredFirstFactors = tenantConfig.firstFactors !== undefined ? tenantConfig.firstFactors : firstFactorsFromMFA;
...
function isFactorConfiguredForTenant({ allAvailableFirstFactors, firstFactors, factorId, }) {
    ...
    let configuredFirstFactors = firstFactors.filter((factorId) => allAvailableFirstFactors.includes(factorId) || !Object.values(types_1.FactorIds).includes(factorId));
