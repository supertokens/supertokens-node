...
exports.AllowedDomainsClaim = exports.getTenantCoreConfig = exports.disassociateUserFromTenant = exports.associateUserToTenant = exports.deleteThirdPartyConfig = exports.createOrUpdateThirdPartyConfig = exports.listAllTenants = exports.getTenant = exports.deleteTenant = exports.createOrUpdateTenant = exports.init = void 0;
...
class Wrapper {
    ...
    static async getTenantCoreConfig(tenantId, userContext) {
        const recipeInstance = recipe_1.default.getInstanceOrThrowError();
...
exports.getTenantCoreConfig = Wrapper.getTenantCoreConfig;
