...
const loginMethods_1 = require("./api/loginMethods");
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        super(recipeId, appInfo);
        this.staticThirdPartyProviders = [];
        this.getTenantIdForUserIdFuncsFromOtherRecipes = [];
        ...
        this.handleAPIRequest = (id, req, res, _, __) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.LOGIN_METHODS_API) {
                    return yield loginMethods_1.default(this.apiImpl, options);
                }
        ...
        this.addGetTenantIdForUserIdFunc = (func) => {
        ...
        this.getTenantIdForUserId = (userId, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                for (const f of this.getTenantIdForUserIdFuncsFromOtherRecipes) {
                    const tenantIdRes = yield f(userId, userContext);
                    ...
                    postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(() => {
                        try {
                            recipe_1.default
                                ...
                                .addClaimFromOtherRecipe(multitenancyClaim_1.AllowedDomainsClaim);
                        } catch (_a) {
