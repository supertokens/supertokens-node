...
function loginMethodsAPI(apiImplementation, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        tenantId = yield options.recipeImplementation.getTenantId({ tenantIdFromFrontend: tenantId, userContext });
        const result = yield apiImplementation.loginMethodsGET({ tenantId, clientType, options, userContext });
