...
exports.parseJWTWithoutSignatureVerification = void 0;
const logger_1 = require("../../logger");
const utils_1 = require("../../utils");
const HEADERS = new Set([
    utils_1.encodeBase64(JSON.stringify({
        alg: "RS256",
        typ: "JWT",
        version: "1",
    })),
...
function parseJWTWithoutSignatureVerification(jwt) {
    ...
    if (!HEADERS.has(splittedInput[0])) {
        const parsedHeader = JSON.parse(utils_1.decodeBase64(splittedInput[0]));
        if (parsedHeader.version !== undefined) {
            ...
            logger_1.logDebugMessage("parseJWTWithoutSignatureVerification: version from header: " + version);
        }
        else {
            logger_1.logDebugMessage("parseJWTWithoutSignatureVerification: assuming latest version (3) because version header is missing");
    ...
    return {
        ...
        payload: JSON.parse(utils_1.decodeBase64(splittedInput[1])),
