...
const HEADERS = new Set([
    (0, utils_1.encodeBase64)(JSON.stringify({
        alg: "RS256",
        typ: "JWT",
        version: "1",
    })),
...
function parseJWTWithoutSignatureVerification(jwt) {
    ...
    if (!HEADERS.has(splittedInput[0])) {
        ...
        if (parsedHeader.version !== undefined) {
            ...
            (0, logger_1.logDebugMessage)("parseJWTWithoutSignatureVerification: assuming latest version (3) because version header is missing");
