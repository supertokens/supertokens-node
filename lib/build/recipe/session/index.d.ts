...
export default class SessionWrapper {
    ...
    static createJWT(
        ...
        userContext?: Record<string, any>
    ): Promise<import("../openid").CreateJWTResponse>;
    static getJWKS(userContext?: Record<string, any>): Promise<import("../jwt").GetJWKSResponse>;
    static getOpenIdDiscoveryConfiguration(
        userContext?: Record<string, any>
    ): Promise<import("../openid").GetOpenIdDiscoveryConfigurationResponse>;
