        ...
        __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (incomingPath.equals(refreshTokenPath) && method === "post") {
                    request.session = yield recipeInstance.recipeInterfaceImpl.refreshSession(request, response);
                } else {
                    request.session = yield recipeInstance.recipeInterfaceImpl.getSession(request, response, options);
                }
                return next();
            } catch (err) {
                next(err);
