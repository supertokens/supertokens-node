...
function verifySession(recipeInstance, antiCsrfCheck) {
    ...
    return (request, response, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let incomingPath = new normalisedURLPath_1.default(recipeInstance.getRecipeId(), request.originalUrl);
...
function sendTryRefreshTokenResponse(recipeInstance, message, request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            utils_1.sendNon200Response(recipeInstance.getRecipeId(), response, "try refresh token", recipeInstance.config.sessionExpiredStatusCode);
        }
        catch (err) {
            next(err);
        }
...
function sendUnauthorisedResponse(recipeInstance, message, request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            utils_1.sendNon200Response(recipeInstance.getRecipeId(), response, "unauthorised", recipeInstance.config.sessionExpiredStatusCode);
        }
        catch (err) {
            next(err);
        }
...
function sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, userId, request, response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            utils_1.sendNon200Response(recipeInstance.getRecipeId(), response, "token theft detected", recipeInstance.config.sessionExpiredStatusCode);
        }
        catch (err) {
            next(err);
        }
