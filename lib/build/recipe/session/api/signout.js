...
function signOutAPI(recipeInstance, req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        // Logic as per https://github.com/supertokens/supertokens-node/issues/34#issuecomment-717958537
        // step 1
        let session;
        try {
            session = yield __1.default.getSession(req, res);
        } catch (err) {
            if (__1.default.Error.isErrorFromSuperTokens(err) && err.type === __1.default.Error.UNAUTHORISED) {
