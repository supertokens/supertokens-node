...
function getAPIInterface() {
    return {
        refreshPOST: async function ({ options, userContext }) {
            ...
            if (
                (cookieAndHeaders_1.hasMultipleCookiesForTokenType(options.req, "access") ||
                    cookieAndHeaders_1.hasMultipleCookiesForTokenType(options.req, "refresh")) &&
            ...
            let didClearCookies = cookieAndHeaders_1.clearSessionCookiesFromOlderCookieDomain({
                req: options.req,
                res: options.res,
