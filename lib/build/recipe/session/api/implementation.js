            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (incomingPath.equals(refreshTokenPath) && method === "post") {
                    ...
                    if (session !== undefined) {
                        const claimValidators = yield utils_2.getRequiredClaimValidators(session, verifySessionOptions === null || verifySessionOptions === void 0 ? void 0 : verifySessionOptions.overrideGlobalClaimValidators, userContext);
