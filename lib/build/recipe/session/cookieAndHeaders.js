...
function setMissingClaimIdHeader(response, claimId) {
...
exports.setMissingClaimIdHeader = setMissingClaimIdHeader;
...
function setFrontTokenInHeaders(res, userId, atExpiry, accessTokenPayload, claims) {
    const tokenInfo = {
        uid: userId,
        ate: atExpiry,
