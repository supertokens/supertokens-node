...
function clearSessionFromAllTokenTransferMethods(config, req, res, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const transferMethod of constants_2.availableTokenTransferMethods) {
            yield clearSession(config, req, res, transferMethod, userContext);
        }
    });
}
exports.clearSessionFromAllTokenTransferMethods = clearSessionFromAllTokenTransferMethods;
function clearSession(config, req, res, transferMethod, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const token of tokenTypes) {
            yield setToken(config, req, res, token, "", 0, transferMethod, userContext);
        }
...
function setToken(config, req, res, tokenType, value, expires, transferMethod, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @param path
 */
function setCookie(config, req, res, name, value, expires, pathType, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        let domain = yield config.cookieDomain(req, userContext);
        let secure = yield config.cookieSecure(req, userContext);
        let sameSite = yield config.cookieSameSite(req, userContext);
        let path = "";
        if (pathType === "refreshTokenPath") {
            path = config.refreshTokenPath.getAsStringDangerous();
        } else if (pathType === "accessTokenPath") {
            path =
                config.accessTokenPath.getAsStringDangerous() === ""
                    ? "/"
                    : config.accessTokenPath.getAsStringDangerous();
        }
        let httpOnly = true;
