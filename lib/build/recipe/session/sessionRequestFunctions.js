...
function getSessionFromRequest({ req, res, config, recipeInterfaceImpl, options, userContext }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const antiCSRFMode = yield config.antiCsrf(req, userContext);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (
            ...
            if (req.getCookieValue(LEGACY_ID_REFRESH_TOKEN_COOKIE_NAME) !== undefined) {
                ...
                yield cookieAndHeaders_1.setCookie(
                    config,
                    req,
                    res,
        ...
        for (const transferMethod of constants_1.availableTokenTransferMethods) {
            if (transferMethod !== requestTransferMethod && refreshTokens[transferMethod] !== undefined) {
                cookieAndHeaders_1.clearSession(config, req, res, transferMethod, userContext);
            }
        }
        yield session.attachToRequestResponse({
            req,
...
function createNewSessionInRequest({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const apiDomainVal = yield appInfo.apiDomain(req, userContext);
        ...
        const topLevelAPIDomain = utils_2.getTopLevelDomainForSameSiteResolution(apiDomainVal.getAsStringDangerous());
        if (
            outputTransferMethod === "cookie" &&
            cookieSameSite === "none" &&
            !config.cookieSecure &&
            !(
                (topLevelAPIDomain === "localhost" || utils_2.isAnIpAddress(topLevelAPIDomain)) &&
        ...
        for (const transferMethod of constants_1.availableTokenTransferMethods) {
            if (
                ...
                yield cookieAndHeaders_1.clearSession(config, req, res, transferMethod, userContext);
            }
        }
