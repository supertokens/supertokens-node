...
function getSessionFromRequest({ req, res, config, recipeInterfaceImpl, options, userContext }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield recipeInterfaceImpl.getSession({
        ...
        if (result.status === "TRY_REFRESH_TOKEN_ERROR") {
            throw new error_1.default({ message: result.message, type: "TRY_REFRESH_TOKEN" });
        }
...
function refreshSessionInRequest({ res, req, userContext, config, recipeInterfaceImpl }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield recipeInterfaceImpl.refreshSession({
        ...
        yield result.session.attachToRequestResponse({
            req,
            res,
            transferMethod: requestTransferMethod,
        });
...
function createNewSessionInRequest({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_2.setRequestInUserContextIfNotDefined(userContext, req);
        ...
        if (
            ...
            !(
                ...
                (appInfo.topLevelWebsiteDomain === "localhost" || utils_2.isAnIpAddress(appInfo.topLevelWebsiteDomain))
            )
        ) {
        ...
        const result = yield recipeInstance.recipeInterfaceImpl.createNewSession({
            userId,
