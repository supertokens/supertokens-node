...
function verifySession(options) {
    return h3_1.eventHandler((event) =>
        __awaiter(this, void 0, void 0, function* () {
            const request = new framework_1.H3Request(event);
            const response = new framework_1.H3Response(event);
            try {
                const sessionRecipe = recipe_1.default.getInstanceOrThrowError();
                event.context.session = yield sessionRecipe.verifySession(options, request, response);
            } catch (err) {
