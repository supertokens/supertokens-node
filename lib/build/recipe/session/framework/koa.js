...
const framework_1 = require("../../../framework/koa/framework");
const utils_1 = require("../../../utils");
function verifySession(options) {
    return (ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
            let sessionRecipe = recipe_1.default.getInstanceOrThrowError();
            let request = new framework_1.KoaRequest(ctx);
            let response = new framework_1.KoaResponse(ctx);
            const userContext = utils_1.makeDefaultUserContextFromAPI(request);
            try {
                ctx.session = yield sessionRecipe.verifySession(options, request, response, userContext);
            } catch (err) {
                try {
