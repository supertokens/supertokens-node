            ...
            __awaiter(this, void 0, void 0, function* () {
                if (this.handshakeInfo === undefined) {
                    if (this.checkIfInServerlessEnv()) {
                        let handshakeInfo = yield utils_2.getDataFromFileIfExists(constants_1.HANDSHAKE_INFO_FILE_PATH);
                    ...
                    if (this.checkIfInServerlessEnv()) {
                        utils_2.storeIntoTempFile(constants_1.HANDSHAKE_INFO_FILE_PATH, this.handshakeInfo);
                    }
                }
                return this.handshakeInfo;
            });
