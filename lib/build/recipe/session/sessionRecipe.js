    ...
    constructor(recipeId, appInfo, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                {
                    method: "post",
                    pathWithoutApiBasePath: constants_1.REFRESH_API_PATH,
                    id: "REFRESH",
        ...
        let normalisedInput = utils_1.validateAndNormaliseUserInput(this.getRecipeId(), config);
        this.config = {
            accessTokenPath: normalisedInput.accessTokenPath,
            refreshTokenPath:
                appInfo.apiBasePath +
                utils_2.normaliseURLPathOrThrowError(this.getRecipeId(), constants_1.REFRESH_API_PATH),
