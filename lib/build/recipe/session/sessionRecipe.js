    ...
    constructor(recipeId, appInfo, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(this.getRecipeId(), constants_1.REFRESH_API_PATH),
                    id: "REFRESH",
                    disabled: this.config.sessionRefreshFeature.disableDefaultImplementation,
                },
            ];
        };
        this.handleAPIRequest = (id, req, res, next) => __awaiter(this, void 0, void 0, function* () {
            yield api_1.handleRefreshAPI(this, req, res, next);
        });
        this.handleError = (err, request, response, next) => {
            if (err.type === error_1.default.UNAUTHORISED) {
                ...
                return this.config.errorHandlers.onTokenTheftDetected(err.payload.sessionHandle, err.payload.userId, request, response, next);
            }
        };
        ...
        this.getHandshakeInfo = () => __awaiter(this, void 0, void 0, function* () {
            if (this.handshakeInfo === undefined) {
                let response = yield this.getQuerier().sendPostRequest(new normalisedURLPath_1.default(this.getRecipeId(), "/recipe/handshake"), {});
                this.handshakeInfo = {
        ...
        this.createNewSession = (res, userId, jwtPayload = {}, sessionData = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new sessionClass_1.default(this, response.accessToken.token, response.session.handle, response.session.userId, response.session.userDataInJWT, res);
        });
        this.getSession = (req, res, doAntiCsrfCheck) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.accessToken !== undefined) {
                    cookieAndHeaders_1.setFrontTokenInHeaders(this, res, response.session.userId, response.accessToken.expiry, response.session.userDataInJWT);
                    cookieAndHeaders_1.attachAccessTokenToCookie(this, res, response.accessToken.token, response.accessToken.expiry);
                    accessToken = response.accessToken.token;
                }
                return new sessionClass_1.default(this, accessToken, response.session.handle, response.session.userId, response.session.userDataInJWT, res);
            }
            catch (err) {
                if (err.type === error_1.default.UNAUTHORISED) {
        ...
        this.refreshSession = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (err.type === error_1.default.UNAUTHORISED || err.type === error_1.default.TOKEN_THEFT_DETECTED) {
                    cookieAndHeaders_1.clearSessionFromCookie(this, res);
                }
                throw err;
            }
