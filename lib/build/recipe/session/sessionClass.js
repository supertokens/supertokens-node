...
class Session {
    constructor(helpers, accessToken, sessionHandle, userId, userDataInAccessToken, claims, res) {
        ...
        this.updateAccessTokenPayload = (newAccessTokenPayload, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                yield this.regenerateToken(newAccessTokenPayload, undefined, userContext);
            });
    ...
    updateClaims(claims, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (JSON.stringify(newSessionClaimPayload) !== origSessionClaimPayloadJSON) {
                yield this.regenerateToken(undefined, newSessionClaimPayload, userContext);
            }
        });
    }
    ...
    regenerateToken(newAccessTokenPayload, newClaimPayload, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
