...
class Session {
    ...
    async revokeSession(userContext) {
        ...
        if (this.reqResInfo !== undefined) {
            ...
            (0, cookieAndHeaders_1.clearSession)(this.helpers.config, this.reqResInfo.res, this.reqResInfo.transferMethod, this.reqResInfo.req, ctx);
        }
    }
    async getSessionDataFromDatabase(userContext) {
        ...
        if (sessionInfo === undefined) {
            (0, logger_1.logDebugMessage)("getSessionDataFromDatabase: Throwing UNAUTHORISED because session does not exist anymore");
    ...
    async updateSessionDataInDatabase(newSessionData, userContext) {
        ...
        if (!(await this.helpers.getRecipeImpl().updateSessionDataInDatabase({
            ...
            (0, logger_1.logDebugMessage)("updateSessionDataInDatabase: Throwing UNAUTHORISED because session does not exist anymore");
            throw new error_1.default({
                message: "Session does not exist anymore",
                type: error_1.default.UNAUTHORISED,
            });
    ...
    async mergeIntoAccessTokenPayload(accessTokenPayloadUpdate, userContext) {
        ...
        if (response === undefined) {
            (0, logger_1.logDebugMessage)("mergeIntoAccessTokenPayload: Throwing UNAUTHORISED because session does not exist anymore");
            throw new error_1.default({
                message: "Session does not exist anymore",
                type: error_1.default.UNAUTHORISED,
            });
        ...
        if (response.accessToken !== undefined) {
            ...
            this.frontToken = (0, cookieAndHeaders_1.buildFrontToken)(this.userId, response.accessToken.expiry, payload);
            ...
            if (this.reqResInfo !== undefined) {
                ...
                (0, utils_1.setAccessTokenInResponse)(this.reqResInfo.res, this.accessToken, this.frontToken, this.helpers.config, this.reqResInfo.transferMethod, this.reqResInfo.req, ctx);
            }
        }
        else {
    ...
    async getTimeCreated(userContext) {
        ...
        if (sessionInfo === undefined) {
            (0, logger_1.logDebugMessage)("getTimeCreated: Throwing UNAUTHORISED because session does not exist anymore");
            throw new error_1.default({
                message: "Session does not exist anymore",
                type: error_1.default.UNAUTHORISED,
            });
    ...
    attachToRequestResponse(info, userContext) {
        ...
        if (this.accessTokenUpdated) {
            ...
            const ctx = userContext === undefined && this.reqResInfo !== undefined
                ? (0, utils_2.makeDefaultUserContextFromAPI)(this.reqResInfo.req)
                : (0, utils_2.getUserContext)(userContext);
            (0, utils_1.setAccessTokenInResponse)(res, this.accessToken, this.frontToken, this.helpers.config, transferMethod, info.req, ctx);
            if (this.refreshToken !== undefined) {
                (0, cookieAndHeaders_1.setToken)(this.helpers.config, res, "refresh", this.refreshToken.token, this.refreshToken.expiry, transferMethod, info.req, ctx);
            }
