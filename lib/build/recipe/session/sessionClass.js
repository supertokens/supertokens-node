...
class Session {
    constructor(helpers, accessToken, sessionHandle, userId, userDataInAccessToken, res) {
        ...
        this.applyClaimBuilder = (claimBuilder, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                const update = yield claimBuilder.applyToPayload(this.getUserId(), {}, userContext);
                return this.mergeIntoAccessTokenPayload(update, userContext);
            });
        this.setClaimValue = (claimBuilder, value, userContext) => {
            const update = claimBuilder.addToPayload_internal({}, value, userContext);
            return this.mergeIntoAccessTokenPayload(update, userContext);
        };
        this.removeClaim = (claimBuilder, userContext) => {
