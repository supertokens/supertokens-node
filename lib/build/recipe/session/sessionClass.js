...
class Session {
    constructor(helpers, accessToken, sessionHandle, userId, userDataInAccessToken, grants, res) {
        ...
        this.updateSessionGrants = (newGrants, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
    ...
    shouldRefetchGrant(grant, userContext) {
        return grant.shouldRefetchGrant(this.getSessionGrants(), userContext);
    }
    fetchGrant(grant, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const value = yield grant.fetchGrant(this.getUserId(), userContext);
            if (value !== undefined) {
                const newGrantPayload = grant.addToGrantPayload(this.getSessionGrants(), value, userContext);
                yield this.updateSessionGrants(newGrantPayload, userContext);
            }
        });
    }
    checkGrantInToken(grant, userContext) {
        return grant.isGrantValid(this.getSessionGrants(), userContext);
    }
    addGrant(grant, value, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const newGrantPayload = grant.addToGrantPayload(this.getSessionGrants(), value, userContext);
            yield this.updateSessionGrants(newGrantPayload, userContext);
        });
    }
    removeGrant(grant, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
