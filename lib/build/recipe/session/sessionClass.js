...
class Session {
    constructor(helpers, accessToken, sessionHandle, userId, recipeUserId, userDataInAccessToken, res, req, transferMethod) {
    ...
    updateSessionData(newSessionData, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield this.helpers.getRecipeImpl().updateSessionData({
                sessionHandle: this.sessionHandle,
                newSessionData,
                userContext: userContext === undefined ? {} : userContext,
            }))) {
    ...
    mergeIntoAccessTokenPayload(accessTokenPayloadUpdate, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedPayload = Object.assign(Object.assign({}, this.getAccessTokenPayload(userContext)), accessTokenPayloadUpdate);
    ...
    fetchAndSetClaim(claim, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const update = yield claim.build(this.getUserId(userContext), this.getRecipeUserId(userContext), userContext);
    ...
    updateAccessTokenPayload(newAccessTokenPayload, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.accessToken !== undefined) {
                ...
                cookieAndHeaders_1.setToken(this.helpers.config, this.res, "access", response.accessToken.token, 
                ...
                Date.now() + 3153600000000, this.transferMethod);
            }
        });
    }
}
