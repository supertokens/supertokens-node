    ...
    constructor(recipeInstance, accessToken, sessionHandle, userId, userDataInJWT, res) {
        ...
        this.updateJWTPayload = (newJWTPayload) => __awaiter(this, void 0, void 0, function* () {
            let response = yield this.recipeInstance
                .getQuerier()
                .sendPostRequest(new normalisedURLPath_1.default(this.recipeInstance.getRecipeId(), "/recipe/session/regenerate"), {
            ...
            if (response.accessToken !== undefined) {
                ...
                cookieAndHeaders_1.setFrontTokenInHeaders(this.recipeInstance, this.res, response.session.userId, response.accessToken.expiry, response.session.userDataInJWT);
                cookieAndHeaders_1.attachAccessTokenToCookie(this.recipeInstance, this.res, response.accessToken.token, response.accessToken.expiry);
            }
        });
