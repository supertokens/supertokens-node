...
class SessionWrapper {
    ...
    static createNewSessionWithoutRequestResponse(
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apiDomain = yield appInfo.apiDomain({}, userContext);
            ...
            if (antiCSRF === undefined) {
                if (appInfo.initialOriginType === "string") {
                    antiCSRF = yield recipeInstance.config.antiCsrf({}, userContext);
                } else {
    ...
    static getSessionWithoutRequestResponse(accessToken, antiCsrfToken, options, antiCSRF, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static refreshSession(req, res, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = recipeInstance.config;
            const recipeInterfaceImpl = recipeInstance.recipeInterfaceImpl;
            return yield sessionRequestFunctions_1.refreshSessionInRequest({
                res,
                req,
                userContext,
                config,
...
SessionWrapper.STError = error_1.default;
...
exports.STError = SessionWrapper.STError;
// JWT Functions
