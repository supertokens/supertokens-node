...
class SessionWrapper {
    ...
    static revokeAllSessionsForUser(userId, revokeSessionsForLinkedAccounts = true, userContext = {}) {
        return recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.revokeAllSessionsForUser({ userId, revokeSessionsForLinkedAccounts, userContext });
    }
    static getAllSessionHandlesForUser(userId, fetchSessionsForAllLinkedAccounts = true, userContext = {}) {
