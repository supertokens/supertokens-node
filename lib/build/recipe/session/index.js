...
class SessionWrapper {
    ...
    static validateClaimsForSessionHandle(sessionHandle, overrideGlobalClaimValidators, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.validateClaimsForSessionHandle({
                sessionHandle,
    ...
    static validateClaimsInJWTPayload(userId, jwtPayload, overrideGlobalClaimValidators, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.validateClaimsInJWTPayload({
                userId,
                jwtPayload,
                overrideGlobalClaimValidators,
                userContext,
    ...
    static getSession(req, res, options, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (session !== undefined) {
                yield recipeInterfaceImpl.assertClaims({
                    session,
                    overrideGlobalClaimValidators:
