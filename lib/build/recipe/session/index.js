...
class SessionWrapper {
    static createNewSession(req, res, userId, recipeUserId, accessTokenPayload = {}, sessionData = {}, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const claim of claimsAddedByOtherRecipes) {
                const update = yield claim.build(userId, recipeUserId, userContext);
    ...
    static validateClaimsForSessionHandle(sessionHandle, overrideGlobalClaimValidators, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const claimValidators = overrideGlobalClaimValidators !== undefined
            ...
            if (claimValidationResponse.accessTokenPayloadUpdate !== undefined) {
                if (!(yield recipeImpl.mergeIntoAccessTokenPayload({
                    sessionHandle,
    ...
    static getSession(req, res, options, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (session !== undefined) {
                const claimValidators = yield utils_1.getRequiredClaimValidators(session, options === null || options === void 0 ? void 0 : options.overrideGlobalClaimValidators, userContext);
    ...
    static revokeAllSessionsForUser(userId, userContext = {}) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.revokeAllSessionsForUser({ userId, userContext });
    }
    ...
    static revokeSession(sessionHandle, userContext = {}) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.revokeSession({ sessionHandle, userContext });
    }
    ...
    static createJWT(payload, validitySeconds, userContext = {}) {
        ...
        throw new global.Error("createJWT cannot be used without enabling the JWT feature. Please set 'enableJWT: true' when initialising the Session recipe");
    }
    static getJWKS(userContext = {}) {
        ...
        throw new global.Error("getJWKS cannot be used without enabling the JWT feature. Please set 'enableJWT: true' when initialising the Session recipe");
    }
    static getOpenIdDiscoveryConfiguration(userContext = {}) {
        ...
        throw new global.Error("getOpenIdDiscoveryConfiguration cannot be used without enabling the JWT feature. Please set 'enableJWT: true' when initialising the Session recipe");
    }
