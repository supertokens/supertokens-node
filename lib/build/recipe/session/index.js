...
class SessionWrapper {
    static createNewSession(res, userId, jwtPayload = {}, sessionData = {}) {
        return sessionRecipe_1.default
            ...
            .recipeInterfaceImpl.createNewSession(res, userId, jwtPayload, sessionData);
    }
    static getSession(req, res, options) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getSession(req, res, options);
    }
    static refreshSession(req, res) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.refreshSession(req, res);
    }
    static revokeAllSessionsForUser(userId) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.revokeAllSessionsForUser(userId);
    }
    static getAllSessionHandlesForUser(userId) {
        return sessionRecipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.getAllSessionHandlesForUser(userId);
    }
    static revokeSession(sessionHandle) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.revokeSession(sessionHandle);
    }
    ...
    static getSessionData(sessionHandle) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getSessionData(sessionHandle);
    }
    ...
    static getJWTPayload(sessionHandle) {
        return sessionRecipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getJWTPayload(sessionHandle);
    }
...
SessionWrapper.verifySession = (options) => {
    ...
    return (req, res, next) =>
        middleware_1.verifySession(sessionRecipe_1.default.getInstanceOrThrowError(), options)(req, res, next);
};
