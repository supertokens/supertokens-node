...
class SessionWrapper {
    static createNewSession(res, userId, accessTokenPayload = {}, sessionData = {}, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const defaultClaims = recipe_1.default.getInstanceOrThrowError().getDefaultClaimBuilders();
            const claimsToAdd = yield recipe_1.default
                .getInstanceOrThrowError()
                .recipeInterfaceImpl.getClaimsToAddOnSessionCreate(userId, defaultClaims, userContext);
