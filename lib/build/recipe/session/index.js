...
class SessionWrapper {
    static createNewSession(res, userId, accessTokenPayload = {}, sessionData = {}, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const claimsAddedByOtherRecipes = recipe_1.default.getClaimsAddedByOtherRecipes();
            let finalAccessTokenPayload = accessTokenPayload;
            for (const claim of claimsAddedByOtherRecipes) {
                const value = yield claim.fetchValue(userId, userContext);
                if (value !== undefined) {
    ...
    static fetchAndGetAccessTokenPayloadUpdate(sessionHandle, claim, userContext = {}) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.fetchAndGetAccessTokenPayloadUpdate({
            sessionHandle,
            claim,
            userContext,
        });
...
exports.fetchAndGetAccessTokenPayloadUpdate = SessionWrapper.fetchAndGetAccessTokenPayloadUpdate;
