...
class SessionWrapper {
    ...
    static createNewSessionWithoutRequestResponse(
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            antiCSRFMode = yield utils_1.checkAntiCsrfOrThrowError(antiCSRFMode, userContext);
    ...
    static getSessionWithoutRequestResponse(accessToken, antiCsrfToken, options, antiCSRFMode, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static createJWT(req, payload, validitySeconds, useStaticSigningKey, userContext = {}) {
