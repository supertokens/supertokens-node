...
class SessionWrapper {
    ...
    static createNewSessionWithoutModifyingResponse(
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return recipe_1.default
                ...
                .recipeInterfaceImpl.createNewSessionWithoutModifyingResponse({
                    userId,
                    accessTokenPayload: finalAccessTokenPayload,
                    sessionDataInDatabase,
                    useDynamicAccessTokenSigningKey,
    ...
    static getSessionWithoutModifyingResponse(accessToken, antiCsrfToken, options, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipeInterfaceImpl = recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl;
            ...
            if (res.status === "OK") {
                ...
                try {
                    ...
                    if (err instanceof error_2.default && err.type === "INVALID_CLAIMS") {
                        return {
    ...
    static refreshSessionWithoutModifyingResponse(
        ...
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.refreshSessionWithoutModifyingResponse({
            refreshToken,
            disableAntiCsrf,
            antiCsrfToken,
            userContext,
...
exports.createNewSessionWithoutModifyingResponse = SessionWrapper.createNewSessionWithoutModifyingResponse;
exports.getSession = SessionWrapper.getSession;
exports.getSessionWithoutModifyingResponse = SessionWrapper.getSessionWithoutModifyingResponse;
exports.getSessionInformation = SessionWrapper.getSessionInformation;
exports.refreshSession = SessionWrapper.refreshSession;
exports.refreshSessionWithoutModifyingResponse = SessionWrapper.refreshSessionWithoutModifyingResponse;
