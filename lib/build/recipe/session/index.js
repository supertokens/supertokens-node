...
class SessionWrapper {
    ...
    static validateClaimsForSessionHandle(sessionHandle, overrideGlobalClaimValidators, tenantId, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static getSessionInformation(sessionHandle, tenantId, userContext = {}) {
    ...
    static revokeSession(sessionHandle, tenantId, userContext = {}) {
    ...
    static revokeMultipleSessions(sessionHandles, tenantId, userContext = {}) {
    ...
    static updateSessionDataInDatabase(sessionHandle, newSessionData, tenantId, userContext = {}) {
    ...
    static mergeIntoAccessTokenPayload(sessionHandle, accessTokenPayloadUpdate, tenantId, userContext = {}) {
    ...
    static fetchAndSetClaim(sessionHandle, claim, tenantId, userContext = {}) {
    ...
    static setClaimValue(sessionHandle, claim, value, tenantId, userContext = {}) {
    ...
    static getClaimValue(sessionHandle, claim, tenantId, userContext = {}) {
    ...
    static removeClaim(sessionHandle, claim, tenantId, userContext = {}) {
