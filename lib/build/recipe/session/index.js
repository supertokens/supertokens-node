...
class SessionWrapper {
    ...
    static getSession(req, res, doAntiCsrfCheck) {
        sessionRecipe_1.default.getInstanceOrThrowError().getSession(req, res, doAntiCsrfCheck);
    }
    static refreshSession(req, res) {
        sessionRecipe_1.default.getInstanceOrThrowError().refreshSession(req, res);
    }
    static revokeAllSessionsForUser(userId) {
        sessionRecipe_1.default.getInstanceOrThrowError().revokeAllSessionsForUser(userId);
    }
    static getAllSessionHandlesForUser(userId) {
        sessionRecipe_1.default.getInstanceOrThrowError().getAllSessionHandlesForUser(userId);
    }
    static revokeSession(sessionHandle) {
        sessionRecipe_1.default.getInstanceOrThrowError().revokeSession(sessionHandle);
    }
    static revokeMultipleSessions(sessionHandles) {
        sessionRecipe_1.default.getInstanceOrThrowError().revokeMultipleSessions(sessionHandles);
    }
    static getSessionData(sessionHandle) {
        sessionRecipe_1.default.getInstanceOrThrowError().getSessionData(sessionHandle);
    }
    static updateSessionData(sessionHandle, newSessionData) {
        sessionRecipe_1.default.getInstanceOrThrowError().updateSessionData(sessionHandle, newSessionData);
    }
    static getJWTPayload(sessionHandle) {
        sessionRecipe_1.default.getInstanceOrThrowError().getJWTPayload(sessionHandle);
    }
    static updateJWTPayload(sessionHandle, newJWTPayload) {
        sessionRecipe_1.default.getInstanceOrThrowError().updateJWTPayload(sessionHandle, newJWTPayload);
    }
    static auth0Handler(request, response, next, domain, clientId, clientSecret, callback) {
        sessionRecipe_1.default
...
exports.middleware = SessionWrapper.middleware;
