...
exports.setJWTExpiryOffsetSecondsForTesting = void 0;
...
function default_1(originalImplementation, openIdRecipeImplementation, config) {
    ...
    function jwtAwareUpdateAccessTokenPayload(sessionInformation, newAccessTokenPayload, userContext) {
    ...
    return Object.assign(Object.assign({}, originalImplementation), { createNewSession: function ({ req, res, userId, recipeUserId, accessTokenPayload, sessionData, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                accessTokenPayload =
                    accessTokenPayload === null || accessTokenPayload === undefined ? {} : accessTokenPayload;
                let accessTokenValidityInSeconds = Math.ceil((yield this.getAccessTokenLifeTimeMS({ userContext })) / 1000);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let newAccessTokenPayload = Object.assign(Object.assign({}, sessionInformation.accessTokenPayload), accessTokenPayloadUpdate);
