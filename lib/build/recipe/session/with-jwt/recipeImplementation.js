...
class RecipeImplementation {
    ...
    updateAccessTokenPayload({ sessionHandle, newAccessTokenPayload }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.originalImplementation.updateAccessTokenPayload({ sessionHandle, newAccessTokenPayload });
        });
    }
