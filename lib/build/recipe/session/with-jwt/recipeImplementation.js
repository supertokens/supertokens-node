    ...
    return Object.assign(Object.assign({}, originalImplementation), {
        createNewSession: function ({ res, userId, accessTokenPayload, sessionData }) {
            return __awaiter(this, void 0, void 0, function* () {
                let accessTokenValidityInSeconds =
                    (yield originalImplementation.getAccessTokenLifeTimeMS.bind(this)()) / 1000;
                ...
                return yield originalImplementation.createNewSession.bind(this)({
                    res,
                    userId,
                    accessTokenPayload,
                    sessionData,
        ...
        refreshSession: function ({ req, res }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let newSession = yield originalImplementation.refreshSession.bind(this)({ req, res });
        ...
        updateAccessTokenPayload: function ({ sessionHandle, newAccessTokenPayload }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let sessionInformation = yield originalImplementation.getSessionInformation.bind(this)({
                    sessionHandle,
                });
                ...
                return yield originalImplementation.updateAccessTokenPayload.bind(this)({
                    sessionHandle,
