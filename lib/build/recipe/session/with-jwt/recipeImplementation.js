...
function default_1(originalImplementation, openIdRecipeImplementation, config) {
    ...
    return Object.assign(Object.assign({}, originalImplementation), {
        createNewSession: function ({ res, userId, accessTokenPayload, sessionData, claimsToAdd, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const claimBuilder of claimsToAdd) {
                    if (typeof claimBuilder === "function") {
                        ...
                        accessTokenPayload = Object.assign(Object.assign({}, accessTokenPayload), update);
                    } else {
                        const value = yield claimBuilder.fetch(userId, userContext);
                        if (value !== undefined) {
                            accessTokenPayload = claimBuilder.addToPayload_internal(
                                accessTokenPayload,
                                value,
                                userContext
                            );
