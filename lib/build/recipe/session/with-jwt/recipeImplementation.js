    ...
    return Object.assign(Object.assign({}, originalImplementation), {
        createNewSession: function ({ res, userId, accessTokenPayload, sessionData }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                accessTokenPayload = Object.assign(
                    Object.assign({ sub: userId, iss: appInfo.apiDomain.getAsStringDangerous() }, accessTokenPayload),
                    {
                        /*
                ...
                return new sessionClass_1.default(sessionContainer, jwtRecipeImplementation, config);
            });
        },
        ...
        refreshSession: function ({ req, res }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return new sessionClass_1.default(newSession, jwtRecipeImplementation, config);
            });
        },
        updateAccessTokenPayload: function ({ sessionHandle, newAccessTokenPayload }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                newAccessTokenPayload = Object.assign(
                    Object.assign(Object.assign({}, defaultClaimsToAdd), newAccessTokenPayload),
