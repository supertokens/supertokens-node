...
function mockRegenerateSession(accessToken, newAccessTokenPayload, querier) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        newAccessTokenPayload.recipeUserId = jwt_1.parseJWTWithoutSignatureVerification(
            accessToken
        ).payload.recipeUserId;
...
function mockRevokeSession(sessionHandle, querier) {
    return __awaiter(this, void 0, void 0, function* () {
        sessionHandles = sessionHandles.filter((sh) => sh.sessionHandle !== sessionHandle);
        let response = yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/session/remove"), {
