...
class SessionWrapper {
    static createNewSession(res, userId, jwtPayload = {}, sessionData = {}) {
        return sessionRecipe_1.default.getInstanceOrThrowError().parentRecipe.createNewSession(res, userId, jwtPayload, sessionData);
    }
    ...
    static updateSessionData(sessionHandle, newSessionData) {
        return sessionRecipe_1.default.getInstanceOrThrowError().parentRecipe.updateSessionData(sessionHandle, newSessionData);
    }
    ...
    static updateJWTPayload(sessionHandle, newJWTPayload) {
        return sessionRecipe_1.default.getInstanceOrThrowError().parentRecipe.updateJWTPayload(sessionHandle, newJWTPayload);
    }
}
