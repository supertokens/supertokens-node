...
class RecipeImplementation {
    constructor(originalImplementation, config) {
        ...
        this.getFDAT = (userId, userContext) => __awaiter(this, void 0, void 0, function* () {
            ...
            let faunaResponse = yield this.config.faunaDBClient.query(this.q.Create(this.q.Tokens(), {
        ...
        this.createNewSession = function ({ res, userId, accessTokenPayload = {}, sessionData = {}, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return getModifiedSession(yield this.originalImplementation.createNewSession({
                    res,
                    userId,
                    accessTokenPayload,
                    sessionData,
...
function getModifiedSession(session) {
    return Object.assign(Object.assign({}, session), { getFaunadbToken: (userContext) => __awaiter(this, void 0, void 0, function* () {
