    ...
    constructor(recipeInstance, accessToken, sessionHandle, userId, userDataInJWT, accessTokenExpiry, res) {
        ...
        this.getFaunadbToken = () =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (jwtPayload[sessionRecipe_1.FAUNADB_SESSION_KEY] !== undefined) {
                    // this operation costs nothing. So we can check
                    return jwtPayload[sessionRecipe_1.FAUNADB_SESSION_KEY];
                } else {
                    let sessionData = yield this.getSessionData();
                    return sessionData[sessionRecipe_1.FAUNADB_SESSION_KEY];
                }
            });
    }
}
