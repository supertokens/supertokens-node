...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, config) {
        ...
        // instance functions.........
        this.getFDAT = (session) => __awaiter(this, void 0, void 0, function* () {
            ...
            let faunaResponse = yield this.faunaDBClient.query(this.q.Create(this.q.Tokens(), {
        ...
        this.createNewSession = (res, userId, jwtPayload = {}, sessionData = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            let session = new sessionClass_1.default(this.parentRecipe, originalSession.getAccessToken(), originalSession.getHandle(), originalSession.getUserId(), originalSession.getJWTPayload(), res);
            try {
        ...
        this.getSession = (req, res, doAntiCsrfCheck) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new sessionClass_1.default(this.parentRecipe, originalSession.getAccessToken(), originalSession.getHandle(), originalSession.getUserId(), originalSession.getJWTPayload(), res);
        });
        ...
        this.config = {
            ...
            accessFaunadbTokenFromFrontend: config.accessFaunadbTokenFromFrontend === undefined ? false : config.accessFaunadbTokenFromFrontend,
