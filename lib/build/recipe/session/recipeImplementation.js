...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    */
    ...
    let obj = {
        ...
        getSession: function ({ accessToken: accessTokenString, antiCSRFMode = "NONE", antiCsrfToken, options }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (
                    (options === null || options === void 0 ? void 0 : options.antiCsrfCheck) !== false &&
                    antiCSRFMode === "VIA_CUSTOM_HEADER"
                ) {
                    throw new Error(
        ...
        refreshSession: function ({ refreshToken, antiCsrfToken, disableAntiCsrf, antiCSRFMode }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (disableAntiCsrf !== true && antiCSRFMode === "VIA_CUSTOM_HEADER") {
                    throw new Error(
                        "Since the anti-csrf mode is VIA_CUSTOM_HEADER getSession can't check the CSRF token. Please either use VIA_TOKEN or set antiCsrfCheck to false"
                    );
                }
