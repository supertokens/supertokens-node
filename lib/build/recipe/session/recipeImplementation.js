...
function getRecipeInterface(querier, config) {
    ...
    let obj = {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const claimBuilder of claimsToAdd) {
                    if (typeof claimBuilder === "function") {
                        const update = yield claimBuilder({
                            res,
                            userId,
                            accessTokenPayload,
                            sessionData,
                        ...
                        const value = yield claimBuilder.fetch(userId, userContext);
                        if (value !== undefined) {
        ...
        getSession: function ({ req, res, options, userContext }) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const reqClaims =
                        (_a = options === null || options === void 0 ? void 0 : options.overwriteDefaultValidators) !==
                            null && _a !== void 0
                            ? _a
                            : config.defaultValidatorsForVerification;
                    logger_1.logDebugMessage(
                        "getSession: required validatorTypeIds " + reqClaims.map((c) => c.validatorTypeId).join(", ")
                    );
                    const validationResult = yield session.validateClaims(reqClaims, userContext);
        ...
        mergeIntoAccessTokenPayload: function ({ sessionHandle, accessTokenPayloadUpdate }) {
            return __awaiter(this, void 0, void 0, function* () {
                const sessionInfo = yield SessionFunctions.getSessionInformation(helpers, sessionHandle);
