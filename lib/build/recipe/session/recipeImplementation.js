...
exports.JWKCacheMaxAgeInMs = void 0;
...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    let obj = {
        ...
        createNewSessionWithoutModifyingResponse: function ({
            userId,
            accessTokenPayload = {},
            sessionData = {},
            disableAntiCSRF,
            ...
            return __awaiter(this, void 0, void 0, function* () {
                logger_1.logDebugMessage("createNewSessionRaw: Started");
                let response = yield SessionFunctions.createNewSession(
                    helpers,
                    userId,
                ...
                const session = new sessionClass_1.default(
                    ...
                    cookieAndHeaders_1.buildFrontToken(
                        ...
                        response.accessToken !== undefined
                            ? (_a = response.accessToken) === null || _a === void 0
                                ? void 0
                                : _a.expiry
        ...
        getSessionWithoutModifyingResponse: function ({ accessToken: accessTokenString, antiCsrfToken, options }) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                if (
                    (options === null || options === void 0 ? void 0 : options.antiCsrfCheck) === true &&
                ...
                logger_1.logDebugMessage("getSessionWithoutModifyingResponse: Started");
                let accessToken;
                try {
                ...
                try {
                    ...
                    if (error.type !== error_1.default.TRY_REFRESH_TOKEN) {
                        logger_1.logDebugMessage(
                ...
                logger_1.logDebugMessage("getSessionWithoutModifyingResponse: Success!");
                const session = new sessionClass_1.default(
                    helpers,
        ...
        refreshSessionWithoutModifyingResponse: function ({ refreshToken, antiCsrfToken, doAntiCsrfCheck }) {
            return __awaiter(this, void 0, void 0, function* () {
                logger_1.logDebugMessage("refreshSessionWithoutModifyingResponse: Started");
                try {
                    let response = yield SessionFunctions.refreshSession(
                        helpers,
                        refreshToken,
                    ...
                    logger_1.logDebugMessage("refreshSessionWithoutModifyingResponse: Success!");
                    return {
                        status: "OK",
                        session: new sessionClass_1.default(
                            helpers,
