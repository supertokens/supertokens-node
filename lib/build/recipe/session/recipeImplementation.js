...
function getRecipeInterface(querier, config) {
    ...
    let obj = {
        createNewSession: function ({ res, userId, accessTokenPayload = {}, sessionData = {}, claimsToAdd }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!res.wrapperUsed) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let response = yield querier.sendPostRequest(
                    new normalisedURLPath_1.default("/recipe/session/regenerate"),
                    {
                        ...
                        claims: (_a = input.newClaimPayload) !== null && _a !== void 0 ? _a : {},
                    }
                );
        ...
        updateSessionClaims: function ({ sessionHandle, claims }) {
