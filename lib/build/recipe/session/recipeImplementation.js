...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    */
    ...
    let obj = {
        ...
        regenerateAccessToken: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (process.env.MOCK !== "true") {
                    ...
                    response = yield mockCore_1.mockRegenerateSession(
                        input.accessToken,
        ...
        revokeAllSessionsForUser: function ({ userId, revokeSessionsForLinkedAccounts }) {
            return SessionFunctions.revokeAllSessionsForUser(helpers, userId, revokeSessionsForLinkedAccounts);
        },
        getAllSessionHandlesForUser: function ({ userId, fetchSessionsForAllLinkedAccounts, userContext }) {
