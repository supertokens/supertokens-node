...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    */
    ...
    let obj = {
        ...
        getSession: function ({ accessToken: accessTokenString, antiCSRF = "NONE", antiCsrfToken, options }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (
        ...
        refreshSession: function ({ refreshToken, antiCsrfToken, disableAntiCsrf, antiCSRF }) {
            return __awaiter(this, void 0, void 0, function* () {
