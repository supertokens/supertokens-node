...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    */
    ...
    let obj = {
        ...
        getSessionInformation: function ({ sessionHandle, tenantId }) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        revokeAllSessionsForUser: function ({ userId, tenantId }) {
            return SessionFunctions.revokeAllSessionsForUser(helpers, userId, tenantId);
        },
        getAllSessionHandlesForUser: function ({ userId, tenantId }) {
            return SessionFunctions.getAllSessionHandlesForUser(helpers, userId, tenantId);
        },
        revokeSession: function ({ sessionHandle, tenantId }) {
            return SessionFunctions.revokeSession(helpers, sessionHandle, tenantId);
        },
        revokeMultipleSessions: function ({ sessionHandles, tenantId }) {
            return SessionFunctions.revokeMultipleSessions(helpers, sessionHandles, tenantId);
        },
        updateSessionDataInDatabase: function ({ sessionHandle, newSessionData, tenantId }) {
            return SessionFunctions.updateSessionDataInDatabase(helpers, sessionHandle, newSessionData, tenantId);
        },
        mergeIntoAccessTokenPayload: function ({ sessionHandle, accessTokenPayloadUpdate, tenantId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                const sessionInfo = yield this.getSessionInformation({ sessionHandle, tenantId, userContext });
