...
function getRecipeInterface(querier, config) {
    ...
    let obj = {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const reqClaimsValidators =
                        ...
                        undefined
                            ? yield options.overrideGlobalClaimValidators(session, globalClaimValidators, userContext)
                            : globalClaimValidators;
                    logger_1.logDebugMessage(
                        "getSession: required validator ids " + reqClaimsValidators.map((c) => c.id).join(", ")
                    );
                    yield session.assertClaims(reqClaimsValidators, userContext);
        ...
        mergeIntoAccessTokenPayload: function ({ sessionHandle, accessTokenPayloadUpdate }) {
            return __awaiter(this, void 0, void 0, function* () {
                const sessionInfo = yield this.getSessionInformation(helpers, sessionHandle);
        ...
        fetchAndSetClaim: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                const sessionInfo = yield this.getSessionInformation(helpers, input.sessionHandle);
        ...
        getClaimValue: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                return input.claim.getValueFromPayload(yield this.getAccessTokenPayload(), input.userContext);
            });
        },
