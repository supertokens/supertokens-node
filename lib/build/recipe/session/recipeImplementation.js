    ...
    let obj = {
        ...
        validateClaimsForSessionHandle: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const reqClaimsValidators =
                    input.overrideGlobalClaimValidators !== undefined
                        ? yield input.overrideGlobalClaimValidators(globalClaimValidators, sessionInfo, userContext)
                        : globalClaimValidators;
                const origSessionClaimPayloadJSON = JSON.stringify(sessionInfo.accessTokenPayload);
                let newAccessTokenPayload = yield utils_1.updateClaimsInPayloadIfNeeded(
                    reqClaimsValidators,
        ...
        validateClaimsInJWTPayload: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const reqClaimsValidators =
                    input.overrideGlobalClaimValidators !== undefined
                        ? yield input.overrideGlobalClaimValidators(globalClaimValidators, input.userId, userContext)
                        : globalClaimValidators;
