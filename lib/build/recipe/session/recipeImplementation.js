...
function getRecipeInterface(querier, config, appInfo, getRecipeImplAfterOverrides) {
    ...
    let obj = {
        ...
        createNewSessionWithoutModifyingResponse: function ({
            ...
            return __awaiter(this, void 0, void 0, function* () {
                logger_1.logDebugMessage("createNewSessionWithoutModifyingResponse: Started");
                let response = yield SessionFunctions.createNewSession(
                    helpers,
                    userId,
        ...
        refreshSessionWithoutModifyingResponse: function ({ refreshToken, antiCsrfToken, disableAntiCsrf }) {
            return __awaiter(this, void 0, void 0, function* () {
