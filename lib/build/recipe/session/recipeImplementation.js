    ...
    constructor(querier, config, isInServerlessEnv) {
        ...
        this.createNewSession = ({ res, userId, jwtPayload = {}, sessionData = {} }) =>
            __awaiter(this, void 0, void 0, function* () {
                if (!res.wrapperUsed) {
                    res = frameworks_1.default[supertokens_1.default.getInstanceOrThrowError().framework].wrapResponse(
                        res
                    );
                }
        ...
        this.getSession = ({ req, res, options }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (!req.wrapperUsed) {
                    req = frameworks_1.default[supertokens_1.default.getInstanceOrThrowError().framework].wrapRequest(
                        req
                    );
                }
