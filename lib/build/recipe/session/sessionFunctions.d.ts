 ...
 */
export declare function getSession(helpers: Helpers, parsedAccessToken: ParsedJWTInfo, antiCsrfToken: string | undefined, doAntiCsrfCheck: boolean, alwaysCheckCore: boolean, userContext: UserContext): Promise<{
    session: {
        handle: string;
        userId: string;
 ...
 */
export declare function refreshSession(helpers: Helpers, refreshToken: string, antiCsrfToken: string | undefined, disableAntiCsrf: boolean, userContext: UserContext): Promise<CreateOrRefreshAPIResponse>;
/**
