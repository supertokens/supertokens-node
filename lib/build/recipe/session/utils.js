...
function setAccessTokenInResponse(res, response, config, transferMethod) {
    ...
    cookieAndHeaders_1.setFrontTokenInHeaders(res, response.session.userId, response.accessToken.expiry, payload);
