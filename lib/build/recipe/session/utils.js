...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let errorHandlers = {
        ...
        onTryRefreshToken: (message, request, response) => {
            return middleware_1.sendTryRefreshTokenResponse(recipeInstance, message, request, response);
        },
        onUnauthorised: (message, request, response) => {
            return middleware_1.sendUnauthorisedResponse(recipeInstance, message, request, response);
        },
    };
