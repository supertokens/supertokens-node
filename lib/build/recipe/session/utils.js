...
const normalisedURLPath_1 = __importStar(require("../../normalisedURLPath"));
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let accessTokenPath =
        config === undefined || config.accessTokenPath === undefined
            ? normalisedURLPath_1.normaliseURLPathOrThrowError("/")
    ...
    return {
        ...
        accessTokenPath: appInfo.apiBasePath.appendPath(new normalisedURLPath_1.default(accessTokenPath)),
