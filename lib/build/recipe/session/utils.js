...
function sendInvalidClaimResponse(recipeInstance, validationError, __, response) {
    return __awaiter(this, void 0, void 0, function* () {
        cookieAndHeaders_1.setInvalidClaimHeader(response, JSON.stringify(validationError));
        utils_2.sendNon200Response(response, "invalid claim", recipeInstance.config.missingClaimStatusCode);
    });
}
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let errorHandlers = {
        ...
        onInvalidClaim: (validationError, request, response) => {
    ...
    return {
        ...
        claimsToAddOnCreation:
            (_a = config === null || config === void 0 ? void 0 : config.claimsToAddOnCreation) !== null &&
            _a !== void 0
                ? _a
                : [],
        defaultValidatorsForVerification:
            (_b = config === null || config === void 0 ? void 0 : config.defaultValidatorsForVerification) !== null &&
            _b !== void 0
                ? _b
                : [],
