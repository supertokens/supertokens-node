...
function sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, _, __, ___, response) {
    return __awaiter(this, void 0, void 0, function* () {
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let cookieSameSite = appInfo.topLevelAPIDomain !== appInfo.topLevelWebsiteDomain || protocolOfAPIDomain !== protocolOfWebsiteDomain
        ? "none"
        : "lax";
    cookieSameSite =
    ...
    let antiCsrf = config === undefined || config.antiCsrf === undefined
        ? cookieSameSite === "none"
            ? "VIA_CUSTOM_HEADER"
            : "NONE"
        : config.antiCsrf;
    let errorHandlers = {
        onTokenTheftDetected: (sessionHandle, userId, recipeUserId, request, response) => __awaiter(this, void 0, void 0, function* () {
            return yield sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, userId, recipeUserId, request, response);
        }),
        onTryRefreshToken: (message, request, response) => __awaiter(this, void 0, void 0, function* () {
...
function attachTokensToResponse(config, res, response, transferMethod) {
    ...
    cookieAndHeaders_1.setToken(config, res, "access", accessToken.token, 
    ...
    Date.now() + 3153600000000, transferMethod);
...
exports.attachTokensToResponse = attachTokensToResponse;
function getRequiredClaimValidators(session, overrideGlobalClaimValidators, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const globalClaimValidators = yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getGlobalClaimValidators({
