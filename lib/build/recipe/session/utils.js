...
function sendMissingClaimResponse(recipeInstance, claimId, __, response) {
    return __awaiter(this, void 0, void 0, function* () {
        cookieAndHeaders_1.setMissingClaimIdHeader(response, claimId);
        utils_2.sendNon200Response(response, "missing claim", recipeInstance.config.missingClaimStatusCode);
    });
}
exports.sendMissingClaimResponse = sendMissingClaimResponse;
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let errorHandlers = {
        ...
        onMissingClaim: (claimId, request, response) => {
    ...
    return {
        ...
        override,
        defaultClaims:
            (_a = config === null || config === void 0 ? void 0 : config.defaultClaims) !== null && _a !== void 0
                ? _a
                : [],
        defaultRequiredClaimChecks:
            (_b = config === null || config === void 0 ? void 0 : config.defaultRequiredClaimChecks) !== null &&
            _b !== void 0
                ? _b
                : [],
        missingClaimStatusCode:
            (_c = config === null || config === void 0 ? void 0 : config.missingClaimStatusCode) !== null &&
            _c !== void 0
                ? _c
                : 403,
        jwt: {
