...
async function sendTryRefreshTokenResponse(recipeInstance, _, __, response, ___) {
    utils_2.sendNon200ResponseWithMessage(response, "try refresh token", recipeInstance.config.sessionExpiredStatusCode);
}
...
async function sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, _, __, ___, response, userContext) {
    ...
    utils_2.sendNon200ResponseWithMessage(response, "token theft detected", recipeInstance.config.sessionExpiredStatusCode);
}
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let errorHandlers = {
        ...
        onClearDuplicateSessionCookies: async (message, _, response, __) => {
            return utils_1.send200Response(response, { message });
        },
    };
    ...
    return {
        ...
        overwriteSessionDuringSignInUp: config === null || config === void 0 ? void 0 : config.overwriteSessionDuringSignInUp,
        jwksRefreshIntervalSec: (_d = config === null || config === void 0 ? void 0 : config.jwksRefreshIntervalSec) !== null && _d !== void 0 ? _d : 3600 * 4,
    };
}
...
function setAccessTokenInResponse(res, accessToken, frontToken, config, transferMethod, req, userContext) {
    ...
    cookieAndHeaders_1.setToken(config, res, "access", accessToken, 
