...
async function sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, _, __, ___, response) {
    await recipeInstance.recipeInterfaceImpl.revokeSession({ sessionHandle, userContext: {} }); // TODO should userContext be passed to error handlers?
    utils_2.sendNon200ResponseWithMessage(
        response,
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    return {
        ...
        overwriteSessionDuringSignIn:
            (_d = config === null || config === void 0 ? void 0 : config.overwriteSessionDuringSignIn) !== null &&
            _d !== void 0
                ? _d
                : false,
    };
