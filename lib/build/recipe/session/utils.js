...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    const cookieSameSite = (req, userContext) =>
        __awaiter(this, void 0, void 0, function* () {
            ...
            const apiDomain = yield appInfo.apiDomain(req, userContext);
            ...
            let topLevelAPIDomain = utils_1.getTopLevelDomainForSameSiteResolution(apiDomainString);
    ...
    let cookieSecure = (req, userContext) =>
        __awaiter(this, void 0, void 0, function* () {
            let apiDomain = yield appInfo.apiDomain(req, userContext);
            let cookieSecureVal = apiDomain.getAsStringDangerous().startsWith("https");
