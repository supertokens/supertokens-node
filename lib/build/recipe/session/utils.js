...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    if ((config === null || config === void 0 ? void 0 : config.exposeAccessTokenToFrontendInCookieBasedAuth) == true) {
        exposeAccessTokenToFrontendInCookieBasedAuth = true;
    }
    ...
    return {
        useDynamicAccessTokenSigningKey:
            (config === null || config === void 0 ? void 0 : config.useDynamicAccessTokenSigningKey) === false,
