...
function updateClaimsInPayloadIfNeeded(userId, claimValidators, newAccessTokenPayload, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const validator of claimValidators) {
            ...
            if ("claim" in validator && (yield validator.shouldRefetch(newAccessTokenPayload, userContext))) {
                ...
                const value = yield validator.claim.fetchValue(userId, userContext);
