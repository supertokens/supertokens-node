...
function sendTokenTheftDetectedResponse(recipeInstance, sessionHandle, _, __, response, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        yield recipeInstance.recipeInterfaceImpl.revokeSession({ sessionHandle, tenantId, userContext: {} });
        utils_2.sendNon200ResponseWithMessage(
            response,
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let antiCsrf =
        config === undefined || config.antiCsrf === undefined
            ...
            : config.antiCsrf;
    let errorHandlers = {
        onTokenTheftDetected: (sessionHandle, userId, tenantId, request, response) =>
