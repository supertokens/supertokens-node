...
function sendMissingGrantResponse(recipeInstance, grantId, __, response) {
    return __awaiter(this, void 0, void 0, function* () {
        // TODO(grants): check header name
        response.setHeader("missing-grant-id", grantId, false);
        utils_2.sendNon200Response(response, "missing grant", recipeInstance.config.missingGrantStatusCode);
    });
}
exports.sendMissingGrantResponse = sendMissingGrantResponse;
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let errorHandlers = {
        ...
        onMissingGrant: (grantId, request, response) => {
    ...
    return {
        ...
        defaultRequiredGrants:
            (_a = config === null || config === void 0 ? void 0 : config.defaultRequiredGrants) !== null &&
            _a !== void 0
                ? _a
                : [],
        missingGrantStatusCode:
            (_b = config === null || config === void 0 ? void 0 : config.missingGrantStatusCode) !== null &&
            _b !== void 0
                ? _b
                : 403,
        jwt: {
