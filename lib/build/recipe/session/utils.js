...
function sendInvalidClaimResponse(recipeInstance, validationErrors, __, response) {
    return __awaiter(this, void 0, void 0, function* () {
        cookieAndHeaders_1.setInvalidClaimHeader(response, JSON.stringify(validationErrors));
        utils_2.sendNon200Response(response, "invalid claim", recipeInstance.config.invalidClaimStatusCode);
    });
}
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    return {
        ...
        invalidClaimStatusCode:
            (_a = config === null || config === void 0 ? void 0 : config.invalidClaimStatusCode) !== null &&
            _a !== void 0
                ? _a
                : 403,
        jwt: {
