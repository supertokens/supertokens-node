...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    let cookieSameSite = topLevelAPIDomain !== topLevelWebsiteDomain || protocolOfAPIDomain !== protocolOfWebsiteDomain ? "none" : "lax";
    cookieSameSite =
    ...
    let antiCsrf = config === undefined || config.antiCsrf === undefined
        ...
        : config.antiCsrf;
    let errorHandlers = {
        onTokenTheftDetected: (sessionHandle, userId, request, response) => __awaiter(this, void 0, void 0, function* () {
