...
function updateClaimsInPayloadIfNeeded(claimValidators, newAccessTokenPayload, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.updateClaimsInPayloadIfNeeded = updateClaimsInPayloadIfNeeded;
