...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, tenantId, req, res, path, method, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.REFRESH_API_PATH) {
                    return yield refresh_1.default(this.apiImpl, options, userContext);
                } else if (id === constants_1.SIGNOUT_API_PATH) {
                    return yield signout_1.default(this.apiImpl, options, userContext);
                } else {
                    return yield this.openIdRecipe.handleAPIRequest(id, tenantId, req, res, path, method, userContext);
                }
            });
        ...
        this.verifySession = (options, request, response, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
