...
const sessionsGet_1 = __importDefault(require("./api/sessionsGet"));
const sessionRevoke_1 = __importDefault(require("./api/sessionRevoke"));
// For Express
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAPIsHandled = () => {
            let apisHandled = [
                ...
                {
                    method: "get",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(constants_1.SESSIONS_GET_API_PATH),
        ...
        this.handleAPIRequest = async (id, _tenantId, req, res, _path, _method, userContext) => {
            ...
            } else if (id === constants_1.SESSIONS_GET_API_PATH) {
                return await sessionsGet_1.default(this.apiImpl, options, userContext, _tenantId);
            } else if (id === constants_1.SESSION_REVOKE_API_PATH) {
                return await sessionRevoke_1.default(this.apiImpl, options, userContext);
            } else {
                return false;
            }
        };
