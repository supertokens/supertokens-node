...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
            ...
            if (err.fromRecipe === SessionRecipe.RECIPE_ID) {
                if (err.type === error_1.default.UNAUTHORISED) {
                    ...
                    if (err.payload === undefined ||
                        ...
                        cookieAndHeaders_1.clearSessionFromAllTokenTransferMethods(this.config, response, request, userContext);
                    }
                    ...
                    logger_1.logDebugMessage("errorHandler: returning CLEAR_DUPLICATE_SESSION_COOKIES");
        ...
        this.getNormalisedOverwriteSessionDuringSignInUp = (req) => {
            ...
            const res = (_a = this.config.overwriteSessionDuringSignInUp) !== null && _a !== void 0 ? _a : supportsFDI31;
