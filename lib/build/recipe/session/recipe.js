...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        let builder = new supertokens_js_override_1.default((0, recipeImplementation_1.default)(querier_1.Querier.getNewInstanceOrThrowError(recipeId), this.config, this.getAppInfo(), () => this.recipeInterfaceImpl));
    ...
    static init(config) {
        return (appInfo, isInServerlessEnv, plugins) => {
            if (SessionRecipe.instance === undefined) {
                SessionRecipe.instance = new SessionRecipe(SessionRecipe.RECIPE_ID, appInfo, isInServerlessEnv, (0, plugins_1.applyPlugins)(SessionRecipe.RECIPE_ID, config, plugins !== null && plugins !== void 0 ? plugins : []));
                return SessionRecipe.instance;
            }
            else {
