...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.getAllCORSHeaders = () => {
            return [...cookieAndHeaders_1.getCORSAllowedHeaders(), ...this.jwtRecipe.getAllCORSHeaders()];
        };
        ...
        this.jwtRecipe = new recipe_1.default(recipeId, appInfo, isInServerlessEnv, {
            override: Object.assign({}, this.config.override.jwtFeature),
        });
        if (this.config.enableJWTFeature === true) {
            let defaultRecipeImplementation = new recipeImplementation_1.default(
                querier_1.Querier.getNewInstanceOrThrowError(recipeId),
                this.config,
                isInServerlessEnv
            );
            this.recipeInterfaceImpl = this.config.override.functions(
                new with_jwt_1.default(defaultRecipeImplementation, this.jwtRecipe.recipeInterfaceImpl)
            );
        } else {
            this.recipeInterfaceImpl = this.config.override.functions(
