...
class SessionRecipe extends recipeModule_1.default {
    ...
    static init(config) {
        return (appInfo, isInServerlessEnv, plugins) => {
            if (SessionRecipe.instance === undefined) {
                SessionRecipe.instance = new SessionRecipe(SessionRecipe.RECIPE_ID, appInfo, isInServerlessEnv, (0, utils_2.applyPlugins)(SessionRecipe.RECIPE_ID, config, plugins !== null && plugins !== void 0 ? plugins : []));
                return SessionRecipe.instance;
            }
            else {
