...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.defaultClaimsBuilders = [];
        this.defaultClaimValidators = [];
        ...
        this.handleError = (err, request, response) =>
            __awaiter(this, void 0, void 0, function* () {
                if (err.fromRecipe === SessionRecipe.RECIPE_ID) {
                    ...
                    } else if (err.type === error_1.default.INVALID_CLAIM) {
        ...
        this.addDefaultClaimBuilder = (builder) => {
            this.defaultClaimsBuilders.push(builder);
        };
        this.getDefaultClaimBuilders = () => {
            return this.defaultClaimsBuilders;
        };
        this.addDefaultClaimValidator = (builder) => {
            this.defaultClaimValidators.push(builder);
        };
        this.getGlobalClaimValidators = () => {
