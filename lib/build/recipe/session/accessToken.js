...
async function getInfoFromAccessToken(jwtInfo, jwks, doAntiCsrfCheck) {
    var _a, e_1, _b, _c;
    var _d;
    (0, logger_1.logDebugMessage)(`verifyAccessToken called with ${JSON.stringify(jwtInfo)}`);
    (0, logger_1.logDebugMessage)(`verifyAccessToken called with ${JSON.stringify(jwks)}`);
    (0, logger_1.logDebugMessage)(`verifyAccessToken called with ${JSON.stringify(doAntiCsrfCheck)}`);
    try {
        ...
        try {
            ...
            if (jwtInfo.version === 2 && (error === null || error === void 0 ? void 0 : error.code) === "ERR_JWKS_MULTIPLE_MATCHING_KEYS") {
                ...
                try {
                    ...
                    for (var _e = true, error_2 = __asyncValues(error), error_2_1; error_2_1 = await error_2.next(), _a = error_2_1.done, !_a; _e = true) {
                        _c = error_2_1.value;
                        _e = false;
                        const publicKey = _c;
                        try {
                            ...
                            if ((innerError === null || innerError === void 0 ? void 0 : innerError.code) === "ERR_JWS_SIGNATURE_VERIFICATION_FAILED") {
                                continue;
                            }
                            throw innerError;
                        }
        ...
        let recipeUserId = new recipeUserId_1.default((_d = sanitizeStringInput(payload.rsub)) !== null && _d !== void 0 ? _d : userId);
        ...
        (0, logger_1.logDebugMessage)("getInfoFromAccessToken: Returning TRY_REFRESH_TOKEN because access token validation failed - " +
            err.message);
