...
async function getInfoFromAccessToken(jwtInfo, jwks, doAntiCsrfCheck) {
    ...
    try {
        ...
        try {
            ...
            if (jwtInfo.version === 2 && (error === null || error === void 0 ? void 0 : error.code) === "ERR_JWKS_MULTIPLE_MATCHING_KEYS") {
                ...
                try {
                    ...
                    for (var error_2 = __asyncValues(error), error_2_1; error_2_1 = await error_2.next(), !error_2_1.done;) {
        ...
        let recipeUserId = new recipeUserId_1.default((_b = sanitizeStringInput(payload.rsub)) !== null && _b !== void 0 ? _b : userId);
        ...
        logger_1.logDebugMessage("getInfoFromAccessToken: Returning TRY_REFRESH_TOKEN because access token validation failed - " +
            err.message);
