...
function getInfoFromAccessToken(jwtInfo, jwks, doAntiCsrfCheck) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { payload } = yield jose_1.default.jwtVerify(jwtInfo.rawTokenString, jwks).catch((error) => {
                var error_2, error_2_1;
                return __awaiter(this, void 0, void 0, function* () {
                    var e_1, _a;
                    ...
                    if (
                        ...
                        try {
                            ...
                            for (
                                error_2 = __asyncValues(error);
                                (error_2_1 = yield error_2.next()), !error_2_1.done;

                            ) {
                                const publicKey = error_2_1.value;
                                try {
                                    return yield jose_1.default.jwtVerify(jwtInfo.rawTokenString, publicKey);
                                } catch (innerError) {
                                    if (
                        ...
                        throw new jose_1.default.errors.JWSSignatureVerificationFailed();
                    }
                    throw error;
                });
            });
