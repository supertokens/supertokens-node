 ...
 */
function createNewSession(recipeImplementation, userId, accessTokenPayload = {}, sessionData = {}) {
 ...
 */
function getAccessTokenPayload(recipeImplementation, sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeImplementation.querier.sendGetRequest(
...
function updateAccessTokenPayload(recipeImplementation, sessionHandle, newAccessTokenPayload) {
    return __awaiter(this, void 0, void 0, function* () {
