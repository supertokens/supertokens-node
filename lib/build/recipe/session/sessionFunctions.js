 ...
 */
function createNewSession(helpers, userId, disableAntiCsrf, recipeUserId, accessTokenPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield helpers.querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/session"), requestBody);
        helpers.updateJwtSigningPublicKeyInfo(response.jwtSigningPublicKeyList, response.jwtSigningPublicKey, response.jwtSigningPublicKeyExpiryTime);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const key of handShakeInfo.getJwtSigningPublicKeyList()) {
            try {
                 ...
                 */
                accessTokenInfo = yield accessToken_1.getInfoFromAccessToken(parsedAccessToken, key.publicKey, handShakeInfo.antiCsrf === "VIA_TOKEN" && doAntiCsrfCheck);
...
function refreshSession(helpers, refreshToken, antiCsrfToken, containsCustomHeader, transferMethod) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield helpers.querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/session/refresh"), requestBody);
        if (response.status === "OK") {
            delete response.status;
            return response;
        }
...
function revokeAllSessionsForUser(helpers, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield helpers.querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/session/remove"), {
            userId,
        });
