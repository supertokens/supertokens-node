 ...
 */
function getSessionInformation(helpers, sessionHandle, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function revokeAllSessionsForUser(helpers, userId, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
 ...
 */
function getAllSessionHandlesForUser(helpers, userId, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
 ...
 */
function revokeSession(helpers, sessionHandle, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
 ...
 */
function revokeMultipleSessions(helpers, sessionHandles, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
 ...
 */
function updateSessionDataInDatabase(helpers, sessionHandle, newSessionData, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
        newSessionData = newSessionData === null || newSessionData === undefined ? {} : newSessionData;
        let response = yield helpers.querier.sendPutRequest(
            new normalisedURLPath_1.default(`/${tenantId}/recipe/session/data`),
            {
                sessionHandle,
...
function updateAccessTokenPayload(helpers, sessionHandle, newAccessTokenPayload, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
        ...
        let response = yield helpers.querier.sendPutRequest(
            new normalisedURLPath_1.default(`/${tenantId}/recipe/jwt/data`),
            {
                sessionHandle,
