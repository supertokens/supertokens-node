 ...
 */
function createNewSession(helpers, userId, sessionGrants, accessTokenPayload = {}, sessionData = {}) {
...
function updateSessionGrants(helpers, sessionHandle, newGrants) {
    return __awaiter(this, void 0, void 0, function* () {
        newGrants = newGrants === null || newGrants === undefined ? {} : newGrants;
        const response = yield helpers.querier.sendPutRequest(
            new normalisedURLPath_1.default("/recipe/session/grants"),
            {
                sessionHandle,
                grants: newGrants,
            }
...
exports.updateSessionGrants = updateSessionGrants;
