 ...
 */
function createNewSession(helpers, userId, disableAntiCsrf, accessTokenPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let topLevelAPIDomain = utils_2.getTopLevelDomainForSameSiteResolution(
            helpers.appInfo.apiDomain.getAsStringDangerous()
        );
        let topLevelWebsiteDomain = utils_2.getTopLevelDomainForSameSiteResolution(
 ...
 */
function refreshSession(helpers, refreshToken, antiCsrfToken, containsCustomHeader, disableAntiCSRF) {
    return __awaiter(this, void 0, void 0, function* () {
        let handShakeInfo = yield helpers.getHandshakeInfo();
        let requestBody = {
            refreshToken,
