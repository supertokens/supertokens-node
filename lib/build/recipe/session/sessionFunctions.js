...
function createNewSession(
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const requestBody = {
            ...
            enableAntiCsrf: !disableAntiCsrf && antiCSRFMode === "VIA_TOKEN",
        };
 ...
 */
function getSession(helpers, parsedAccessToken, antiCsrfToken, doAntiCsrfCheck, alwaysCheckCore, antiCSRFMode) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        let accessTokenInfo;
        try {
            ...
            accessTokenInfo = yield accessToken_1.getInfoFromAccessToken(
                parsedAccessToken,
                helpers.JWKS,
                antiCSRFMode === "VIA_TOKEN" && doAntiCsrfCheck
            );
        } catch (err) {
            /**
        ...
        if (doAntiCsrfCheck) {
            ...
            } else if (antiCSRFMode === "VIA_CUSTOM_HEADER") {
        ...
        let requestBody = {
            ...
            antiCsrfToken,
            doAntiCsrfCheck,
            enableAntiCsrf: antiCSRFMode === "VIA_TOKEN",
 ...
 */
function refreshSession(helpers, refreshToken, antiCsrfToken, disableAntiCsrf, antiCSRFMode) {
    return __awaiter(this, void 0, void 0, function* () {
        let requestBody = {
            refreshToken,
            antiCsrfToken,
