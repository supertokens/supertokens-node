...
async function getSession(
    ...
    try {
        ...
        accessTokenInfo = await (0, accessToken_1.getInfoFromAccessToken)(
            parsedAccessToken,
            (0, combinedRemoteJWKSet_1.getCombinedJWKS)(helpers.querier, config),
    ...
    if (response.status === "OK") {
        ...
        if (response.payloadUpdateAvailable === true) {
...
async function refreshSession(
    ...
    try {
        ...
        if (
            ...
            (err === null || err === void 0 ? void 0 : err.message) !== undefined &&
            ...
            const { accessTokenValidity: _ignored } = requestBody,
                requestBodyWithoutValidity = __rest(requestBody, ["accessTokenValidity"]);
    ...
    if (response.status === "OK") {
        ...
        throw new error_1.default({
            ...
            payload: {
                ...
                recentTokenReuseSubtype: response.recentTokenReuseSubtype,
            },
