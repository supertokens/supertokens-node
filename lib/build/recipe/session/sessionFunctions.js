 ...
 */
function refreshSession(helpers, refreshToken, antiCsrfToken, disableAntiCsrf, useDynamicAccessTokenSigningKey) {
    return __awaiter(this, void 0, void 0, function* () {
        let requestBody = {
            refreshToken,
            antiCsrfToken,
 ...
 */
function revokeAllSessionsForUser(helpers, userId, tenantId, revokeAcrossAllTenants) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function getAllSessionHandlesForUser(helpers, userId, tenantId, fetchAcrossAllTenants) {
    return __awaiter(this, void 0, void 0, function* () {
        if (tenantId === undefined) {
            tenantId = constants_1.DEFAULT_TENANT_ID;
        }
