 ...
 */
function createNewSession(helpers, userId, sessionClaims, accessTokenPayload = {}, sessionData = {}) {
...
function updateSessionClaims(helpers, sessionHandle, newClaimPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        newClaimPayload = newClaimPayload === null || newClaimPayload === undefined ? {} : newClaimPayload;
        const response = yield helpers.querier.sendPutRequest(
            new normalisedURLPath_1.default("/recipe/session/claims"),
            {
                sessionHandle,
...
exports.updateSessionClaims = updateSessionClaims;
