...
function createNewSession(
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.env.MOCK !== "true") {
            ...
            response.session.recipeUserId = new recipeUserId_1.default(response.session.recipeUserId);
        }
 ...
 */
function getAllSessionHandlesForUser(helpers, userId, fetchSessionsForAllLinkedAccounts, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
