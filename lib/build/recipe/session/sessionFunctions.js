...
function createNewSession(recipeInstance, userId, jwtPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default("/recipe/session"), requestBody);
...
function getSession(recipeInstance, accessToken, antiCsrfToken, doAntiCsrfCheck, containsCustomHeader) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default("/recipe/session/verify"), requestBody);
...
function refreshSession(recipeInstance, refreshToken, antiCsrfToken, containsCustomHeader) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default("/recipe/session/refresh"), requestBody);
        if (response.status === "OK") {
            delete response.status;
            return response;
        } else if (response.status === "UNAUTHORISED") {
...
function revokeAllSessionsForUser(recipeInstance, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendPostRequest(new normalisedURLPath_1.default("/recipe/session/remove"), {
                userId,
            });
...
function getAllSessionHandlesForUser(recipeInstance, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendGetRequest(new normalisedURLPath_1.default("/recipe/session/user"), {
                userId,
            });
...
function getSessionData(recipeInstance, sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendGetRequest(new normalisedURLPath_1.default("/recipe/session/data"), {
                sessionHandle,
            });
        if (response.status === "OK") {
...
function updateSessionData(recipeInstance, sessionHandle, newSessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield recipeInstance
            .getQuerier()
            .sendPutRequest(new normalisedURLPath_1.default("/recipe/session/data"), {
                sessionHandle,
...
function getJWTPayload(recipeInstance, sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield recipeInstance
            .getQuerier()
            .sendGetRequest(new normalisedURLPath_1.default("/recipe/jwt/data"), {
                sessionHandle,
            });
        if (response.status === "OK") {
...
function updateJWTPayload(recipeInstance, sessionHandle, newJWTPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield recipeInstance
            .getQuerier()
            .sendPutRequest(new normalisedURLPath_1.default("/recipe/jwt/data"), {
                sessionHandle,
