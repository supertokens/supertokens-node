 ...
 */
function getSession(helpers, parsedAccessToken, antiCsrfToken, doAntiCsrfCheck, alwaysCheckCore, antiCSRF) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        let accessTokenInfo;
        try {
 ...
 */
function refreshSession(helpers, refreshToken, antiCsrfToken, disableAntiCsrf, antiCSRF) {
    return __awaiter(this, void 0, void 0, function* () {
        let requestBody = {
            refreshToken,
            antiCsrfToken,
