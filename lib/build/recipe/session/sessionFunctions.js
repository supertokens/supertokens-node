            ...
            return Object.assign(Object.assign({}, response), {
                session: {
                    ...
                    expiryTime:
                        ...
                        (accessTokenInfo === null || accessTokenInfo === void 0
                            ? void 0
...
function getSessionInformation(helpers, sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response;
        if (process.env.MOCK !== "true") {
            response = yield helpers.querier.sendGetRequest(new normalisedURLPath_1.default(`/recipe/session`), {
                sessionHandle,
            });
        } else {
            response = yield mockCore_1.mockGetSessionInformation(sessionHandle, helpers.querier);
        }
        if (response.status === "OK") {
 ...
 */
function revokeAllSessionsForUser(helpers, userId, revokeSessionsForLinkedAccounts, tenantId, revokeAcrossAllTenants) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.env.MOCK !== "true") {
            ...
            return yield mockCore_1.mockRevokeAllSessionsForUser({
                userId,
                revokeSessionsForLinkedAccounts,
 ...
 */
function getAllSessionHandlesForUser(
    helpers,
    userId,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.env.MOCK !== "true" || (userContext !== undefined && userContext.doNotMock === true)) {
            let response = yield helpers.querier.sendGetRequest(
            ...
            return yield mockCore_1.mockGetAllSessionHandlesForUser({ userId, fetchSessionsForAllLinkedAccounts });
        }
    });
}
...
function revokeSession(helpers, sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        if (process.env.MOCK !== "true") {
            ...
            return yield mockCore_1.mockRevokeSession(sessionHandle, helpers.querier);
        }
    });
}
...
function updateAccessTokenPayload(helpers, sessionHandle, newAccessTokenPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.env.MOCK !== "true") {
            ...
            return yield mockCore_1.mockUpdateAccessTokenPayload(sessionHandle, newAccessTokenPayload, helpers.querier);
        }
    });
}
