...
function createNewSession(userId, jwtPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendPostRequest("/session", {
            userId,
...
function getSession(accessToken, antiCsrfToken, doAntiCsrfCheck) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!error_1.default.isErrorFromSession(err) || err.type !== error_1.default.TRY_REFRESH_TOKEN) {
        ...
        let response = yield _1.getQuerier().sendPostRequest("/session/verify", {
            accessToken,
            antiCsrfToken,
            doAntiCsrfCheck,
        });
...
function refreshSession(refreshToken, antiCsrfToken) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendPostRequest("/session/refresh", {
            refreshToken,
            antiCsrfToken,
        });
        if (response.status == "OK") {
...
function revokeAllSessionsForUser(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendPostRequest("/session/remove", {
            userId,
        });
...
function getAllSessionHandlesForUser(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendGetRequest("/session/user", {
            userId,
        });
...
function getSessionData(sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendGetRequest("/session/data", {
            sessionHandle,
        });
        if (response.status === "OK") {
...
function updateSessionData(sessionHandle, newSessionData) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendPutRequest("/session/data", {
            sessionHandle,
...
function getJWTPayload(sessionHandle) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendGetRequest("/jwt/data", {
            sessionHandle,
        });
        if (response.status === "OK") {
...
function updateJWTPayload(sessionHandle, newJWTPayload) {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield _1.getQuerier().sendPutRequest("/jwt/data", {
            sessionHandle,
