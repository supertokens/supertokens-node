...
function getSession(req, res, doAntiCsrfCheck) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (error_1.default.isErrorFromSession(err) && err.type === error_1.default.UNAUTHORISED) {
...
function refreshSession(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (
                error_1.default.isErrorFromSession(err) &&
                (err.type === error_1.default.UNAUTHORISED || err.type === error_1.default.TOKEN_THEFT_DETECTED)
            ) {
                cookieAndHeaders_1.clearSessionFromCookie(res);
            }
            throw err;
...
class Session {
    constructor(accessToken, sessionHandle, userId, userDataInJWT, accessTokenExpiry, res) {
        ...
        this.updateJWTPayload = (newJWTPayload) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield _1.getQuerier().sendPostRequest("/session/regenerate", {
