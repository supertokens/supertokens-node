...
function getSMTPProvider(config, getDefaultEmailServiceImplementation) {
    ...
    return {
        sendEmail: function (input, userContext) {
            return __awaiter(this, void 0, void 0, function* () {
                let content = yield serviceImpl.getContent(input, userContext);
                yield serviceImpl.sendRawEmail(content, userContext);
            });
        },
    };
}
exports.getSMTPProvider = getSMTPProvider;
