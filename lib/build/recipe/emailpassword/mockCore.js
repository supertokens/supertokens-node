...
exports.mockUpdateEmailOrPassword = exports.mockCreateRecipeUser = exports.mockSignIn = exports.mockConsumePasswordResetToken = exports.mockCreatePasswordResetToken = exports.mockGetPasswordResetInfo = exports.mockReset = void 0;
...
function mockGetPasswordResetInfo(token) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.mockGetPasswordResetInfo = mockGetPasswordResetInfo;
        ...
        if (response.status === "OK" && shouldMarkEmailVerified) {
            ...
            try {
                ...
                if (tokenResp.status === "OK") {
                    ...
                    yield EmailVerification.verifyEmailUsingToken(tokenResp.token, false);
                }
            } catch (err) {
