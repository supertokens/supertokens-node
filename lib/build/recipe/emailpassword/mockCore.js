...
function mockCreatePasswordResetToken(email, userId, tenantId) {
    return __awaiter(this, void 0, void 0, function* () {
...
function mockConsumePasswordResetToken(token, newPassword, tenantId, querier) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield querier.sendPostRequest(
