...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    if (emailService === undefined) {
        emailService = {
            sendEmail: (input, userContext) =>
                __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    if (input.type === "EMAIL_VERIFICATION") {
                        return yield recipeInstance.emailVerificationRecipe.emailDelivery.recipeInterfaceImpl.sendEmail(
                            input,
                            userContext
                        );
                    }
                    let createAndSendCustomEmail =
                        (_a = config === null || config === void 0 ? void 0 : config.resetPasswordUsingTokenFeature) ===
                            null || _a === void 0
                            ? void 0
                    ...
                    yield createAndSendCustomEmail(input.user, input.passwordResetLink, userContext);
                }),
        };
    }
    let emailDelivery = Object.assign(
        { service: emailService, override: (originalImplementation) => originalImplementation },
        config === null || config === void 0 ? void 0 : config.emailDelivery
    );
    return {
        signUpFeature,
        signInFeature,
...
function validateAndNormaliseEmailVerificationConfig(recipeInstance, _, config) {
    ...
    return {
        emailDelivery:
            (config === null || config === void 0 ? void 0 : config.emailDelivery) === undefined
                ? undefined
                : {
