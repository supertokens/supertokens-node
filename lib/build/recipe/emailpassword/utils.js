...
function defaultSetSessionDataForSession(user, formFields, action) {
    return __awaiter(this, void 0, void 0, function* () {
        return {};
    });
}
function defaultSetJwtPayloadForSession(user, formFields, action) {
    return __awaiter(this, void 0, void 0, function* () {
        return {};
    });
}
...
function validateAndNormaliseSignupConfig(recipeInstance, appInfo, config) {
    let disableDefaultImplementation =
        config === undefined || config.disableDefaultImplementation === undefined
            ? false
            : config.disableDefaultImplementation;
    let formFields = config === undefined ? [] : normaliseSignUpFormFields(config.formFields);
