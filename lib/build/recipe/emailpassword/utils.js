...
exports.defaultEmailValidator = exports.defaultPasswordValidator = exports.normaliseSignUpFormFields = exports.validateAndNormaliseUserInput = void 0;
...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    function getEmailDeliveryConfig(recipeImpl, isInServerlessEnv) {
        ...
        if (emailService === undefined) {
            emailService = new backwardCompatibility_1.default(recipeImpl, appInfo, isInServerlessEnv, config === null || config === void 0 ? void 0 : config.resetPasswordUsingTokenFeature);
        }
