...
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    if (config !== undefined && config.override !== undefined) {
        override = Object.assign(Object.assign({}, override), config.override);
    }
    return {
        sessionFeature,
        signUpFeature,
...
function validateAndNormaliseEmailVerificationConfig(recipeInstance, _, config) {
    ...
    return {
        ...
        createAndSendCustomEmail:
            ((_a = config === null || config === void 0 ? void 0 : config.emailVerificationFeature) === null ||
            _a === void 0
                ? void 0
                : _a.createAndSendCustomEmail) === undefined
                ? undefined
                : (user, link) =>
                      __awaiter(this, void 0, void 0, function* () {
                          ...
                          if (
                              ...
                              ((_c =
                                  ...
                                  null || _c === void 0
                                  ? void 0
                                  : _c.createAndSendCustomEmail) === undefined
                          ) {
        ...
        getEmailVerificationURL:
            ...
            _b === void 0
                ? void 0
                : _b.getEmailVerificationURL) === undefined
                ? undefined
                : (user) =>
                      __awaiter(this, void 0, void 0, function* () {
                          var _d;
                          ...
                          if (
                              ...
                              ((_d =
                                  ...
                                  null || _d === void 0
                                  ? void 0
                                  : _d.getEmailVerificationURL) === undefined
                          ) {
                              throw new Error("Unknown User ID provided");
                          }
