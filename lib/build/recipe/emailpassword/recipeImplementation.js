...
function getRecipeInterface(querier) {
    return {
        ...
        updateEmailOrPassword: function (input, options = { applyPasswordPolicy: true }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (options.applyPasswordPolicy) {
                    const formFields = recipe_1.default.getInstanceOrThrowError().config.signUpFeature.formFields;
