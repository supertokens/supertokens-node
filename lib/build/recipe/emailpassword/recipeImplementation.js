        ...
        signUp: function ({ email, password, doAccountLinking, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (response.status === "OK") {
                    ...
                    if (doAccountLinking) {
                        let primaryUserId = yield recipe_1.default.getInstanceOrThrowError().doPostSignUpAccountLinkingOperations({
                            newUser: {
                                email,
                    ...
                    return Object.assign(Object.assign({}, response), { createdNewUser });
                }
                else {
                    return {
