...
function getRecipeInterface(querier, getEmailPasswordConfig) {
    return {
        signUp: function ({ email, password, tenantId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield this.createNewRecipeUser({
                    email,
                    password,
                    tenantId,
                    userContext,
        ...
        signIn: function ({ email, password, tenantId, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let response;
                if (process.env.MOCK !== "true") {
                    ...
                    response = yield mockCore_1.mockSignIn({ email, password, tenantId });
                }
                if (response.status === "OK") {
        ...
        createResetPasswordToken: function ({ userId, email, tenantId }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (process.env.MOCK !== "true") {
        ...
        consumePasswordResetToken: function ({ token, newPassword, tenantId }) {
            return __awaiter(this, void 0, void 0, function* () {
                if (process.env.MOCK !== "true") {
                    return yield querier.sendPostRequest(
                        new normalisedURLPath_1.default(
                    ...
                    return mockCore_1.mockConsumePasswordResetToken(token, newPassword, tenantId, querier);
                }
            });
        },
