...
const derivedEmailVerificationServiceImplementation_1 = require("./derivedEmailVerificationServiceImplementation");
class SMTPService {
    constructor(config) {
        this.sendEmail = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.serviceImpl.sendRawEmail(
                    Object.assign(Object.assign(Object.assign({}, content), input.userContext), {
        ...
        this.evSMTPService = new smtp_1.default({
            smtpSettings: this.config.smtpSettings,
            override: (_) => {
                return derivedEmailVerificationServiceImplementation_1.getDerivedEV(this.serviceImpl);
            },
        });
    }
}
