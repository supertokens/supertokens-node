...
function getServiceImplementation(transporter, emailVerificationSMTPEmailService) {
    return {
        ...
        getContent: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                if (input.type === "EMAIL_VERIFICATION") {
                    return yield emailVerificationSMTPEmailService.serviceImpl.getContent(input);
                }
