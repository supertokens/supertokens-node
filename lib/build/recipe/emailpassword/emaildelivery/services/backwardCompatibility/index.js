...
class BackwardCompatibilityService {
    constructor(_, appInfo, isInServerlessEnv) {
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    if (!this.isInServerlessEnv) {
                        ...
                        yield this.createAndSendCustomEmail(input.user, input.passwordResetLink, input.userContext);
                    }
                } catch (_) {}
            });
        this.isInServerlessEnv = isInServerlessEnv;
        this.appInfo = appInfo;
        this.createAndSendCustomEmail = passwordResetFunctions_1.createAndSendCustomEmail(this.appInfo);
    }
}
