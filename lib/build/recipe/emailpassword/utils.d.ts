...
export declare function defaultEmailValidator(value: any): Promise<"Email is invalid" | "Development bug: Please make sure the email field yields a string" | undefined>;
