...
import { TypeInput, TypeNormalisedInput, NormalisedFormField, TypeInputEmailVerificationFeature, TypeInputFormField } from "./types";
...
export declare function validateAndNormaliseEmailVerificationConfig(recipeInstance: Recipe, appInfo: NormalisedAppinfo, config?: TypeInputEmailVerificationFeature): TypeNormalisedInputEmailVerification;
