...
const anomalydetection_1 = __importDefault(require("../../anomalydetection"));
function getAPIImplementation() {
    return {
        ...
        signInPOST: async function ({ formFields, tenantId, options, userContext }) {
            ...
            if (anomalydetection_1.default.getInstance() !== undefined) {
                const anomalyDetected = await anomalydetection_1.default.checkForAnomaly(
                    options.req,
                    response.user.id,
                    userContext
                );
