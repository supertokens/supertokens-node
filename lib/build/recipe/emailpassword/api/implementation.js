        ...
        generatePasswordResetTokenPOST: async function ({ formFields, tenantId, options, userContext, }) {
            ...
            async function generateAndSendPasswordResetToken(primaryUserId, recipeUserId) {
                ...
                if (response.status === "UNKNOWN_USER_ID_ERROR") {
                    (0, logger_1.logDebugMessage)(`Password reset email not sent, unknown user id: ${recipeUserId === undefined ? primaryUserId : recipeUserId.getAsString()}`);
                    return {
                        status: "OK",
                    };
                }
            ...
            (0, logger_1.logDebugMessage)("generatePasswordResetTokenPOST: primary linking candidate: " + (linkingCandidate === null || linkingCandidate === void 0 ? void 0 : linkingCandidate.id));
            ...
            if (linkingCandidate === undefined && users.length > 0) {
                ...
                (0, logger_1.logDebugMessage)(`generatePasswordResetTokenPOST: oldest recipe level-linking candidate: ${oldestUser.id} (w/ ${oldestUser.loginMethods[0].verified ? "verified" : "unverified"} email)`);
                ...
                (0, logger_1.logDebugMessage)(`generatePasswordResetTokenPOST: recipe level-linking candidate ${shouldBecomePrimaryUser ? "can" : "can not"} become primary`);
            ...
            */
            ...
            if (emailPasswordAccount === undefined) {
                ...
                if (!shouldDoAccountLinkingResponse.shouldAutomaticallyLink) {
                    (0, logger_1.logDebugMessage)(`Password reset email not sent, since email password user didn't exist, and account linking not enabled`);
                    return {
                        status: "OK",
                    };
                }
                ...
                if (isSignUpAllowed) {
                    ...
                    (0, logger_1.logDebugMessage)(`Password reset email not sent, isSignUpAllowed returned false for email: ${email}`);
                    return {
                        status: "OK",
                    };
                }
