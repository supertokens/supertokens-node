                    ...
                    if (primaryUser !== undefined) {
                        ...
                        if (epUser === undefined) {
                            ...
                            if (epRecipeUser === undefined) {
                                ...
                                let identitiesForPrimaryUser = accountlinking_1.default.getIdentitiesForUser(
                                    primaryUser
                                );
                                /**
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (response.status === "OK") {
                    ...
                    if (user.isPrimaryUser) {
                        ...
                        let result = yield accountlinking_1.default.createPrimaryUserIdOrLinkAccounts(
                            user.id,
                            session,
                            userContext
                        );
                        if (result.createNewSession) {
                            ...
                            let currentSessionData = session === undefined ? undefined : yield session.getSessionData();
