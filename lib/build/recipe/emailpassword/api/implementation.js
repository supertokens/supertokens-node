    ...
    return {
        ...
        generatePasswordResetTokenPOST: async function ({ formFields, tenantId, options, userContext }) {
            ...
            if (linkingCandidate === undefined && users.length > 0) {
                ...
                const shouldBecomePrimaryUser = await recipe_1.default.getInstanceOrThrowError().shouldBecomePrimaryUser(oldestUser, tenantId, undefined, userContext);
            ...
            */
            ...
            let shouldDoAccountLinkingResponse = await recipe_1.default.getInstanceOrThrowError().config.shouldDoAutomaticAccountLinking(emailPasswordAccount !== undefined
