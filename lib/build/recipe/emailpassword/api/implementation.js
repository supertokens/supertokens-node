    ...
    return {
        linkAccountToExistingAccountPOST: function ({ formFields, session, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let accountLinkingInstance = yield recipe_1.default.getInstanceOrThrowError();
                let result = yield accountLinkingInstance.linkAccountsWithUserFromSession({
                    session,
                    newUser: {
                        email,
                ...
                if (result.status === "CUSTOM_RESPONSE") {
                    ...
                    // status: "OK"
                    yield session.fetchAndSetClaim(accountLinkingClaim_1.AccountLinkingClaim, userContext);
                    return {
        ...
        emailExistsGET: function ({ email, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let usersWithSameEmail = yield __1.listUsersByAccountInfo(
                    {
                        email,
                    },
                    userContext
        ...
        generatePasswordResetTokenPOST: function ({ formFields, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function generateAndSendPasswordResetToken(userId) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (response.status === "UNKNOWN_USER_ID_ERROR") {
                            logger_1.logDebugMessage(`Password reset email not sent, unknown user id: ${userId}`);
                            return {
                                status: "OK",
                            };
                        }
                ...
                if (primaryUserAssociatedWithEmail === undefined) {
                    ...
                    return yield generateAndSendPasswordResetToken(emailPasswordAccount.recipeUserId);
                }
                ...
                if (emailPasswordAccount === undefined) {
                    ...
                    if (isSignUpAllowed) {
                        ...
                        return yield generateAndSendPasswordResetToken(primaryUserAssociatedWithEmail.id);
                    } else {
                ...
                if (areTheTwoAccountsLinked) {
                    return yield generateAndSendPasswordResetToken(emailPasswordAccount.recipeId);
                }
        ...
        passwordResetPOST: function ({ formFields, token, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                function markEmailAsVerified(userId, email) {
                    return __awaiter(this, void 0, void 0, function* () {
                ...
                function doUpdatePassword() {
                    return __awaiter(this, void 0, void 0, function* () {
                        let updateResponse = yield options.recipeImplementation.updateEmailOrPassword({
                            userId: recipeUserIdForWhomTokenWasGenerated,
                ...
                let recipeUserIdForWhomTokenWasGenerated = tokenConsumptionResponse.userId;
                ...
                if (existingUser.isPrimaryUser) {
                    ...
                    let emailPasswordUserIsLinkedToExistingUser =
                        existingUser.loginMethods.find((lm) => {
                            ...
                            return lm.recipeUserId === recipeUserIdForWhomTokenWasGenerated;
                        }) !== undefined;
                    if (emailPasswordUserIsLinkedToExistingUser) {
                        ...
                        if (createUserResponse.status === "EMAIL_ALREADY_EXISTS_ERROR") {
                            ...
                            // as verified.
                            yield markEmailAsVerified(createUserResponse.user.id, tokenConsumptionResponse.email);
