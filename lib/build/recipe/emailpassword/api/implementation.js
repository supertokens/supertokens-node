    ...
    return {
        ...
        generatePasswordResetTokenPOST: function ({ formFields, options, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let passwordResetLink = (yield options.config.resetPasswordUsingTokenFeature.getResetPasswordURL(user, userContext)) +
                    "?token=" +
                    response.token +
                    "&rid=" +
                    options.recipeId;
                try {
                    if (!options.isInServerlessEnv) {
                        ...
                        yield options.config.resetPasswordUsingTokenFeature.createAndSendCustomEmail(user, passwordResetLink, userContext);
                    }
                }
                catch (_) { }
                return {
