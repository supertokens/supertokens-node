    ...
    return {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (result.createRecipeUser) {
                    ...
                    if (response.status !== "OK") {
                        throw Error(`this error should never be thrown while creating a new user during accountLinkPostSignInViaSession flow: ${response.status}`);
                    }
                    ...
                    if (result.updateAccountLinkingClaim === "ADD_CLAIM") {
                        ...
                        yield session.setClaimValue(accountLinkingClaim_1.AccountLinkingClaim, response.user.id, userContext);
                        return {
                ...
                if (result.createRecipeUser) {
                    throw Error(`this error should never be thrown after creating a new user during accountLinkPostSignInViaSession flow`);
                }
                if (!result.accountsLinked && "reason" in result) {
                    ...
                    if (result.reason === "ACCOUNT_INFO_ALREADY_LINKED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR" ||
                ...
                if (user === undefined) {
                    throw Error("this error should never be thrown. Can't find primary user with userId: " + session.getUserId());
                }
                return {
                    status: "OK",
                    user,
        ...
        generatePasswordResetTokenPOST: function ({ formFields, options, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (users !== undefined) {
                    ...
                    if (primaryUser !== undefined) {
                        ...
                        if (epUser === undefined) {
                             ...
                             */
                            let epRecipeUser = users.find((u) => u.loginMethods.find((l) => l.recipeId === "emailpassword") !== undefined);
                            if (epRecipeUser === undefined) {
                                 ...
                                 */
                                let shouldDoAccountLinking = yield recipe_1.default.getInstanceOrThrowError().config.shouldDoAutomaticAccountLinking({
                                    email,
                                    recipeId: "emailpassword",
                                }, primaryUser, undefined, userContext);
                                ...
                                let identitiesForPrimaryUser = recipe_1.default.getInstanceOrThrowError().transformUserInfoIntoVerifiedAndUnverifiedBucket(primaryUser);
                                /**
                ...
                if (response.status === "UNKNOWN_USER_ID_ERROR") {
                    logger_1.logDebugMessage(`Password reset email not sent, unknown user id: ${userIdForPasswordReset}`);
                    return {
                        status: "OK",
                    };
                }
                let passwordResetLink = options.appInfo.websiteDomain.getAsStringDangerous() +
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (response.status === "OK") {
                    ...
                    if (user.isPrimaryUser) {
                        ...
                        const session = yield session_1.default.getSession(options.req, options.res, { overrideGlobalClaimValidators: () => [], sessionRequired: false }, userContext);
                        let result = yield recipe_1.default.getInstanceOrThrowError().createPrimaryUserIdOrLinkAccountsAfterEmailVerification({
                            recipeUserId: user.id,
                            session,
                            userContext,
                        });
                        if (result.createNewSession) {
                            yield session_1.createNewSession(options.req, options.res, result.primaryUserId, result.recipeUserId, {}, {}, userContext);
                        }
                    }
                }
                return response;
        ...
        signInPOST: function ({ formFields, options, userContext, }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let session = yield session_1.default.createNewSession(options.req, options.res, user.id, recipeUser.recipeUserId, {}, {}, userContext);
                return {
                    status: "OK",
                    session,
                    user,
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!isSignUpAllowed) {
                    return {
                        ...
                        reason: "The input email is already associated with another account where it is not verified. Please disable automatic account linking, or verify the other account before trying again.",
                    };
                }
                let response = yield options.recipeImplementation.signUp({
                    email,
