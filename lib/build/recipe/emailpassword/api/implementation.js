...
function getAPIImplementation() {
    return {
        ...
        passwordResetPOST: async function ({ formFields, token, tenantId, options, userContext }) {
            ...
            async function doUpdatePasswordAndEmailVerification(recipeUserId) {
                ...
                if (
                    ...
                    const userAfterLinking = linkRes.status === "OK" ? linkRes.user : updatedUserAfterEmailVerification;
                    if (linkRes.status === "OK" && linkRes.user.id !== updatedUserAfterEmailVerification.id) {
            ...
            if (existingUser.isPrimaryUser) {
                ...
                if (emailPasswordUserIsLinkedToExistingUser) {
                    return doUpdatePasswordAndEmailVerification(
                ...
                return doUpdatePasswordAndEmailVerification(new recipeUserId_1.default(userIdForWhomTokenWasGenerated));
            }
        },
