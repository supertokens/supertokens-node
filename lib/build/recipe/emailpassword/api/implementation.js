    ...
    return {
        ...
        signInPOST: function ({ formFields, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let response = yield options.recipeImplementation.signIn({
                    email,
                    password,
                    userContext,
                });
                ...
                if (session === undefined) {
                    ...
                    const linkAccountResponse = yield accountlinking_1.linkAccounts(
                        emailPasswordRecipeUser.recipeUserId,
                        session.getUserId(),
                        userContext
                    );
                ...
                yield mfa_1.completeFactorInSession(session, "emailpassword", userContext);
                return {
                    status: "OK",
                    session,
                    user: response.user,
        ...
        signUpPOST: function ({ formFields, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (session === undefined) {
                    ...
                    // Session already exists, we need to link accounts
                    let user = yield __1.getUser(session.getUserId(), userContext);
                    if ((user === null || user === void 0 ? void 0 : user.isPrimaryUser) === false) {
                        let resp = yield accountlinking_1.createPrimaryUser(session.getRecipeUserId(), userContext);
