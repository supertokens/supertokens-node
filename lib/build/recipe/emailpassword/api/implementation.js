        ...
        generatePasswordResetTokenPOST: async function ({ formFields, tenantId, options, userContext }) {
            ...
            */
            ...
            let shouldDoAccountLinkingResponse = await stInstance
                .getRecipeInstanceOrThrow("accountlinking")
                .config.shouldDoAutomaticAccountLinking(emailPasswordAccount !== undefined
        ...
        passwordResetPOST: async function ({ formFields, token, tenantId, options, userContext, }) {
            async function markEmailAsVerified(recipeUserId, email) {
                ...
                try {
                    ...
                    (0, logger_1.logDebugMessage)("email verification recipe not initialised, not marking email as verified");
                }
