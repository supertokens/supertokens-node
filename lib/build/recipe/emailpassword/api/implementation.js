...
function getAPIImplementation() {
    return {
        ...
        signInPOST: async function ({ formFields, tenantId, options, userContext }) {
            ...
            let session;
            session = await session_1.default.getSession(options.req, options.res, {
            ...
            return {
                ...
                user: await __1.getUser(response.user.id, userContext), // fetching user again cause the user might have been updated while setting up mfa
            };
        },
