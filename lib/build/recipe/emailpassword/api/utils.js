...
function validateFormFieldsOrThrowError(recipeInstance, configFormFields, formFieldsRaw) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < formFieldsRaw.length; i++) {
            ...
            if (typeof curr.id !== "string" || typeof curr.value !== "string") {
                throw newBadRequestError(recipeInstance, "All elements of formFields must contain an 'id' and 'value' field");
            }
...
function newBadRequestError(recipeInstance, message) {
...
function validateFormOrThrowError(recipeInstance, inputs, configFormFields) {
    return __awaiter(this, void 0, void 0, function* () {
