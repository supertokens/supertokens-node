...
async function validateFormFieldsOrThrowError(configFormFields, formFieldsRaw, tenantId, userContext) {
    ...
    formFields = formFields.map((field) => {
        if (field.id === constants_1.FORM_FIELD_EMAIL_ID) {
            return Object.assign(Object.assign({}, field), { value: typeof field.value === "string" ? field.value.trim() : field.value });
        }
        return field;
    });
...
async function validateFormOrThrowError(inputs, configFormFields, tenantId, userContext) {
    ...
    for (const formField of configFormFields) {
        ...
        const hasNonEmptyStringValue = typeof (input === null || input === void 0 ? void 0 : input.value) === "string" && input.value.length > 0;
        const hasNonNullishNonStringValue = typeof (input === null || input === void 0 ? void 0 : input.value) !== "string" && (input === null || input === void 0 ? void 0 : input.value) !== null && (input === null || input === void 0 ? void 0 : input.value) !== undefined;
