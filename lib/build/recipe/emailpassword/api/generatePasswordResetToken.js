...
function generatePasswordResetToken(recipeInstance, req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // step 1
        let formFields = yield utils_2.validateFormFieldsOrThrowError(recipeInstance, recipeInstance.config.resetPasswordUsingTokenFeature.formFieldsForGenerateTokenForm, req.body.formFields);
        ...
        // step 4
        let passwordResetLink = (yield recipeInstance.config.resetPasswordUsingTokenFeature.getResetPasswordURL(user)) +
            "?token=" +
            token +
            "&rid=" +
