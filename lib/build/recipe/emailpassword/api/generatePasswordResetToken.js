...
function generatePasswordResetToken(apiImplementation, recipeInstance, req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result = yield apiImplementation.generatePasswordResetTokenPOST(formFields, {
            recipeImplementation: recipeInstance.recipeInterfaceImpl,
            req,
            res,
            next,
        });
        utils_1.send200Response(res, result);
    });
}
