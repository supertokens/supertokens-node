...
async function generatePasswordResetToken(apiImplementation, tenantId, options, userContext) {
    ...
    // step 1
    let formFields = await utils_2.validateFormFieldsOrThrowError(options.config.resetPasswordUsingTokenFeature.formFieldsForGenerateTokenForm, requestBody.formFields, tenantId, userContext);
