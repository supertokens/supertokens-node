...
function signUpAPI(recipeInstance, req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // step 1
        let formFields = yield utils_2.validateFormFieldsOrThrowError(recipeInstance, recipeInstance.config.signUpFeature.formFields, req.body.formFields);
        ...
        // set 3
        yield recipeInstance.config.signUpFeature.handleCustomFormFields(user, formFields.filter((field) => field.id !== constants_1.FORM_FIELD_EMAIL_ID && field.id !== constants_1.FORM_FIELD_PASSWORD_ID));
        // step 4
