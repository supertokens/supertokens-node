...
function signInAPI(recipeInstance, req, res, _) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let user = yield recipeInstance.recipeInterfaceImpl.signIn(email, password);
        // set 4
        yield recipeInstance.config.signInFeature.handlePostSignIn(user);
