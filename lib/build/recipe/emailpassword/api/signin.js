...
function signInAPI(apiImplementation, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        logger_1.infoLoggerWithCode[logger_1.loggerCodes.API_CALLED]("SignInAPI");
        ...
        if (result.status === "OK") {
            logger_1.debugLoggerWithCode[logger_1.loggerCodes.API_RESPONSE]("SignInAPI", result.status);
