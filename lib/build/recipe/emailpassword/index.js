...
exports.sendEmail = exports.getPasswordResetTokenInfo = exports.linkEmailPasswordAccountsWithUserFromSession = exports.updateEmailOrPassword = exports.consumePasswordResetToken = exports.createResetPasswordToken = exports.signIn = exports.signUp = exports.Error = exports.init = void 0;
const recipe_1 = __importDefault(require("./recipe"));
const error_1 = __importDefault(require("./error"));
const accountlinking_1 = require("../accountlinking");
const recipeUserId_1 = __importDefault(require("../../recipeUserId"));
class Wrapper {
    static signUp(email, password, attemptAccountLinking = true, userContext) {
    ...
    static signIn(email, password, attemptAccountLinking = true, userContext) {
