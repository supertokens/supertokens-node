...
class Wrapper {
    ...
    static async sendEmail(input) {
        ...
        return await recipeInstance.emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign(Object.assign({}, input), { tenantId: input.tenantId === undefined ? constants_1.DEFAULT_TENANT_ID : input.tenantId, userContext: (0, utils_2.getUserContext)(input.userContext) }));
    }
}
