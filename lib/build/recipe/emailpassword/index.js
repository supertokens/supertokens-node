...
class Wrapper {
    static signUp(email, password, doAutomaticAccountLinking = false, userContext) {
    ...
    static sendEmail(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield recipeInstance.emailDelivery.ingredientInterfaceImpl.sendEmail(Object.assign({ userContext: {} }, input));
        });
    }
}
