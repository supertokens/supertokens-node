...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.handleAPIRequest = (id, tenantId, req, res, _path, _method, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.SIGN_UP_API) {
                    return yield signup_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.SIGN_IN_API) {
                    return yield signin_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.GENERATE_PASSWORD_RESET_TOKEN_API) {
                    return yield generatePasswordResetToken_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.PASSWORD_RESET_API) {
                    return yield passwordReset_1.default(this.apiImpl, tenantId, options, userContext);
        ...
        this.handleError = (err, _request, response) =>
            __awaiter(this, void 0, void 0, function* () {
