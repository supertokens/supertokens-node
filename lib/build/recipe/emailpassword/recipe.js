        ...
        this.handleAPIRequest = (
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.SIGN_UP_API) {
                    return yield signup_1.default(this.apiImpl, options, userContext);
                    ...
                    return yield generatePasswordResetToken_1.default(this.apiImpl, options, userContext);
                } else if (id === constants_1.PASSWORD_RESET_API) {
                    return yield passwordReset_1.default(this.apiImpl, options, userContext);
                } else if (id === constants_1.SIGNUP_EMAIL_EXISTS_API) {
                    return yield emailExists_1.default(this.apiImpl, options, userContext);
                }
                return false;
            });
