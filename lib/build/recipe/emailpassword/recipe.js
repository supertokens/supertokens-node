    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(constants_1.GENERATE_PASSWORD_RESET_TOKEN_API),
                ...
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(constants_1.LINK_ACCOUNT_TO_EXISTING_ACCOUNT_API),
                    id: constants_1.LINK_ACCOUNT_TO_EXISTING_ACCOUNT_API,
                    disabled: this.apiImpl.linkAccountToExistingAccountPOST === undefined,
                },
            ];
        };
        this.handleAPIRequest = (id, req, res, _path, _method) => __awaiter(this, void 0, void 0, function* () {
            let options = {
                config: this.config,
        ...
        this.handleError = (err, _request, response) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getEmailForUserId = (userId, userContext) => __awaiter(this, void 0, void 0, function* () {
            let user = yield this.recipeInterfaceImpl.getUserById({ userId, userContext });
            if (user !== undefined) {
                let recipeLevelUser = user.loginMethods.find((u) => u.recipeId === "emailpassword" && u.recipeUserId === userId);
