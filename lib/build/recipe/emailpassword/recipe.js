    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes) {
        ...
        this.verifyEmailUsingToken = (token) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                let userInThisRecipe = yield this.recipeInterfaceImpl.getUserById({ userId: user.id });
        ...
        this.signIn = (email, password) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.signIn({ email, password });
                if (response.status === "OK") {
                    return response.user;
                } else {
        ...
        this.createResetPasswordToken = (userId) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.createResetPasswordToken({ userId });
                if (response.status === "OK") {
        ...
        this.resetPasswordUsingToken = (token, newPassword) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.resetPasswordUsingToken({ token, newPassword });
        ...
        this.updateEmailOrPassword = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                let response = yield this.recipeInterfaceImpl.updateEmailOrPassword(input);
                if (response.status === "OK") {
                    return;
                }
