    ...
    constructor(recipeId, appInfo, config) {
        ...
        this.getAPIsHandled = () => {
            return [
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(this.getRecipeId(), constants_1.SIGN_UP_API),
                    id: constants_1.SIGN_UP_API,
                    disabled: this.config.signUpFeature.disableDefaultImplementation,
                },
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(this.getRecipeId(), constants_1.SIGN_IN_API),
                    id: constants_1.SIGN_IN_API,
                    disabled: this.config.signInFeature.disableDefaultImplementation,
                },
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(this.getRecipeId(), constants_1.GENERATE_PASSWORD_RESET_TOKEN_API),
                ...
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(this.getRecipeId(), constants_1.PASSWORD_RESET_API),
        ...
        this.handleError = (err, request, response, next) => {
            if (err.type === error_1.default.EMAIL_ALREADY_EXISTS_ERROR) {
                ...
                return this.handleError(new error_1.default({
                ...
                }, this.getRecipeId()), request, response, next);
            }
            else if (err.type === error_1.default.WRONG_CREDENTIAL_ERROR) {
        ...
        this.createResetPasswordToken = (userId) => __awaiter(this, void 0, void 0, function* () {
            return coreAPICalls_1.createResetPasswordToken(this, userId);
        });
        this.resetPasswordUsingToken = (token, newPassword) => __awaiter(this, void 0, void 0, function* () {
    ...
    static init(config) {
        return (appInfo) => {
            if (Recipe.instance === undefined) {
                ...
                throw new error_1.default({
                    type: error_1.default.GENERAL_ERROR,
                    payload: new Error("Emailpassword recipe has already been initialised. Please check your code for bugs."),
                }, Recipe.RECIPE_ID);
            }
        };
    }
