...
const linkAccountWithUserFromSession_1 = __importDefault(require("./api/linkAccountWithUserFromSession"));
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config, ingredients) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                },
                {
                    method: "post",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(
                        constants_1.LINK_ACCOUNT_TO_EXISTING_ACCOUNT_API
                    ),
        ...
        this.handleAPIRequest = (id, req, res, _path, _method) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                } else if (id === constants_1.LINK_ACCOUNT_TO_EXISTING_ACCOUNT_API) {
                    return yield linkAccountWithUserFromSession_1.default(this.apiImpl, options);
                }
                return false;
            });
