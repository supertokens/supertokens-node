...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, next, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                if (id === constants_1.SIGN_UP_API) {
                    return yield signup_1.default(this.apiImpl, this, req, res, next);
                } else if (id === constants_1.SIGN_IN_API) {
                    return yield signin_1.default(this.apiImpl, this, req, res, next);
                } else if (id === constants_1.GENERATE_PASSWORD_RESET_TOKEN_API) {
                    return yield generatePasswordResetToken_1.default(this.apiImpl, this, req, res, next);
                } else if (id === constants_1.SIGN_OUT_API) {
                    return yield signout_1.default(this.apiImpl, this, req, res, next);
                } else if (id === constants_1.PASSWORD_RESET_API) {
                    return yield passwordReset_1.default(this.apiImpl, this, req, res, next);
                } else if (id === constants_1.SIGNUP_EMAIL_EXISTS_API) {
                    return yield emailExists_1.default(this.apiImpl, this, req, res, next);
                } else {
        ...
        this.recipeInterfaceImpl = this.config.override.functions(
            new recipeImplementation_1.default(querier_1.Querier.getInstanceOrThrowError(isInServerlessEnv, recipeId))
        );
        this.apiImpl = this.config.override.apis(new implementation_1.default(this));
    }
