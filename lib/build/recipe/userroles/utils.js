...
function validateAndNormaliseUserInput(_, __, config) {
    ...
    return {
        skipAddingRolesToAccessToken: (config === null || config === void 0 ? void 0 : config.skipAddingRolesToAccessToken) === true,
        skipAddingPermissionsToAccessToken: (config === null || config === void 0 ? void 0 : config.skipAddingPermissionsToAccessToken) === true,
        override,
    };
}
