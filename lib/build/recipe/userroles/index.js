...
class Wrapper {
    ...
    static getUsersForRole(role, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsersForRole({
                role,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
...
exports.getUsersForRole = Wrapper.getUsersForRole;
