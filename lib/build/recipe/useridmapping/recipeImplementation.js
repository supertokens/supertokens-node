...
function getRecipeInterface(querier) {
    return {
        ...
        getUserIdMapping: function ({ userId, userIdType, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        deleteUserIdMapping: function ({ userId, userIdType }) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        updateOrDeleteUserIdMappingInfo: function ({ userId, userIdType, externalUserIdInfo }) {
            return __awaiter(this, void 0, void 0, function* () {
