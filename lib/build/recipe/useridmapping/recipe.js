...
exports.isUserIdMappingRecipeInitialized = isUserIdMappingRecipeInitialized;
class Recipe extends recipeModule_1.default {
    ...
    static init(config) {
        return (appInfo, isInServerlessEnv) => {
            if (Recipe.instance === undefined) {
                exports.isUserIdMappingRecipeInitialized = isUserIdMappingRecipeInitialized = true;
                Recipe.instance = new Recipe(Recipe.RECIPE_ID, appInfo, isInServerlessEnv, config);
                return Recipe.instance;
            } else {
                throw new Error("UserIdMapping recipe has already been initialised. Please check your code for bugs.");
            }
        };
    }
    static reset() {
...
Recipe.RECIPE_ID = "useridmapping";
Recipe.instance = undefined;
