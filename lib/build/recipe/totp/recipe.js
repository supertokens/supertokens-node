    ...
    constructor(stInstance, recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = async (id, _tenantId, req, res, _, __, userContext) => {
            ...
            if (id === constants_1.CREATE_TOTP_DEVICE) {
                return await (0, createDevice_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            else if (id === constants_1.LIST_TOTP_DEVICES) {
                return await (0, listDevices_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            else if (id === constants_1.REMOVE_TOTP_DEVICE) {
                return await (0, removeDevice_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            else if (id === constants_1.VERIFY_TOTP_DEVICE) {
                return await (0, verifyDevice_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
            else if (id === constants_1.VERIFY_TOTP) {
                return await (0, verifyTOTP_1.default)(this.stInstance, this.apiImpl, options, userContext);
            }
        ...
        {
            let builder = new supertokens_js_override_1.default((0, recipeImplementation_1.default)(this.stInstance, this.querier, this.config));
