...
const services_1 = require("./emaildelivery/services");
function validateAndNormaliseUserInput(recipeInstance, appInfo, config) {
    ...
    if (emailService === undefined) {
        emailService = new services_1.BackwardCompatibilityService(
            recipeInstance,
            appInfo,
    ...
    let emailDelivery = Object.assign(
        Object.assign({}, config === null || config === void 0 ? void 0 : config.emailDelivery),
        {
            /**
             * if we do
             * let emailDelivery = {
