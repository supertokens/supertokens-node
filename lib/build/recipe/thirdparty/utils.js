...
exports.isFakeEmail = exports.validateAndNormaliseUserInput = void 0;
function validateAndNormaliseUserInput(appInfo, config) {
    let signInAndUpFeature = validateAndNormaliseSignInAndUpConfig(appInfo, config === null || config === void 0 ? void 0 : config.signInAndUpFeature);
