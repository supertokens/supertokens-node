...
function defaultHandlePostSignUpIn(user, thirdPartyAuthCodeResponse, newUser) {
...
function defaultSetSessionDataForSession(user, thirdPartyAuthCodeResponse, action) {
    return __awaiter(this, void 0, void 0, function* () {
        return {};
    });
}
function defaultSetJwtPayloadForSession(user, thirdPartyAuthCodeResponse, action) {
    return __awaiter(this, void 0, void 0, function* () {
        return {};
    });
}
