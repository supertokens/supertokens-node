...
function mockCreateNewOrUpdateEmailOfRecipeUser(thirdPartyId, thirdPartyUserId, email, tenantId, querier) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield querier.sendPostRequest(new normalisedURLPath_1.default(`${tenantId}/recipe/signinup`), {
            thirdPartyId,
            thirdPartyUserId,
            email: { id: email },
        });
