...
class Wrapper {
    static getProvider(tenantId, thirdPartyId, clientType, userContext = {}) {
    ...
    static manuallyCreateOrUpdateUser(tenantId, thirdPartyId, thirdPartyUserId, email, isVerified, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
