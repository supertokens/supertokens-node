...
class Wrapper {
    static getProvider(thirdPartyId, clientType, tenantId, userContext = {}) {
    ...
    static manuallyCreateOrUpdateUser(thirdPartyId, thirdPartyUserId, email, tenantId, userContext = {}) {
        return __awaiter(this, void 0, void 0, function* () {
