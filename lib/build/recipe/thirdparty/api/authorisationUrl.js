...
function authorisationUrlAPI(apiImplementation, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let provider = utils_2.findRightProvider(options.providers, thirdPartyId, undefined);
        ...
        let result = yield apiImplementation.authorisationUrlGET({ provider, options });
