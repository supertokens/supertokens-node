...
function signInUpAPI(apiImplementation, recipeInstance, req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result = yield apiImplementation.signInUpPOST(provider, code, redirectURI, {
            recipeImplementation: recipeInstance.recipeInterfaceImpl,
            req,
            res,
            next,
        });
        return utils_1.send200Response(res, result);
    });
}
