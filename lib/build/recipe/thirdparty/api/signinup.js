...
async function signInUpAPI(stInstance, apiImplementation, tenantId, options, userContext) {
    ...
    const shouldTryLinkingWithSessionUser = (0, utils_1.getNormalisedShouldTryLinkingWithSessionUserFlag)(options.req, bodyParams);
    ...
    if (result.status === "OK") {
        (0, utils_1.send200Response)(options.res, Object.assign({ status: result.status }, (0, utils_1.getBackwardsCompatibleUserInfo)(options.req, result, userContext)));
    }
    else {
