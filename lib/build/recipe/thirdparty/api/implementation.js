    ...
    return {
        authorisationUrlGET: function ({ provider, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                let providerInfo = yield provider.get(undefined, undefined, userContext);
                let params = {};
        ...
        signInUpPOST: function ({ provider, code, redirectURI, authCodeResponse, options, userContext }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let providerInfo = yield provider.get(redirectURI, code, userContext);
                if (authCodeResponse !== undefined) {
                    ...
                    const atResp = yield cross_fetch_1.default(providerInfo.accessTokenAPI.url, {
                        method: "post",
                    ...
                    accessTokenAPIResponse = yield atResp.json();
                }
                userInfo = yield providerInfo.getProfileInfo(accessTokenAPIResponse, userContext);
