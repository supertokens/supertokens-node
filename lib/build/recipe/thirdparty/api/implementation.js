...
exports.DEV_KEY_IDENTIFIER = "4398792-";
function isUsingDevelopmentClientId(client_id) {
    return client_id.startsWith(exports.DEV_KEY_IDENTIFIER) || DEV_OAUTH_CLIENT_IDS.includes(client_id);
}
function getActualClientIdFromDevelopmentClientId(client_id) {
    if (client_id.startsWith(exports.DEV_KEY_IDENTIFIER)) {
        return client_id.split(exports.DEV_KEY_IDENTIFIER)[1];
    }
    return client_id;
}
