    ...
    constructor() {
        this.authorisationUrlGET = ({ provider, options }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (utils_1.isUsingOAuthDevelopmentKeys(providerInfo.getClientId())) {
                ...
                if (utils_1.isUsingOAuthDevelopmentKeys(providerInfo.getClientId())) {
                    url = `${constants_1.DEV_OAUTH_AUTHORIZATION_URL}?${paramsString}`;
                }
                return {
                    status: "OK",
                    url,
        ...
        this.signInUpPOST = ({ provider, code, redirectURI, options }) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                let accessTokenAPIResponse;
                {
                    let providerInfo = yield provider.get(undefined, undefined);
                    if (utils_1.isUsingOAuthDevelopmentKeys(providerInfo.getClientId())) {
                        redirectURI = constants_1.DEV_OAUTH_REDIRECT_URL;
                    }
                }
