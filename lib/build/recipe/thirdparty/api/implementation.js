    ...
    return {
        ...
        signInUpPOST: async function (input) {
            ...
            if (preAuthChecks.status !== "OK") {
                logger_1.logDebugMessage("signInUpPOST: erroring out because preAuthChecks returned " + preAuthChecks.status);
            ...
            if (postAuthChecks.status !== "OK") {
                logger_1.logDebugMessage("signInUpPOST: erroring out because postAuthChecks returned " + postAuthChecks.status);
        ...
        appleRedirectHandlerPOST: async function ({ formPostInfoFromProvider, options }) {
            ...
            const state = utils_1.decodeBase64(stateInBase64);
