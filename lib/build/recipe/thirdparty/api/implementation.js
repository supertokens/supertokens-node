...
function getAPIInterface() {
    return {
        authorisationUrlGET: function ({ provider, options }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (
                    ...
                    !isUsingDevelopmentClientId(providerInfo.getClientId())
                ) {
        ...
        signInUpPOST: function ({ provider, code, redirectURI, authCodeResponse, clientId, options }) {
            return __awaiter(this, void 0, void 0, function* () {
                let userInfo;
                ...
                let providerInfo = yield provider.get(redirectURI, code, clientId);
