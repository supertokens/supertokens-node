            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (existingUsers.length === 0) {
                    ...
                    if (!emailInfo.isVerified && recipe_2.default.getInstance() !== undefined) {
                        emailInfo.isVerified = yield emailverification_1.default.isEmailVerified(
                            recipeUserId,
                            emailInfo.id,
                            userContext
                        );
                ...
                if (session === undefined) {
                    session = yield session_1.default.createNewSession(
                        options.req,
                        options.res,
                        new recipeUserId_1.default(response.user.id),
                        {},
                        {},
                        userContext
                    );
                ...
                yield mfa_1.completeFactorInSession(session, "passwordless", userContext);
                return {
                    status: "OK",
