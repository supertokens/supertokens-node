...
function Twitter(input) {
    ...
    input.override = function (originalImplementation) {
        ...
        originalImplementation.exchangeAuthCodeForOAuthTokens = async function (input) {
            ...
            const basicAuthToken = Buffer.from(`${clientId}:${originalImplementation.config.clientSecret}`, "utf8").toString("base64");
            ...
            const tokenResponse = await utils_1.doPostRequest(originalImplementation.config.tokenEndpoint, twitterOauthTokenParams, {
