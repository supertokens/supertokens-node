...
function Twitter(input) {
    ...
    input.override = function (originalImplementation) {
        ...
        originalImplementation.exchangeAuthCodeForOAuthTokens = async function (input) {
            ...
            const basicAuthToken = utils_1.encodeBase64(`${clientId}:${originalImplementation.config.clientSecret}`);
            ...
            const tokenResponse = await thirdpartyUtils_1.doPostRequest(originalImplementation.config.tokenEndpoint, twitterOauthTokenParams, {
