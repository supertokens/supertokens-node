...
function GW(config) {
    ...
    function get(redirectURI, authCodeFromRequest) {
        ...
        let authorizationRedirectParams = Object.assign({ scope: scopes.join(" "), access_type: "offline", include_granted_scopes: "true", response_type: "code", client_id: config.clientId, hd: domain }, additionalParams);
        function getProfileInfo(authCodeResponse) {
            return __awaiter(this, void 0, void 0, function* () {
                let payload = yield utils_1.verifyIdTokenFromJWKSEndpoint(authCodeResponse.id_token, "https://www.googleapis.com/oauth2/v3/certs", {
