    ...
    function get(redirectURI, authCodeFromRequest) {
        ...
        function getProfileInfo(accessTokenAPIResponse) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let response = yield cross_fetch_1.default("https://api.github.com/user", {
                    method: "get",
                    headers: {
                ...
                let emailsInfoResponse = yield cross_fetch_1.default("https://api.github.com/user/emails", {
                    headers: {
                        Authorization: authHeader,
                        Accept: "application/vnd.github.v3+json",
                    },
                ...
                let emailsInfo = yield emailsInfoResponse.json();
