    ...
    input.override = function (originalImplementation) {
        ...
        originalImplementation.getUserInfo = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const rawResponse = {};
                const emailInfoResp = yield utils_1.doFetch("https://api.github.com/user/emails", { headers });
                ...
                const userInfoResp = yield utils_1.doFetch("https://api.github.com/user", { headers });
