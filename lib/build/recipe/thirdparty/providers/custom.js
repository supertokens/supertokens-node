...
exports.getActualClientIdFromDevelopmentClientId =
    exports.isUsingDevelopmentClientId =
    exports.DEV_OAUTH_REDIRECT_URL =
        void 0;
    ...
    let impl = {
        ...
        getUserInfo: async function ({ oAuthTokens, userContext }) {
            ...
            if (idToken && impl.config.jwksURI !== undefined) {
                ...
                rawUserInfoFromProvider.fromIdTokenPayload = await utils_1.verifyIdTokenFromJWKSEndpointAndGetPayload(
                    idToken,
                    jwks,
                    {
