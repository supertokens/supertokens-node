...
async function fetchAndSetConfig(tenantId, provider, clientType, userContext) {
...
function createProvider(input) {
    ...
    if (thirdPartyId.startsWith("active-directory")) {
        ...
        return (0, _1.SAML)(clonedInput);
    }
    return (0, custom_1.default)(clonedInput);
}
async function findAndCreateProviderInstance(tenantId, providers, thirdPartyId, clientType, userContext) {
...
function mergeConfig(staticConfig, coreConfig) {
    var _a, _b, _c, _d;
    const result = Object.assign(Object.assign(Object.assign({}, staticConfig), coreConfig), { userInfoMap: {
            fromIdTokenPayload: Object.assign(Object.assign({}, (_a = staticConfig.userInfoMap) === null || _a === void 0 ? void 0 : _a.fromIdTokenPayload), (_b = coreConfig.userInfoMap) === null || _b === void 0 ? void 0 : _b.fromIdTokenPayload),
            fromUserInfoAPI: Object.assign(Object.assign({}, (_c = staticConfig.userInfoMap) === null || _c === void 0 ? void 0 : _c.fromUserInfoAPI), (_d = coreConfig.userInfoMap) === null || _d === void 0 ? void 0 : _d.fromUserInfoAPI),
        } });
...
function mergeProvidersFromCoreAndStatic(providerConfigsFromCore, providerInputsFromStatic, includeAllProviders) {
    ...
    if (providerConfigsFromCore.length === 0) {
        for (const config of providerInputsFromStatic.filter((config) => config.includeInNonPublicTenantsByDefault === true || includeAllProviders === true)) {
