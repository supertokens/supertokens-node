...
exports.normaliseOIDCEndpointToIncludeWellKnown =
    exports.discoverOIDCEndpoints =
    exports.verifyIdTokenFromJWKSEndpointAndGetPayload =
    exports.doPostRequest =
    exports.doGetRequest =
        void 0;
...
async function getOIDCDiscoveryInfo(issuer) {
    ...
    const normalizedPath = new normalisedURLPath_1.default(issuer);
