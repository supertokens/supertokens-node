...
function Bitbucket(input) {
    ...
    input.override = function (originalImplementation) {
        ...
        originalImplementation.getUserInfo = async function (input) {
            ...
            const userInfoFromAccessToken = await utils_1.doGetRequest("https://api.bitbucket.org/2.0/user", undefined, headers);
            ...
            const userInfoFromEmail = await utils_1.doGetRequest("https://api.bitbucket.org/2.0/user/emails", undefined, headers);
