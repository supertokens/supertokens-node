...
const getUsersByEmailAPI_1 = require("./api/getUsersByEmailAPI");
    ...
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes) {
        ...
        this.getAPIsHandled = () => {
            return [
                ...
                {
                    method: "get",
                    pathWithoutApiBasePath: new normalisedURLPath_1.default(constants_1.GET_USERS_BY_EMAIL_API),
                    id: constants_1.GET_USERS_BY_EMAIL_API,
        ...
        this.handleAPIRequest = (id, req, res, next, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                } else if (id === constants_1.GET_USERS_BY_EMAIL_API) {
                    return getUsersByEmailAPI_1.getUsersByEmailAPI(this.apiImpl, options);
                } else {
