        ...
        this.handleAPIRequest = (id, tenantId, req, res, _path, _method, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.SIGN_IN_UP_API) {
                    return yield signinup_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.AUTHORISATION_API) {
                    return yield authorisationUrl_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.APPLE_REDIRECT_HANDLER) {
                    return yield appleRedirect_1.default(this.apiImpl, options, userContext);
                }
                return false;
            });
