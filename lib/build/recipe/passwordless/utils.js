...
exports.getEnabledPwlessFactors = exports.defaultValidateEmail = exports.defaultValidatePhoneNumber = exports.validateAndNormaliseUserInput = void 0;
...
function getEnabledPwlessFactors(config) {
    ...
    if (config.flowType === "MAGIC_LINK") {
        ...
        if (config.contactMethod === "EMAIL") {
            ...
            allFactors = [multifactorauth_1.FactorIds.OTP_EMAIL, multifactorauth_1.FactorIds.OTP_PHONE, multifactorauth_1.FactorIds.LINK_EMAIL, multifactorauth_1.FactorIds.LINK_PHONE];
        }
    }
    return allFactors;
}
