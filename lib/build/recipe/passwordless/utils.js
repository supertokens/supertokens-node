...
function validateAndNormaliseUserInput(_, appInfo, config) {
            ...
            sendEmail: (input, userContext) =>
                __awaiter(this, void 0, void 0, function* () {
                    if (config.contactMethod === "EMAIL" || config.contactMethod === "EMAIL_OR_PHONE") {
                        ...
                        yield createAndSendCustomEmail(
                            {
    ...
    let emailDelivery = Object.assign(
        ...
        (_a = config.emailDelivery) === null || _a === void 0 ? void 0 : _a.override
    );
    let smsDelivery =
        config === undefined || config.smsDelivery === undefined
            ...
            : Object.assign(
                  {
                      service: (_b = config.smsDelivery) === null || _b === void 0 ? void 0 : _b.service,
                      override: (originalImplementation) => originalImplementation,
                  },
                  (_c = config.smsDelivery) === null || _c === void 0 ? void 0 : _c.override
              );
