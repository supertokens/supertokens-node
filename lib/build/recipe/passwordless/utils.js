...
exports.defaultValidateEmail = exports.defaultValidatePhoneNumber = exports.validateAndNormaliseUserInput = void 0;
...
function validateAndNormaliseUserInput(_, appInfo, config) {
    ...
    function getSmsDeliveryConfig() {
        ...
        let createAndSendCustomTextMessage = config.contactMethod === "EMAIL" ? undefined : config.createAndSendCustomTextMessage;
        /**
         * following code is for backward compatibility.
         * if user has not passed emailDelivery config, we
        ...
        if (smsService === undefined) {
            smsService = new backwardCompatibility_2.default(appInfo, createAndSendCustomTextMessage);
        }
