...
function getRecipeInterface(querier) {
    ...
    return {
        ...
        updateUser: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (input.phoneNumber !== undefined && typeof input.phoneNumber === "string") {
                    let userForUserId = yield __1.getUser(input.userId);
                    if (userForUserId !== undefined && userForUserId.isPrimaryUser) {
                        let usersForPhoneNumbers = yield __1.listUsersByAccountInfo({
        ...
        getEmailOrPhoneNumberForCode: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let response = yield querier.sendPutRequest(
                    new normalisedURLPath_1.default("/recipe/email-or-phonenumber"),
                    copyAndRemoveUserContext(input)
                );
                if (response.status === "OK") {
                    return {
