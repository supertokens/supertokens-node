...
function getRecipeInterface(querier) {
    ...
    return {
        consumeCode: async function (input) {
            ...
            const linkResult = await recipe_1.default.getInstance().createPrimaryUserIdOrLinkByAccountInfo({
        ...
        createRecipeUser: async function (input) {
            const response = await this.verifyAndDeleteCode(
                Object.assign(Object.assign({}, input), { createRecipeUserIfNotExists: true })
            );
            if (response.status !== "OK") {
                return response;
            }
        ...
        verifyAndDeleteCode: async function (input) {
            ...
            logger_1.logDebugMessage("Passwordless.verifyAndDeleteCode code consumed OK");
