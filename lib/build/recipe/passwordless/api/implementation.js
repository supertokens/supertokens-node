    ...
    return {
        consumeCodePOST: async function (input) {
            ...
            return {
                ...
                createdNewRecipeUser: (_d = response.createdNewRecipeUser) !== null && _d !== void 0 ? _d : false,
        ...
        createCodePOST: async function (input) {
            ...
            const userWithMatchingLoginMethod = await getUserByAccountInfo(
...
async function getUserByAccountInfo(input) {
    ...
    logger_1.logDebugMessage(`getUserByAccountInfo ${usersWithMatchingLoginMethods.length} has matching login methods`);
