                ...
                try {
                    ...
                    if (mfaInstance === undefined) {
                        if (session === undefined) {
                            ...
                            // active session
                            let overwriteSessionDuringSignIn = recipe_3.default.getInstanceOrThrowError().config
...
const linkAccountsForFactorSetup = async (mfaInstance, sessionUser, recipeUserId, userContext) => {
