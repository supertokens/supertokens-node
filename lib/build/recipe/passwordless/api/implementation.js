...
function getAPIImplementation() {
    return {
        consumeCodePOST: async function (input) {
            ...
            if (mfaInstance) {
                isAlreadySetup = !sessionUser ? false : utils_1.isFactorSetupForUser(sessionUser, factorId);
            ...
            if (mfaInstance === undefined) {
                ...
                if (
                    session === undefined ||
                    recipe_3.default.getInstanceOrThrowError().config.overwriteSessionDuringSignIn
                ) {
