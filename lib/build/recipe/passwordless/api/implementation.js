    ...
    return {
        consumeCodePOST: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let response = yield input.options.recipeImplementation.consumeCode("deviceId" in input
                    ? {
                ...
                const session = yield session_1.default.createNewSession(input.options.res, user.id, {}, {}, input.userContext);
                return {
                    status: "OK",
        ...
        createCodePOST: function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let response = yield input.options.recipeImplementation.createCode("email" in input
                    ? {
                        userContext: input.userContext,
                        email: input.email,
                ...
                if (flowType === "MAGIC_LINK" || flowType === "USER_INPUT_CODE_AND_MAGIC_LINK") {
                    magicLink =
                        (yield input.options.config.getLinkDomainAndPath("phoneNumber" in input
                            ? {
                                phoneNumber: input.phoneNumber,
                            }
                            : {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    ...
                    if (response.status === "OK") {
                        ...
                        if (flowType === "MAGIC_LINK" || flowType === "USER_INPUT_CODE_AND_MAGIC_LINK") {
                            magicLink =
                                (yield input.options.config.getLinkDomainAndPath(deviceInfo.email === undefined
                                    ? {
