...
function createCode(apiImplementation, tenantId, options, userContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (
            ...
            email = email.trim();
            const validateError = yield options.config.validateEmailAddress(email, tenantId);
        ...
        if (
            ...
            const validateError = yield options.config.validatePhoneNumber(phoneNumber, tenantId);
            if (validateError !== undefined) {
                utils_1.send200Response(options.res, {
                    status: "GENERAL_ERROR",
                    message: validateError,
