...
async function consumeCode(apiImplementation, tenantId, options, userContext) {
    ...
    const shouldTryLinkingWithSessionUser = utils_1.getNormalisedShouldTryLinkingWithSessionUserFlag(options.req, body);
    ...
    if (result.status === "OK") {
        result = Object.assign(Object.assign({}, result), utils_1.getBackwardsCompatibleUserInfo(options.req, result, userContext));
