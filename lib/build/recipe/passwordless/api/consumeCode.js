...
async function consumeCode(stInstance, apiImplementation, tenantId, options, userContext) {
    ...
    let result = await apiImplementation.consumeCodePOST(deviceId !== undefined
        ? {
            deviceId,
            userInputCode,
            preAuthSessionId,
    ...
    if (result.status === "OK") {
        result = Object.assign(Object.assign({}, result), (0, utils_1.getBackwardsCompatibleUserInfo)(options.req, result, userContext));
