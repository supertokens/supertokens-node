...
export default class Wrapper {
    ...
    ): Promise<import("./types").CreateCodeResponse>;
    static createNewCodeForDevice(input: {
        deviceId: string;
        userInputCode?: string;
        tenantId: string;
        userContext?: Record<string, any>;
    }): Promise<import("./types").CreateNewCodeForDeviceResponse>;
    /**
     * 1. verifies the code
    ...
    static updateUser(input: {
        ...
        userContext?: Record<string, any>;
    }): Promise<import("./types").UpdateUserResponse>;
    ...
    ): Promise<import("./types").RevokeAllCodesResponse>;
    static revokeCode(
        input:
            | {
                  codeId: string;
    ...
    ): Promise<import("./types").RevokeCodeResponse>;
