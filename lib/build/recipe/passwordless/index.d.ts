...
import { RecipeInterface, User, APIOptions, APIInterface, TypePasswordlessEmailDeliveryInput, TypePasswordlessSmsDeliveryInput } from "./types";
export default class Wrapper {
    ...
    static sendEmail(input: TypePasswordlessEmailDeliveryInput & {
        userContext?: any;
    }): Promise<void>;
