        ...
        this.handleAPIRequest = (id, tenantId, req, res, _, __, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.CONSUME_CODE_API) {
                    return yield consumeCode_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.CREATE_CODE_API) {
                    return yield createCode_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.DOES_EMAIL_EXIST_API) {
                    return yield emailExists_1.default(this.apiImpl, tenantId, options, userContext);
                } else if (id === constants_1.DOES_PHONE_NUMBER_EXIST_API) {
                    return yield phoneNumberExists_1.default(this.apiImpl, tenantId, options, userContext);
                } else {
                    return yield resendCode_1.default(this.apiImpl, tenantId, options, userContext);
                }
            });
            ...
            __awaiter(this, void 0, void 0, function* () {
                let userInputCode =
                    this.config.getCustomUserInputCode !== undefined
                        ? yield this.config.getCustomUserInputCode(input.tenantId, input.userContext)
                        : undefined;
