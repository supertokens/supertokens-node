...
const recipe_1 = require("../emaildelivery/recipe");
const emaildelivery_1 = require("./emaildelivery");
const smsDelivery_1 = require("./smsDelivery");
const recipe_2 = require("../smsdelivery/recipe");
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        {
            let override = (originalImplementation) => originalImplementation;
            ...
            let builder = new supertokens_js_override_1.default(
                emaildelivery_1.default(this.config.emailDelivery.service)
            );
            let emailDeliveryRecipeInterfaceImpl = builder.override(override).build();
            this.emailDelivery = new recipe_1.default(recipeId, appInfo, {
        ...
        }
        {
            ...
            let builder = new supertokens_js_override_1.default(smsDelivery_1.default(smsService));
            let smsDeliveryRecipeInterfaceImpl = builder.override(override).build();
            this.smsDelivery = new recipe_2.default(recipeId, appInfo, {
                service: smsService,
