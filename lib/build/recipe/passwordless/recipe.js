            ...
            if (Recipe.instance === undefined) {
                ...
                postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(() => {
                    ...
                    if (mfaInstance !== undefined) {
                        ...
                        mfaInstance.addGetFactorsSetupForUserFromOtherRecipes(async (user, tenantConfig) => {
                            if (tenantConfig.passwordless.enabled === false) {
                                return [];
                            }
                        ...
                        mfaInstance.addGetEmailsForFactorFromOtherRecipes((user) => {
                            let result = {};
                        ...
                        mfaInstance.addGetPhoneNumbersForFactorsFromOtherRecipes((user) => {
                            let result = {};
