        ...
        this.handleAPIRequest = (
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.CONSUME_CODE_API) {
                    return yield consumeCode_1.default(this.apiImpl, options, userContext);
                } else if (id === constants_1.CREATE_CODE_API) {
                    return yield createCode_1.default(this.apiImpl, options, userContext);
                    ...
                    return yield phoneNumberExists_1.default(this.apiImpl, options, userContext);
                } else {
                    return yield resendCode_1.default(this.apiImpl, options, userContext);
                }
            });
