...
function defaultCreateAndSendCustomSms(_) {
    return (input, _) => __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("Free daily SMS quota reached. If you want to use SuperTokens to send SMS, please sign up on supertokens.com to get your SMS API key, else you can also define your own method by overriding the service. For now, we are logging it below:");
        /**
