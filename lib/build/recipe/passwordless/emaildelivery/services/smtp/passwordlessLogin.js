...
function getPasswordlessLoginEmailHTML(appName, email, codeLifetime, urlWithLinkCode, userInputCode) {
    if (urlWithLinkCode !== undefined && userInputCode !== undefined) {
        return getPasswordlessLoginOTPAndURLLinkBody(appName, email, (0, utils_1.humaniseMilliseconds)(codeLifetime), urlWithLinkCode, userInputCode);
    }
    if (userInputCode !== undefined) {
        return getPasswordlessLoginOTPBody(appName, email, (0, utils_1.humaniseMilliseconds)(codeLifetime), userInputCode);
    }
    if (urlWithLinkCode !== undefined) {
        return getPasswordlessLoginURLLinkBody(appName, email, (0, utils_1.humaniseMilliseconds)(codeLifetime), urlWithLinkCode);
    }
