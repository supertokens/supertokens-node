...
function getPasswordlessLoginEmailContent(input, from) {
...
function getOTPBody(codeLifetime, userInputCode) {
    return `
        <tr>
...
function getPasswordlessLoginEmailHTML(appName, codeLifetime, urlWithLinkCode, userInputCode, email) {
    let mainBody = ``;
