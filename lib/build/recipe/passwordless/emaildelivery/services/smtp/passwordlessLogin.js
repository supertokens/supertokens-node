...
exports.getPasswordlessLoginEmailHTML = void 0;
const supertokens_1 = __importDefault(require("../../../../../supertokens"));
const utils_1 = require("../../../../../utils");
function getPasswordlessLoginEmailContent(input) {
    let supertokens = supertokens_1.default.getInstanceOrThrowError();
    let appName = supertokens.appInfo.appName;
    let body = getPasswordlessLoginEmailHTML(appName, input.email, input.codeLifetime, input.urlWithLinkCode, input.userInputCode);
    return {
        body,
        toEmail: input.email,
...
exports.default = getPasswordlessLoginEmailContent;
function getPasswordlessLoginOTPBody(appName, email, codeLifetime, userInputCode) {
    return `
        <!doctype html>
...
function getPasswordlessLoginURLLinkBody(appName, email, codeLifetime, urlWithLinkCode) {
    return `
        <!doctype html>
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
            xmlns:o="urn:schemas-microsoft-com:office:office">
...
function getPasswordlessLoginOTPAndURLLinkBody(appName, email, codeLifetime, urlWithLinkCode, userInputCode) {
    return `
        <!doctype html>
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
            xmlns:o="urn:schemas-microsoft-com:office:office">
...
function getPasswordlessLoginEmailHTML(appName, email, codeLifetime, urlWithLinkCode, userInputCode) {
    if (urlWithLinkCode !== undefined && userInputCode !== undefined) {
        return getPasswordlessLoginOTPAndURLLinkBody(appName, email, utils_1.humaniseMilliseconds(codeLifetime), urlWithLinkCode, userInputCode);
    }
    if (userInputCode !== undefined) {
        return getPasswordlessLoginOTPBody(appName, email, utils_1.humaniseMilliseconds(codeLifetime), userInputCode);
    }
    if (urlWithLinkCode !== undefined) {
        return getPasswordlessLoginURLLinkBody(appName, email, utils_1.humaniseMilliseconds(codeLifetime), urlWithLinkCode);
    }
    throw Error("this should never be thrown");
}
exports.getPasswordlessLoginEmailHTML = getPasswordlessLoginEmailHTML;
