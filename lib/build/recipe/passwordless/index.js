...
class Wrapper {
    ...
    static getUserById(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUserById(Object.assign({ userContext: {} }, input));
    }
    static getUserByEmail(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUserByEmail(Object.assign({ userContext: {} }, input));
    }
    ...
    static updateUser(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.updateUser(Object.assign({ userContext: {} }, input));
    }
