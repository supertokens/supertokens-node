...
exports.getEmailOrPhoneNumberForCode = exports.sendSms = exports.sendEmail = exports.signInUp = exports.createMagicLink = exports.revokeCode = exports.revokeAllCodes = exports.updateUser = exports.createNewCodeForDevice = exports.listCodesByPreAuthSessionId = exports.listCodesByPhoneNumber = exports.listCodesByEmail = exports.listCodesByDeviceId = exports.getUserByPhoneNumber = exports.getUserById = exports.getUserByEmail = exports.consumeCode = exports.createCode = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static consumeCode(input) {
        return recipe_1.default
            .getInstanceOrThrowError()
            .recipeInterfaceImpl.consumeCode(Object.assign({ userContext: {}, doAccountLinking: false }, input));
    }
    ...
    static getEmailOrPhoneNumberForCode(input) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default
                .getInstanceOrThrowError()
                .recipeInterfaceImpl.getEmailOrPhoneNumberForCode(Object.assign({ userContext: {} }, input));
        });
    }
}
...
exports.getEmailOrPhoneNumberForCode = Wrapper.getEmailOrPhoneNumberForCode;
