...
exports.sendSms = exports.sendEmail = exports.verifyCode = exports.signInUp = exports.createMagicLink = exports.revokeCode = exports.revokeAllCodes = exports.updateUser = exports.createNewCodeForDevice = exports.listCodesByPreAuthSessionId = exports.listCodesByPhoneNumber = exports.listCodesByEmail = exports.listCodesByDeviceId = exports.consumeCode = exports.createCode = exports.Error = exports.init = void 0;
...
class Wrapper {
    ...
    static verifyCode(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.verifyCode(
            Object.assign(Object.assign({}, input), {
                deleteCode: true,
                userContext: utils_1.getUserContext(input.userContext),
            })
