...
class HandshakeInfo {
    constructor(jwtSigningPublicKey, cookieDomain, cookieSecure, accessTokenPath, refreshTokenPath, enableAntiCsrf, accessTokenBlacklistingEnabled, jwtSigningPublicKeyExpiryTime, cookieSameSite, idRefreshTokenPath, sessionExpiredStatusCode) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (HandshakeInfo.instance == undefined) {
                ...
                if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0") {
                    HandshakeInfo.instance = new HandshakeInfo(response.jwtSigningPublicKey, response.cookieDomain, response.cookieSecure, response.accessTokenPath, response.refreshTokenPath, response.enableAntiCsrf, response.accessTokenBlacklistingEnabled, response.jwtSigningPublicKeyExpiryTime, "none", response.accessTokenPath, 440);
                }
                else {
                    HandshakeInfo.instance = new HandshakeInfo(response.jwtSigningPublicKey, response.cookieDomain, response.cookieSecure, response.accessTokenPath, response.refreshTokenPath, response.enableAntiCsrf, response.accessTokenBlacklistingEnabled, response.jwtSigningPublicKeyExpiryTime, response.cookieSameSite, response.idRefreshTokenPath, response.sessionExpiredStatusCode);
                }
            }
