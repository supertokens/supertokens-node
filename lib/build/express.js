...
function createNewSession(res, userId, jwtPayload = {}, sessionData = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        cookieAndHeaders_1.attachAccessTokenToCookie(res, accessToken.token, accessToken.expiry, accessToken.domain, accessToken.cookiePath, accessToken.cookieSecure, accessToken.sameSite);
        cookieAndHeaders_1.attachRefreshTokenToCookie(res, refreshToken.token, refreshToken.expiry, refreshToken.domain, refreshToken.cookiePath, refreshToken.cookieSecure, refreshToken.sameSite);
        cookieAndHeaders_1.setIdRefreshTokenInHeaderAndCookie(res, idRefreshToken.token, idRefreshToken.expiry, idRefreshToken.domain, idRefreshToken.cookieSecure, idRefreshToken.cookiePath, idRefreshToken.sameSite);
        if (response.antiCsrfToken !== undefined) {
            cookieAndHeaders_1.setAntiCsrfTokenInHeaders(res, response.antiCsrfToken);
        }
        return new Session(accessToken.token, response.session.handle, response.session.userId, response.session.userDataInJWT, res);
    });
}
...
function getSession(req, res, doAntiCsrfCheck) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let response = yield SessionFunctions.getSession(accessToken, antiCsrfToken, doAntiCsrfCheck, idRefreshToken);
            if (response.accessToken !== undefined) {
                cookieAndHeaders_1.attachAccessTokenToCookie(res, response.accessToken.token, response.accessToken.expiry, response.accessToken.domain, response.accessToken.cookiePath, response.accessToken.cookieSecure, response.accessToken.sameSite);
                accessToken = response.accessToken.token;
            }
            return new Session(accessToken, response.session.handle, response.session.userId, response.session.userDataInJWT, res);
        }
        catch (err) {
            if (error_1.AuthError.isErrorFromAuth(err) && err.errType === error_1.AuthError.UNAUTHORISED) {
                ...
                cookieAndHeaders_1.clearSessionFromCookie(res, handShakeInfo.cookieDomain, handShakeInfo.cookieSecure, handShakeInfo.accessTokenPath, handShakeInfo.refreshTokenPath, handShakeInfo.idRefreshTokenPath, handShakeInfo.cookieSameSite);
            }
            throw err;
        }
    });
...
function refreshSession(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (inputRefreshToken === undefined) {
            let handShakeInfo = yield handshakeInfo_1.HandshakeInfo.getInstance();
            cookieAndHeaders_1.clearSessionFromCookie(res, handShakeInfo.cookieDomain, handShakeInfo.cookieSecure, handShakeInfo.accessTokenPath, handShakeInfo.refreshTokenPath, handShakeInfo.idRefreshTokenPath, handShakeInfo.cookieSameSite);
            throw error_1.generateError(error_1.AuthError.UNAUTHORISED, new Error("Missing auth tokens in cookies. Have you set the correct refresh API path in your frontend and SuperTokens config?"));
        }
        try {
            ...
            if (error_1.AuthError.isErrorFromAuth(err) &&
                (err.errType === error_1.AuthError.UNAUTHORISED || err.errType === error_1.AuthError.TOKEN_THEFT_DETECTED)) {
                let handShakeInfo = yield handshakeInfo_1.HandshakeInfo.getInstance();
                cookieAndHeaders_1.clearSessionFromCookie(res, handShakeInfo.cookieDomain, handShakeInfo.cookieSecure, handShakeInfo.accessTokenPath, handShakeInfo.refreshTokenPath, handShakeInfo.idRefreshTokenPath, handShakeInfo.cookieSameSite);
            }
            throw err;
    ...
    constructor(accessToken, sessionHandle, userId, userDataInJWT, res) {
        ...
        this.revokeSession = () => __awaiter(this, void 0, void 0, function* () {
            if (yield SessionFunctions.revokeSession(this.sessionHandle)) {
                let handShakeInfo = yield handshakeInfo_1.HandshakeInfo.getInstance();
                cookieAndHeaders_1.clearSessionFromCookie(this.res, handShakeInfo.cookieDomain, handShakeInfo.cookieSecure, handShakeInfo.accessTokenPath, handShakeInfo.refreshTokenPath, handShakeInfo.idRefreshTokenPath, handShakeInfo.cookieSameSite);
            }
        });
        /**
        ...
        this.updateJWTPayload = (newJWTPayload) => __awaiter(this, void 0, void 0, function* () {
            if ((yield querier_1.Querier.getInstance().getAPIVersion()) === "1.0") {
                throw error_1.generateError(error_1.AuthError.GENERAL_ERROR, new Error("the current function is not supported for the core"));
            }
            ...
            if (response.accessToken !== undefined) {
                ...
                cookieAndHeaders_1.attachAccessTokenToCookie(this.res, response.accessToken.token, response.accessToken.expiry, response.accessToken.domain, response.accessToken.cookiePath, response.accessToken.cookieSecure, response.accessToken.sameSite);
            }
        });
