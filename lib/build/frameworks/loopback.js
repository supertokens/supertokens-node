...
exports.verifySession = (options) => {
    return (ctx, next) =>
        __awaiter(void 0, void 0, void 0, function* () {
            let sessionRecipe = recipe_1.default.getInstanceOrThrowError();
            let middlewareCtx = yield ctx.get("middleware.http.context");
            let request = new LoopbackRequest(middlewareCtx);
            let response = new LoopbackResponse(middlewareCtx);
            middlewareCtx.request.session = yield sessionRecipe.verifySession(options, request, response);
            return yield next();
        });
};
...
exports.default = LoopbackWrapper;
