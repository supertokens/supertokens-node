...
exports.AuthUtils = {
    ...
    preAuthChecks: async function ({
        ...
        if (isSignUp) {
            ...
            if (
                !(await recipe_1.default.getInstance().isSignInAllowed({
    ...
    postAuthChecks: async function ({
        ...
        if (!isSignUp) {
            ...
            const linkingResult = await exports.AuthUtils.linkToSessionIfProvidedElseCreatePrimaryUserIdOrLinkByAccountInfo(
                {
                    tenantId,
    ...
    getAuthenticatingUserAndAddToCurrentTenantIfRequired: async ({
        ...
        while (i++ < 300) {
            ...
            const currentTenantId =
                (_a = session === null || session === void 0 ? void 0 : session.getTenantId(userContext)) !== null &&
                _a !== void 0
                    ? _a
                    : "public";
     ...
     * if the session user should be primary but we couldn't make it primary because of a conflicting primary user.
     */
    checkAuthTypeAndLinkingStatus: async function (session, accountInfo, inputUser, userContext) {
        ...
        if (session === undefined) {
            ...
            if (
                !utils_3.recipeInitDefinedShouldDoAutomaticAccountLinking(recipe_1.default.getInstance().config) &&
                recipe_2.default.getInstance() !== undefined
            ) {
                throw new Error(
    ...
    linkToSessionIfProvidedElseCreatePrimaryUserIdOrLinkByAccountInfo: async function ({
        ...
        logger_1.logDebugMessage("linkToSessionIfProvidedElseCreatePrimaryUserIdOrLinkByAccountInfo called");
        const retry = () => {
            logger_1.logDebugMessage("linkToSessionIfProvidedElseCreatePrimaryUserIdOrLinkByAccountInfo retrying....");
            return exports.AuthUtils.linkToSessionIfProvidedElseCreatePrimaryUserIdOrLinkByAccountInfo({
                tenantId,
                inputUser: inputUser,
                session,
                recipeUserId,
     ...
     */
    tryAndMakeSessionUserIntoAPrimaryUser: async function (session, userContext) {
