...
exports.AuthUtils = {
    ...
    postAuthChecks: async function ({
        ...
        if (session !== undefined) {
            ...
            if (authenticatedUserLinkedToSessionUser) {
                ...
                let overwriteSessionDuringSignInUp = recipe_3.default
                    .getInstanceOrThrowError()
                    .getNormalisedOverwriteSessionDuringSignInUp(req);
    ...
    loadSessionInAuthAPIIfNeeded: async function (req, res, shouldTryLinkingWithSessionUser, userContext) {
        const overwriteSessionDuringSignInUp = recipe_3.default
            .getInstanceOrThrowError()
            .getNormalisedOverwriteSessionDuringSignInUp(req);
        if (shouldTryLinkingWithSessionUser === false) {
            logger_1.logDebugMessage(
        ...
        logger_1.logDebugMessage("loadSessionInAuthAPIIfNeeded: loading session");
