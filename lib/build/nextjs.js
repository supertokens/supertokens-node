...
class NextJS {
    ...
    static getAppDirRequestHandler(NextResponse) {
        ...
        return async function handleCall(req) {
            ...
            for (const respCookie of baseResponse.cookies) {
                baseResponse.headers.append("Set-Cookie", cookie_1.serialize(respCookie.key, respCookie.value, {
    ...
    static async commonSSRSession(baseRequest, options, userContext) {
        ...
        const transferMethods = tokenTransferMethod === "any" ? constants_1.availableTokenTransferMethods : [tokenTransferMethod];
    ...
    static async getSSRSession(cookies, headers, options, userContext) {
        ...
        const _a = await NextJS.commonSSRSession(baseRequest, options, utils_1.getUserContext(userContext)), { baseResponse, nextResponse } = _a, result = __rest(_a, ["baseResponse", "nextResponse"]);
        return result;
    }
