...
class SuperTokensWrapper {
    ...
    static getUsersOldestFirst(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "ASC" }, input), { userContext: (0, utils_1.getUserContext)(input.userContext) }));
    }
    static getUsersNewestFirst(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "DESC" }, input), { userContext: (0, utils_1.getUserContext)(input.userContext) }));
    }
