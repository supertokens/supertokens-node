...
class SuperTokensWrapper {
    ...
    static getUsersOldestFirst(input) {
        return supertokens_1.default.getInstanceOrThrowError().getUsers(Object.assign({ timeJoinedOrder: "ASC" }, input));
    }
    static getUsersNewestFirst(input) {
        return supertokens_1.default.getInstanceOrThrowError().getUsers(Object.assign({ timeJoinedOrder: "DESC" }, input));
    }
