...
class SuperTokensWrapper {
    ...
    static deleteUser(userId, removeAllLinkedAccounts = true) {
    ...
    static getUser(input) {
        return supertokens_1.default.getInstanceOrThrowError().getUser(input);
    }
    static listUsersByAccountInfo(input) {
        return supertokens_1.default.getInstanceOrThrowError().listUsersByAccountInfo(input);
    }
    static getUserByAccountInfo(input) {
        return supertokens_1.default.getInstanceOrThrowError().getUserByAccountInfoAndRecipeId(input);
    }
}
