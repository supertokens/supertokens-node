...
class SuperTokensWrapper {
    ...
    static createUserIdMapping(input) {
        var _a;
        return supertokens_1.default.getInstanceOrThrowError().createUserIdMapping(
    ...
    static getUserIdMapping(input) {
        var _a;
        return supertokens_1.default.getInstanceOrThrowError().getUserIdMapping(
            Object.assign(Object.assign({}, input), {
                userContext: (_a = input.userContext) !== null && _a !== void 0 ? _a : {},
            })
        );
    ...
    static deleteUserIdMapping(input) {
        var _a;
        return supertokens_1.default.getInstanceOrThrowError().deleteUserIdMapping(
            Object.assign(Object.assign({}, input), {
                userContext: (_a = input.userContext) !== null && _a !== void 0 ? _a : {},
            })
        );
    ...
    static updateOrDeleteUserIdMappingInfo(input) {
        var _a;
        return supertokens_1.default.getInstanceOrThrowError().updateOrDeleteUserIdMappingInfo(
            Object.assign(Object.assign({}, input), {
                userContext: (_a = input.userContext) !== null && _a !== void 0 ? _a : {},
            })
        );
