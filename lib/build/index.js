...
class SuperTokensWrapper {
    ...
    static getUsersOldestFirst(input) {
        return recipe_1.default.getInstance().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "ASC" }, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
    static getUsersNewestFirst(input) {
        return recipe_1.default.getInstance().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "DESC" }, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
    static createUserIdMapping(input) {
        return supertokens_1.default.getInstanceOrThrowError().createUserIdMapping(Object.assign(Object.assign({}, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
    static getUserIdMapping(input) {
        return supertokens_1.default.getInstanceOrThrowError().getUserIdMapping(Object.assign(Object.assign({}, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
    static deleteUserIdMapping(input) {
        return supertokens_1.default.getInstanceOrThrowError().deleteUserIdMapping(Object.assign(Object.assign({}, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
    static updateOrDeleteUserIdMappingInfo(input) {
        return supertokens_1.default.getInstanceOrThrowError().updateOrDeleteUserIdMappingInfo(Object.assign(Object.assign({}, input), { userContext: utils_1.getUserContext(input.userContext) }));
    }
