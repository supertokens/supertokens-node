...
class SuperTokensWrapper {
    ...
    static getUsersOldestFirst(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "ASC" }, input), { userContext: undefined }));
    }
    static getUsersNewestFirst(input) {
        return recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUsers(Object.assign(Object.assign({ timeJoinedOrder: "DESC" }, input), { userContext: undefined }));
    }
    static createUserIdMapping(input) {
        return supertokens_1.default.getInstanceOrThrowError().createUserIdMapping(input);
    }
    static getUserForRecipeId(userId, recipeId) {
        return supertokens_1.default.getInstanceOrThrowError().getUserForRecipeId(userId, recipeId);
    }
    ...
    static getUser(userId, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUser({
                userId,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    }
    static listUsersByAccountInfo(info, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.listUsersByAccountInfo({
                info,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    }
    static getUserByAccountInfo(info, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.getUserByAccountInfo({
                info,
                userContext: userContext === undefined ? {} : userContext,
            });
        });
    ...
    static deleteUser(userId, removeAllLinkedAccounts = true, userContext) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield recipe_1.default.getInstanceOrThrowError().recipeInterfaceImpl.deleteUser({
                userId,
...
exports.getUserByAccountInfo = SuperTokensWrapper.getUserByAccountInfo;
exports.getUserForRecipeId = SuperTokensWrapper.getUserForRecipeId;
