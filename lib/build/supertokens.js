...
class SuperTokens {
    constructor(config) {
        ...
        this.middleware = async (request, response, userContext) => {
            ...
            async function handleWithoutRid(recipeModules) {
                ...
                for (let i = 0; i < recipeModules.length; i++) {
                    logger_1.logDebugMessage("middleware: Checking recipe ID for match: " +
        ...
        }), (_b = config.supertokens) === null || _b === void 0 ? void 0 : _b.apiKey, (_c = config.supertokens) === null || _c === void 0 ? void 0 : _c.networkInterceptor, (_d = config.supertokens) === null || _d === void 0 ? void 0 : _d.disableCoreCallCache);
