        ...
        this.middleware = async (request, response, userContext) => {
            ...
            if (handlerFromApis) {
                ...
                (0, logger_1.logDebugMessage)(
                    "middleware: Request being handled by plugin. ID is: " + handlerFromApis.pluginId
                );
                try {
                    ...
                    if (error_2.default.isErrorFromSuperTokens(err)) {
                        throw err;
                    } else {
                        (0, logger_1.logDebugMessage)(
                        ...
                        throw error_2.default.fromError(err, error_2.default.PLUGIN_ERROR);
                    }
                }
                return true;
            }
