...
const recipe_1 = require("./recipe/accountlinking/recipe");
const recipe_2 = require("./recipe/emailpassword/recipe");
const recipe_3 = require("./recipe/thirdparty/recipe");
const recipe_4 = require("./recipe/passwordless/recipe");
const emailpassword_1 = require("./recipe/emailpassword");
const thirdparty_1 = require("./recipe/thirdparty");
const passwordless_1 = require("./recipe/passwordless");
const thirdpartyemailpassword_1 = require("./recipe/thirdpartyemailpassword");
const thirdpartypasswordless_1 = require("./recipe/thirdpartypasswordless");
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.sendTelemetry = () => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.handleAPI = (matchedRecipe, id, request, response, path, method) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getUserCount = (includeRecipeIds) => __awaiter(this, void 0, void 0, function* () {
            let querier = querier_1.Querier.getNewInstanceOrThrowError(undefined);
        ...
        this.createUserIdMapping = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (utils_1.maxVersion("2.15", cdiVersion) === cdiVersion) {
                    ...
                    return yield querier.sendPostRequest(new normalisedURLPath_1.default("/recipe/userid/map"), {
        ...
        this.getUserIdMapping = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let querier = querier_1.Querier.getNewInstanceOrThrowError(undefined);
                let cdiVersion = yield querier.getAPIVersion();
                if (utils_1.maxVersion("2.15", cdiVersion) === cdiVersion) {
                    // create userId mapping is only available >= CDI 2.15
                    let response = yield querier.sendGetRequest(new normalisedURLPath_1.default("/recipe/userid/map"), {
                        userId: input.userId,
        ...
        this.deleteUserIdMapping = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let querier = querier_1.Querier.getNewInstanceOrThrowError(undefined);
                let cdiVersion = yield querier.getAPIVersion();
                if (utils_1.maxVersion("2.15", cdiVersion) === cdiVersion) {
        ...
        this.updateOrDeleteUserIdMappingInfo = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                let querier = querier_1.Querier.getNewInstanceOrThrowError(undefined);
                let cdiVersion = yield querier.getAPIVersion();
                if (utils_1.maxVersion("2.15", cdiVersion) === cdiVersion) {
                    return yield querier.sendPutRequest(new normalisedURLPath_1.default("/recipe/userid/external-user-id-info"), {
                        userId: input.userId,
                        userIdType: input.userIdType,
                        externalUserIdInfo: input.externalUserIdInfo,
                    });
        ...
        this.middleware = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!path.startsWith(this.appInfo.apiBasePath)) {
                logger_1.logDebugMessage("middleware: Not handling because request path did not start with config path. Request path: " +
            ...
            if (requestRID !== undefined) {
                ...
                for (let i = 0; i < this.recipeModules.length; i++) {
                    logger_1.logDebugMessage("middleware: Checking recipe ID for match: " + this.recipeModules[i].getRecipeId());
                ...
                if (id === undefined) {
                    logger_1.logDebugMessage("middleware: Not handling because recipe doesn't handle request path or method. Request path: " +
                        path.getAsStringDangerous() +
                        ", request method: " +
                        method);
                ...
                for (let i = 0; i < this.recipeModules.length; i++) {
                    ...
                    if (id !== undefined) {
                        logger_1.logDebugMessage("middleware: Request being handled by recipe. ID is: " + id);
                        let requestHandled = yield this.recipeModules[i].handleAPIRequest(id, request, response, path, method);
                        if (!requestHandled) {
                            logger_1.logDebugMessage("middleware: Not handled because API returned requestHandled as false");
                            return false;
                        }
        ...
        this.errorHandler = (err, request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (error_1.default.isErrorFromSuperTokens(err)) {
                ...
                for (let i = 0; i < this.recipeModules.length; i++) {
                    logger_1.logDebugMessage("errorHandler: Checking recipe for match: " + this.recipeModules[i].getRecipeId());
                    if (this.recipeModules[i].isErrorFromThisRecipe(err)) {
                        logger_1.logDebugMessage("errorHandler: Matched with recipeID: " + this.recipeModules[i].getRecipeId());
        ...
        this.getUserForRecipeId = (userId, recipeId) => __awaiter(this, void 0, void 0, function* () {
            let user;
            let recipe;
        ...
        querier_1.Querier.init((_a = config.supertokens) === null || _a === void 0 ? void 0 : _a.connectionURI.split(";").filter((h) => h !== "").map((h) => {
            return {
        ...
        let isAccountLinkingInitialised = this.recipeModules.find((r) => r.getRecipeId() === recipe_1.default.RECIPE_ID);
        if (!isAccountLinkingInitialised) {
            this.recipeModules.push(recipe_1.default.init({})(this.appInfo, this.isInServerlessEnv));
        }
