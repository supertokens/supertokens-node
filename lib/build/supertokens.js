        ...
        this.errorHandler = (err, request, response) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (error_1.default.isErrorFromSuperTokens(err)) {
                    ...
                    if (err.type === error_1.default.FORBIDDEN) {
                        logger_1.logDebugMessage("errorHandler: Sending 403 status code response");
                        return utils_1.sendNon200ResponseWithMessage(response, err.message, 403);
                    }
                    for (let i = 0; i < this.recipeModules.length; i++) {
                        logger_1.logDebugMessage(
