...
class SuperTokens {
    constructor(config) {
        ...
        querier_1.Querier.init(
            (_b = config.supertokens) === null || _b === void 0
                ? void 0
                : _b.connectionURI
                      .split(";")
                      .filter((h) => h !== "")
            ...
            (_c = config.supertokens) === null || _c === void 0 ? void 0 : _c.apiKey,
            (_d = config.supertokens) === null || _d === void 0 ? void 0 : _d.networkInterceptor,
            (_e = config.supertokens) === null || _e === void 0 ? void 0 : _e.disableCoreCallCache
        );
        ...
        this.recipeModules = config.recipeList.map((func) => {
            const recipeModule = func(
                ...
                finalPluginList.filter((p) => p.overrideMap !== undefined).map((p) => p.overrideMap)
            );
