...
class SuperTokens {
    constructor(config) {
        ...
        const inputPluginList = (_a = config.plugins) !== null && _a !== void 0 ? _a : [];
        ...
        for (const plugin of inputPluginList) {
            ...
            if (plugin.dependencies) {
                const result = plugin.dependencies(finalPluginList, version_1.version);
        ...
        querier_1.Querier.init((_b = config.supertokens) === null || _b === void 0 ? void 0 : _b.connectionURI.split(";").filter((h) => h !== "").map((h) => {
            return {
                domain: new normalisedURLDomain_1.default(h.trim()),
                basePath: new normalisedURLPath_1.default(h.trim()),
            };
        }), (_c = config.supertokens) === null || _c === void 0 ? void 0 : _c.apiKey, (_d = config.supertokens) === null || _d === void 0 ? void 0 : _d.networkInterceptor, (_e = config.supertokens) === null || _e === void 0 ? void 0 : _e.disableCoreCallCache);
