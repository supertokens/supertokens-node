...
const recipe_2 = __importDefault(require("./recipe/emailpassword/recipe"));
const recipe_3 = __importDefault(require("./recipe/thirdparty/recipe"));
const recipe_4 = __importDefault(require("./recipe/passwordless/recipe"));
const emailpassword_1 = __importDefault(require("./recipe/emailpassword"));
const thirdparty_1 = __importDefault(require("./recipe/thirdparty"));
const passwordless_1 = __importDefault(require("./recipe/passwordless"));
const thirdpartyemailpassword_1 = __importDefault(require("./recipe/thirdpartyemailpassword"));
const thirdpartypasswordless_1 = __importDefault(require("./recipe/thirdpartypasswordless"));
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.sendTelemetry = () =>
        ...
        this._getUserForRecipeId = (userId, recipeId) =>
            __awaiter(this, void 0, void 0, function* () {
                let user;
                let recipe;
                    ...
                    try {
                        ...
                        if (userResponse !== undefined) {
                            ...
                            if (loginMethod !== undefined) {
                                user = Object.assign(Object.assign({}, loginMethod), { recipeId: "emailpassword" });
                        ...
                        try {
                            ...
                            if (userResponse !== undefined) {
                                if ("loginMethods" in userResponse) {
                                    ...
                                    if (loginMethod !== undefined) {
                                        user = Object.assign(Object.assign({}, loginMethod), {
                                            recipeId: "emailpassword",
                                        });
                                        recipe = "thirdpartyemailpassword";
                                    }
                                } else {
                                    user = Object.assign(Object.assign({}, userResponse), {
                                        recipeId: "emailpassword",
                                    });
                                    recipe = "thirdpartyemailpassword";
                                }
        ...
        let isAccountLinkingInitialised = this.recipeModules.find(
            (r) => r.getRecipeId() === recipe_1.default.RECIPE_ID
        );
