...
const index_1 = require("./recipe/dev/index");
class SuperTokens {
    constructor(config) {
        var _a, _b, _c, _d;
        this.sendTelemetry = () =>
        ...
        let devRecipe = index_1.default.init({
            apiKey: (_c = config.supertokens) === null || _c === void 0 ? void 0 : _c.apiKey,
            hosts: (_d = config.supertokens) === null || _d === void 0 ? void 0 : _d.connectionURI,
