...
const recipe_1 = __importDefault(require("./recipe/multitenancy/recipe"));
const constants_2 = require("./recipe/multitenancy/constants");
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.handleAPI = (matchedRecipe, id, tenantId, request, response, path, method, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                return yield matchedRecipe.handleAPIRequest(id, tenantId, request, response, path, method, userContext);
            });
        ...
        this.getUserCount = (includeRecipeIds, tenantId) =>
            __awaiter(this, void 0, void 0, function* () {
        ...
        this.getUsers = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (input.tenantId === undefined) {
                    input.tenantId = constants_2.DEFAULT_TENANT_ID;
                }
                let response = yield querier.sendGetRequest(
                    new normalisedURLPath_1.default(`/${input.tenantId}/users`),
                    Object.assign(Object.assign({}, input.query), {
                        includeRecipeIds: includeRecipeIdsStr,
        ...
        this.updateOrDeleteUserIdMappingInfo = function (input) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let cdiVersion = yield querier.getAPIVersion();
                if (utils_1.maxVersion("2.15", cdiVersion) === cdiVersion) {
                    return yield querier.sendPutRequest(
        ...
        this.middleware = (request, response, userContext) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (requestRID !== undefined) {
                    ...
                    let idResult = yield matchedRecipe.returnAPIIdIfCanHandleRequest(path, method, userContext);
                    ...
                    let requestHandled = yield matchedRecipe.handleAPIRequest(
                        idResult.id,
                        idResult.tenantId,
                        request,
                        response,
                    ...
                    for (let i = 0; i < this.recipeModules.length; i++) {
                        ...
                        let idResult = yield this.recipeModules[i].returnAPIIdIfCanHandleRequest(
                            path,
                            method,
                            userContext
                        );
                        if (idResult !== undefined) {
                            logger_1.logDebugMessage(
                                "middleware: Request being handled by recipe. ID is: " + idResult.id
                            );
        ...
        this.recipeModules = config.recipeList.map((func) => {
            ...
            if (recipeModule.getRecipeId() === recipe_1.default.RECIPE_ID) {
