...
const recipe_1 = require("./recipe/useridmapping/recipe");
const useridmapping_1 = require("./recipe/useridmapping");
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.sendTelemetry = () =>
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (recipe_1.isUserIdMappingRecipeInitialized) {
                    ...
                    for (let i = 0; i < response.users.length; i++) {
                        ...
                        userIdMappingPromises.push(
                            () =>
                                new Promise((resolve, reject) =>
                                    __awaiter(this, void 0, void 0, function* () {
                                        try {
                                            const userIdMappingResponse = yield useridmapping_1.getUserIdMapping(
                                                userObj.user.id,
                                                "SUPERTOKENS",
                                                undefined
                                            );
                        ...
                        let userIdMapping = yield useridmapping_1.getUserIdMapping(
                            response.users[i].id,
                            "SUPERTOKENS",
                            undefined
                        );
                    ...
                    while (promiseArrayStartPosition < userIdMappingPromises.length) {
                        ...
                        if (promiseArrayEndPosition >= userIdMappingPromises.length) {
                            ...
                            promiseArrayEndPosition =
                                promiseArrayStartPosition +
                                (userIdMappingPromises.length - 1 - promiseArrayStartPosition);
                        }
                        let promisesToCall = [];
