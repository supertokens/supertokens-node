...
class SuperTokens {
    constructor(config) {
        ...
        const { publicConfig, processedPlugins, pluginRouteHandlers, overrideMaps } = (0, plugins_1.loadPlugins)({
            plugins:
                (_b = (_a = config.experimental) === null || _a === void 0 ? void 0 : _a.plugins) !== null &&
                _b !== void 0
                    ? _b
                    : [],
            publicConfig: (0, utils_1.getPublicConfig)(config),
        });
        this.pluginRouteHandlers = pluginRouteHandlers;
        this.pluginList = processedPlugins;
        config = Object.assign(Object.assign({}, publicConfig), (0, utils_1.getNonPublicConfig)(config));
