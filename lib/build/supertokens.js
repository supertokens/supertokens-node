...
class SuperTokens {
    constructor(config) {
        ...
        for (const plugin of inputPluginList) {
            ...
            const dependencies = (0, utils_1.getPluginDependencies)(
                plugin,
                (0, utils_1.getPublicConfig)(config),
                finalPluginList,
                version_1.version
            );
        ...
        for (const [pluginIndex, plugin] of finalPluginList.entries()) {
            if (plugin.config) {
                config = Object.assign(Object.assign({}, config), plugin.config((0, utils_1.getPublicConfig)(config)));
            }
