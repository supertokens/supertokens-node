...
class SuperTokens {
    constructor(config) {
        ...
        this.middleware = async (request, response, userContext) => {
            ...
            if (handlerFromApis) {
                ...
                if (handlerFromApis.verifySessionOptions !== undefined) {
                    session = await recipe_1.default.getInstanceOrThrowError().verifySession(handlerFromApis.verifySessionOptions, request, response, userContext);
                }
        ...
        if (!accountLinkingFound) {
            this.recipeModules.push(AccountLinkingRecipe.init()(this.appInfo, this.isInServerlessEnv, this.pluginOverrideMaps));
        }
        if (!jwtFound) {
        ...
        if (!multitenancyFound) {
            this.recipeModules.push(MultitenancyRecipe.init()(this.appInfo, this.isInServerlessEnv, this.pluginOverrideMaps));
        }
        ...
        if (!userMetadataFound) {
            ...
            this.recipeModules.push(UserMetadataRecipe.init()(this.appInfo, this.isInServerlessEnv, this.pluginOverrideMaps));
        }
        ...
        if (!oauth2Found) {
            this.recipeModules.push(OAuth2ProviderRecipe.init()(this.appInfo, this.isInServerlessEnv, this.pluginOverrideMaps));
        }
