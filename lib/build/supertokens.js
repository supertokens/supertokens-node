...
class SuperTokens {
    constructor(config) {
        ...
        this.middleware = () => {
            return (request, response, next) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (requestRID !== undefined) {
                    ...
                    try {
                        yield utils_1.assertThatBodyParserHasBeenUsed(matchedRecipe.getRecipeId(), request, response);
                    ...
                    for (let i = 0; i < this.recipeModules.length; i++) {
                        ...
                        if (id !== undefined) {
                            try {
                                yield utils_1.assertThatBodyParserHasBeenUsed(this.recipeModules[i].getRecipeId(), request, response);
        ...
        this.errorHandler = () => {
            return (err, request, response, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        querier_1.Querier.init(config.supertokens.connectionURI.split(";").map((h) => new normalisedURLDomain_1.default("", h)), config.supertokens.apiKey);
