...
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.handleAPI = (matchedRecipe, id, tenantId, request, response, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                return yield matchedRecipe.handleAPIRequest(id, tenantId, request, response, path, method);
            });
