...
exports.withSession = exports.getSessionForSSR = exports.handleAuthAPIRequest = exports.createPreParsedRequest = void 0;
...
async function getSessionDetails(preParsedRequest, options, userContext) {
    ...
    const recipe = recipe_1.default.default.instance;
...
async function withSession(remixRequest, handler, options, userContext) {
    try {
