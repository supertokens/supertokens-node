...
exports.withPreParsedRequestResponse = exports.withSession = exports.getSessionForSSRUsingAccessToken = exports.getSessionForSSR = exports.handleAuthAPIRequest = exports.getQueryFromRequest = exports.getCookieFromRequest = void 0;
...
async function getSessionForSSRUsingAccessToken(accessToken) {
    ...
    try {
        ...
        const jwksToUse = combinedRemoteJWKSet_1.getCombinedJWKS(sessionRecipe.config);
        try {
            if (accessToken) {
                const tokenInfo = jwt_1.parseJWTWithoutSignatureVerification(accessToken);
                const decoded = await accessToken_1.getInfoFromAccessToken(tokenInfo, jwksToUse, false);
...
function addCookies(baseResponse, userResponse) {
    ...
    for (const respCookie of baseResponse.cookies) {
        didAddCookies = true;
        userResponse.headers.append("Set-Cookie", cookie_1.serialize(respCookie.key, respCookie.value, {
