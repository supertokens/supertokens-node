...
exports.logDebugMessage = void 0;
...
function logDebugMessage(message) {
    if (debug_1.default.enabled(SUPERTOKENS_DEBUG_NAMESPACE)) {
        debug_1.default(SUPERTOKENS_DEBUG_NAMESPACE)(`{t: "${new Date().toISOString()}", message: \"${message}\", file: \"${getFileLocation()}\" sdkVer: "${version_1.version}"}`);
        console.log();
    }
}
