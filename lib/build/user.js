...
class LoginMethod {
    ...
    hasSamePhoneNumberAs(phoneNumber) {
        ...
        const parsedPhoneNumber = max_1.default(phoneNumber.trim(), { extract: false });
...
class User {
    ...
    static fromApi(apiUser) {
        return new User(
            Object.assign(Object.assign({}, apiUser), { id: new recipeUserId_1.default(apiUser.id).getAsString() })
        );
    }
    toJson() {
        return {
