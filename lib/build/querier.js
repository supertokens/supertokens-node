...
exports.Querier = exports.hydraPubPathPrefix = exports.hydraPubDomain = void 0;
...
exports.hydraPubDomain = (_a = process.env.HYDRA_PUB) !== null && _a !== void 0 ? _a : "http://localhost:4444"; // This will be used as a domain for paths starting with hydraPubPathPrefix
const hydraAdmDomain = (_b = process.env.HYDRA_ADM) !== null && _b !== void 0 ? _b : "http://localhost:4445"; // This will be used as a domain for paths starting with hydraAdmPathPrefix
exports.hydraPubPathPrefix = "/recipe/oauth2/pub"; // Replaced with "/oauth2" when sending the request (/recipe/oauth2/pub/token -> /oauth2/token)
...
class Querier {
    ...
    constructor(hosts, rIdToCore) {
        ...
        this.sendRequestHelper = async (path, method, requestFunc, numberOfTries, retryInfoMap) => {
            ...
            const isHydraAPICall =
                strPath.startsWith(hydraAdmPathPrefix) || strPath.startsWith(exports.hydraPubPathPrefix);
            if (strPath.startsWith(exports.hydraPubPathPrefix)) {
                currentDomain = exports.hydraPubDomain;
                currentBasePath = "";
                strPath = strPath.replace(exports.hydraPubPathPrefix, "/oauth2");
            }
...
async function handleHydraAPICall(response) {
    ...
    } else if (contentType === null || contentType === void 0 ? void 0 : contentType.startsWith("text/plain")) {
        return {
