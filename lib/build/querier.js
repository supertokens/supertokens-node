...
class Querier {
    ...
    constructor(hosts, rIdToCore) {
        this.getAPIVersion = () => __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield this.sendRequestHelper(new normalisedURLPath_1.default("/apiversion"), "GET", (url) => {
                let headers = {};
        ...
        this.sendDeleteRequest = (path, body) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.sendRequestHelper(path, "DELETE", (url) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (Querier.apiKey !== undefined) {
                    headers = Object.assign(Object.assign({}, headers), { "api-key": Querier.apiKey, "content-type": "application/json; charset=utf-8" });
                }
                if (path.isARecipePath() && this.rIdToCore !== undefined) {
                    headers = Object.assign(Object.assign({}, headers), { rid: this.rIdToCore });
                }
