    ...
    constructor(hosts, rIdToCore) {
        this.getAPIVersion = async (userContext) => {
            ...
            let { body: response } = await this.sendRequestHelper(new normalisedURLPath_1.default("/apiversion"), "GET", async (url) => {
                ...
                let response = await utils_1.doFetch(url + `?${queryParams}`, {
                    method: "GET",
                    headers,
                });
                return response;
            ...
            let supportedVersion = utils_1.getLargestVersionFromIntersection(cdiSupportedByServer, version_1.cdiSupported);
        ...
        this.sendGetRequest = async (path, params, userContext) => {
            ...
            const { body: respBody } = await this.sendRequestHelper(path, "GET", async (url) => {
                ...
                if (response.status === 200 && !Querier.disableCache) {
                    ...
                    userContext._default = Object.assign(Object.assign({}, userContext._default), { coreCallCache: Object.assign(Object.assign({}, (_d = userContext._default) === null || _d === void 0 ? void 0 : _d.coreCallCache), { [uniqueKey]: response }), globalCacheTag: Querier.globalCacheTag });
                }
                return response;
            }, ((_a = this.__hosts) === null || _a === void 0 ? void 0 : _a.length) || 0);
            return respBody;
        };
        this.sendGetRequestWithResponseHeaders = async (path, params, inpHeaders, userContext) => {
            var _a;
        ...
        // path should start with "/"
        this.sendPutRequest = async (path, body, params, userContext) => {
            var _a;
            this.invalidateCoreCallCache(userContext);
