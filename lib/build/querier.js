        ...
        this.getAPIVersion = () =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.isInServerlessEnv) {
                    let apiVersion = yield utils_1.getDataFromFileIfExists(constants_1.API_VERSION_FILE_PATH);
                ...
                if (this.isInServerlessEnv) {
                    utils_1.storeIntoTempFile(constants_1.API_VERSION_FILE_PATH, supportedVersion);
                }
                return Querier.apiVersion;
            });
