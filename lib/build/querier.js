...
class Querier {
    ...
    constructor(hosts, isInServerlessEnv, recipe, rIdToCore) {
        this.getAPIVersion = () =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.isInServerlessEnv) {
                    let apiVersion = yield utils_1.getDataFromFileForServerlessCache(constants_1.API_VERSION_FILE_PATH);
                ...
                let response = yield this.sendRequestHelper(
                    new normalisedURLPath_1.default(this.recipe, "/apiversion"),
                    "GET",
                    (url) => {
                        let headers = {};
                ...
                if (this.isInServerlessEnv) {
                    utils_1.storeIntoTempFolderForServerlessCache(constants_1.API_VERSION_FILE_PATH, supportedVersion);
                }
                return Querier.apiVersion;
            });
    ...
    static getInstanceOrThrowError(isInServerlessEnv, recipe, rIdToCore) {
