...
class Querier {
    constructor(hosts, rId) {
        this.getAPIVersion = () => __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield this.sendRequestHelper(new normalisedURLPath_1.default(this.rId, "/apiversion"), "GET", (url) => {
                let headers = {};
            ...
            if (supportedVersion === undefined) {
                throw new error_1.default({
                    ...
                    rId: this.rId,
                    payload: new Error("The running SuperTokens core version is not compatible with this NodeJS SDK. Please visit https://supertokens.io/docs/community/compatibility to find the right versions"),
                });
            }
            ...
            try {
                ...
                if (err.response !== undefined && err.response.status !== undefined && err.response.data !== undefined) {
                    throw new error_1.default({
                        type: error_1.default.GENERAL_ERROR,
                        rId: this.rId,
                        payload: new Error("SuperTokens core threw an error for a " +
                            method +
                            " request to path: '" +
    ...
    static getInstanceOrThrowError(rId) {
