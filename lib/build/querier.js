...
class Querier {
    ...
    constructor(hosts, rIdToCore) {
        ...
        this.sendGetRequest = async (path, params, userContext) => {
            ...
            if (uniqueKey in ((_b = (_a = userContext._default) === null || _a === void 0 ? void 0 : _a.coreCallCache) !== null && _b !== void 0 ? _b : {})) {
            ...
            userContext._default = Object.assign(Object.assign({}, userContext._default), { coreCallCache: Object.assign(Object.assign({}, (_d = userContext._default) === null || _d === void 0 ? void 0 : _d.coreCallCache), { [uniqueKey]: respBody }) });
            return respBody;
        };
