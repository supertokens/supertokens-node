...
class Querier {
    ...
    constructor(hosts, rIdToCore) {
        ...
        // path should start with "/"
        this.sendDeleteRequest = async (template_path, body, params, userContext) => {
            var _a;
            this.invalidateCoreCallCache(userContext);
            const path = this.getPath(template_path);
            const { body: respBody } = await this.sendRequestHelper(
        ...
        // path should start with "/"
        this.sendGetRequest = async (template_path, params, userContext) => {
            var _a;
            const path = this.getPath(template_path);
            const { body: respBody } = await this.sendRequestHelper(
                path,
        ...
        this.sendGetRequestWithResponseHeaders = async (template_path, params, inpHeaders, userContext) => {
            var _a;
            const path = this.getPath(template_path);
        ...
        // path should start with "/"
        this.sendPutRequest = async (template_path, body, params, userContext) => {
            var _a;
            this.invalidateCoreCallCache(userContext);
            const path = this.getPath(template_path);
            const { body: respBody } = await this.sendRequestHelper(
