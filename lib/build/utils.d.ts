...
export declare function normaliseInputAppInfoOrThrowError(recipe: RecipeModule | undefined, appInfo: AppInfo, apiWebProxyPath: NormalisedURLPath): NormalisedAppinfo;
...
export declare function sendNon200Response(recipe: RecipeModule | undefined, res: express.Response, message: string, statusCode: number): void;
