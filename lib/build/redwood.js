            ...
            session_1
                ...
                .catch((err) => {
                    ...
                    if (err.type === session_1.Error.UNAUTHORISED) {
                        errorHandler = recipe_1.default.getInstanceOrThrowError().config.errorHandlers.onUnauthorised;
                    } else if (err.type === session_1.Error.TRY_REFRESH_TOKEN) {
                        errorHandler = recipe_1.default.getInstanceOrThrowError().config.errorHandlers
                            .onTryRefreshToken;
                    } else {
                        return callback(err);
                    }
