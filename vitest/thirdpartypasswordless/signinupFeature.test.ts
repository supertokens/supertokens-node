...
describe(`signinupTest: ${printPath('[test/thirdpartypasswordless/signinupFeature.test.js]')}`, () => {
  ...
  it('test with thirdPartyPasswordless, that if you disable the signInUp api, it does not work', async () => {
    await startST()
    STExpress.init({
      supertokens: {
  ...
  it('test with thirdPartyPasswordless, minimum config without code for thirdparty module', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, missing code and authCodeResponse', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test for thirdPartyPasswordless, minimum config for thirdParty module', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, with minimum config for thirdparty module, email unverified', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, thirdparty provider doesn\'t exist in config', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, provider get function throws error', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, email not returned in getProfileInfo function', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, error thrown from getProfileInfo function', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, invalid POST params for thirdparty module', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test with thirdPartyPasswordless, getUserById when user does not exist', async () => {
    await startST()
    ...
    const userInfo = await ThirdPartyPasswordless.getUserById(signUpUserInfo.id)
  ...
  it('test getUserByThirdPartyInfo when user does not exist', async () => {
    ...
    const signUpUserInfo = response.body.user
    const userInfo = await ThirdPartyPasswordless.getUserByThirdPartyInfo('custom', 'user')
