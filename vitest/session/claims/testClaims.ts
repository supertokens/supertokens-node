...
import { BooleanClaim } from 'supertokens-node/recipe/session/claimBaseClasses/booleanClaim'
import { PrimitiveClaim } from 'supertokens-node/recipe/session/claimBaseClasses/primitiveClaim'

export const UndefinedClaim = new BooleanClaim({
  key: 'st-undef',
  fetchValue: () => undefined,
})

export const TrueClaim = new BooleanClaim({
  key: 'st-true',
  fetchValue: () => true,
})

export class StubClaim extends PrimitiveClaim {
