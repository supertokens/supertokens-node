...
describe(`sessionClaims/removeClaim: ${printPath('[test/session/claims/removeClaim.test.ts]')}`, () => {
  beforeEach(async () => {
    await killAllST()
    await setupST()
  ...
  describe('SessionClass.removeClaim', () => {
    ...
    it('should clear previously set claim', async () => {
      await startST()
    ...
    it('should clear previously set claim using a handle', async () => {
      await startST()
