...
describe(`sessionClaims/verifySession: ${printPath('[test/session/claims/verifySession.test.ts]')}`, () => {
  beforeEach(async () => {
    await killAllST()
    await setupST()
  ...
  describe('verifySession', () => {
    describe('with getGlobalClaimValidators override', () => {
      it('should allow without claims required or present', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
      ...
      it('should allow with claim valid after refetching', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should reject with claim required but not added', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should allow with custom validator returning true', async () => {
        await startST()
      ...
      it('should reject with custom validator returning false', async () => {
        await startST()
        const customValidator = {
          id: 'testid',
      ...
      it('should reject with validator returning false with reason', async () => {
        await startST()
        const customValidator = {
          id: 'testid',
      ...
      it('should reject if assertClaims returns an error', async () => {
        const obj = {}
      ...
      it('should allow if assertClaims returns no errors', async () => {
        const obj = {}
        const testValidatorArr = [obj]
        const validateClaims = sinon.expectation
          .create('validateClaims')
    ...
    describe('with overrideGlobalClaimValidators', () => {
      it('should allow with empty list as override', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should allow with refetched claim', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should reject with invalid refetched claim', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should reject with custom claim returning false', async () => {
        const customValidator = {
          id: 'testid',
          validate: () => ({ isValid: false, reason: 'testReason' }),
        }
      ...
      it('should allow with custom claim returning true', async () => {
        const customValidator = {
          id: 'testid',
          validate: () => ({ isValid: true }),
        }
