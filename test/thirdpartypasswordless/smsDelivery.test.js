...
let { TwilioService, SupertokensService } = require("../../dist/recipe/thirdpartypasswordless/smsdelivery/services");
...
describe(`smsDelivery: ${printPath("[test/thirdpartypasswordless/smsdelivery/services.test.js]")}`, function () {
