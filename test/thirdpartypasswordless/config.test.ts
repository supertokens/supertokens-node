...
describe(`config tests: ${printPath('[test/thirdpartypasswordless/config.test.js]')}`, () => {
  ...
  /*
        contactMethod: EMAIL_OR_PHONE
            - minimal config
    */
  it('test minimum config for thirdpartypasswordless with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
    ...
    const thirdPartyPasswordlessRecipe = await ThirdPartyPasswordlessRecipe.getInstanceOrThrowError()
  ...
  /*
    ...
    */
  it('test for thirdPartyPasswordless, adding custom validators for phone and email with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, use custom function to send email with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, use custom function to send text SMS with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  /*
        contactMethod: PHONE
            - minimal input works
    */
  it('test for thirdPartyPasswordless minimum config with phone contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, if validatePhoneNumber is called with phone contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, createAndSendCustomTextMessage with flowType: USER_INPUT_CODE and phone contact method', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, createAndSendCustomTextMessage with flowType: MAGIC_LINK and phone contact method', async () => {
    await startST()
  ...
  /*  contactMethod: PHONE
    ...
    */
  it('test for thirdPartyPasswordless, createAndSendCustomTextMessage with flowType: USER_INPUT_CODE_AND_MAGIC_LINK and phone contact method', async () => {
    await startST()
  ...
  it('test with thirdPartyPasswordless, createAndSendCustomTextMessage, if error is thrown, it should contain a general error in the response', async () => {
    await startST()
  ...
  it('test with thirdPartyPasswordless, minimum config with email contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, if validateEmailAddress is called with email contactMethod', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, createAndSendCustomEmail with flowType: USER_INPUT_CODE and email contact method', async () => {
    await startST()
  ...
  it('test with thirdPartyPasswordless, createAndSendCustomEmail with flowType: MAGIC_LINK and email contact method', async () => {
    await startST()
  ...
  /*  contactMethod: EMAIL
        If passed createAndSendCustomEmail, it gets called with the right inputs:
            - flowType: USER_INPUT_CODE_AND_MAGIC_LINK -> userInputCode !== undefined && urlWithLinkCode !== undefined
    */
  it('test with ThirdPartyPasswordless, createAndSendCustomTextMessage with flowType: USER_INPUT_CODE_AND_MAGIC_LINK and email contact method', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, that for createAndSendCustomEmail, if error is thrown, the status in the response should be a general error', async () => {
    await startST()
  ...
  it('test thirdPartyPasswordless, missing compulsory configs throws an error', async () => {
    await startST()
  ...
  it('test for thirdPartyPasswordless, passing getCustomUserInputCode using different codes', async () => {
    await startST()
    ...
    const createCodeResponse = await new Promise(resolve =>
      request(app)
        .post('/auth/signinup/code')
        .send({
          email: 'test@example.com',
    ...
    const resendUserCodeResponse = await new Promise(resolve =>
      request(app)
  ...
  it('test for thirdPartyPasswordless, passing getCustomUserInputCode using the same code', async () => {
    await startST()
    ...
    const createNewCodeForDeviceResponse = await ThirdPartyPasswordless.createNewCodeForDevice({
      deviceId: createCodeResponse.deviceId,
  ...
  it('test basic override usage in thirdPartyPasswordless', async () => {
    await startST()

    const customDeviceId = 'customDeviceId'
  ...
  it('test for thirdPartyPasswordless, default config for thirdparty', async () => {
    await startST()
    ...
    const thirdPartyPasswordless = await ThirdPartyPasswordlessRecipe.getInstanceOrThrowError()
    const config = thirdPartyPasswordless.config
  ...
  it('test for thirdPartyPasswordless, minimum config for thirdparty module, custom provider', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
