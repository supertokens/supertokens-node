...
async function createSession(app: any, authModeHeader: any, body: any) {
...
function getTestApp(endpoints: any) {
  const app = express()
...
describe(`auth-modes: ${printPath('[test/auth-modes.test.js]')}`, () => {
  ...
  describe('with default getTokenTransferMethod', () => {
    describe('createNewSession', () => {
      describe('with default getTokenTransferMethod', () => {
        it('should default to header based session w/ no auth-mode header', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
        ...
        it('should default to header based session w/ bad auth-mode header', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should use headers if auth-mode specifies it', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should use cookies if auth-mode specifies it', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
      ...
      describe('with user provided getTokenTransferMethod', () => {
        it('should use headers if getTokenTransferMethod returns any', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should use headers if getTokenTransferMethod returns header', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should use clear cookies (if present) if getTokenTransferMethod returns header', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should use cookies if getTokenTransferMethod returns cookie', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
        ...
        it('should clear headers (if present) if getTokenTransferMethod returns cookie', async () => {
          await startST()
          SuperTokens.init({
            supertokens: {
              connectionURI: 'http://localhost:8080',
    ...
    describe('mergeIntoAccessTokenPayload', () => {
      it('should update cookies if the session was cookie based', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
      ...
      it('should allow headers if the session was header based', async () => {
        await startST()
        SuperTokens.init({
          supertokens: {
            connectionURI: 'http://localhost:8080',
