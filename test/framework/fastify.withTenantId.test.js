...
describe(`Fastify: ${printPath("[test/framework/fastify.withTenantId.test.js]")}`, function () {
    ...
    it("token theft detection", async function () {
        ...
        this.server.post("/auth/public/session/refresh", async (req, res) => {
    ...
    it("generating email verification token without payload", async function () {
        ...
        let res2 = await this.server.inject({
            method: "post",
            url: "/auth/public/user/email/verify/token",
            payload: {},
            headers: {
                Cookie: `sAccessToken=${response.accessToken}`,
    ...
    it("test that search results correct output for 'email: t'", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&email=t",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for multiple search terms", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&email=iresh;john",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for 'email: iresh'", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&email=iresh",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for 'phone: +1'", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&phone=%2B1",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for 'phone: 1('", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&phone=1%28",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for 'provider: google'", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&provider=google",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
    ...
    it("test that search results correct output for 'provider: google, phone: 1'", async function () {
        ...
        let resp = await this.server.inject({
            method: "get",
            url: "/auth/public/dashboard/api/users?limit=10&provider=google&phone=1",
            headers: {
                Authorization: "Bearer testapikey",
                "Content-Type": "application/json",
            },
