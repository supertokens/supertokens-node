...
let ThirPartyPasswordless = require("../dist/recipe/thirdpartypasswordless/recipe").default;
...
const EmailVerificationRecipe = require("../dist/recipe/emailverification/recipe").default;
let JWTRecipe = require("..//dist/recipe/jwt/recipe").default;
...
const { default: OpenIDRecipe } = require("../dist/recipe/openid/recipe");
const { wrapRequest } = require("../dist/framework/express");
