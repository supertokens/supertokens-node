...
import ThirParty from 'supertokens-node/recipe/thirdparty'
...
describe(`providerTest: ${printPath('[test/thirdparty/provider.test.js]')}`, () => {
  ...
  it('test minimum config for third party provider google', async () => {
    await startST()
    STExpress.init({
      supertokens: {
    ...
    const providerInfo = ThirPartyRecipe.getInstanceOrThrowError().providers[0]
  ...
  it('test passing additional params, check they are present in authorisation url for thirdparty provider google', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test passing scopes in config for thirdparty provider google', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test minimum config for third party provider facebook', async () => {
    await startST()
  ...
  it('test passing scopes in config for third party provider facebook', async () => {
    await startST()
  ...
  it('test minimum config for third party provider github', async () => {
    await startST()
  ...
  it('test additional params, check they are present in authorisation url for third party provider github', async () => {
    await startST()
  ...
  it('test passing scopes in config for third party provider github', async () => {
    await startST()
  ...
  it('test minimum config for third party provider apple', async () => {
    await startST()
  ...
  it('test passing additional params, check they are present in authorisation url for third party provider apple', async () => {
    await startST()
  ...
  it('test passing scopes in config for third party provider apple', async () => {
    await startST()
  ...
  it('test passing invalid privateKey in config for third party provider apple', async () => {
    await startST()
  ...
  it('test duplicate provider without any default', async () => {
    await startST()
    try {
      STExpress.init({
        supertokens: {
  ...
  it('test duplicate provider with both default', async () => {
    await startST()
    try {
      STExpress.init({
        supertokens: {
  ...
  it('test duplicate provider with one default', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
