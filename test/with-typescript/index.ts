            ...
            return {
                ...
                createNewSession: async (input) => {
                    ...
                    return {
                        ...
                        updateSessionClaims: session.updateSessionClaims,
                        addClaim: session.addClaim,
                        checkClaimInToken: session.checkClaimInToken,
                        fetchClaim: session.fetchClaim,
                        getSessionClaims: session.getSessionClaims,
                        removeClaim: session.removeClaim,
                        shouldRefetchClaim: session.shouldRefetchClaim,
                ...
                updateSessionClaims: originalImpl.updateSessionClaims,
