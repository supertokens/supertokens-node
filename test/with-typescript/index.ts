            ...
            return {
                ...
                createNewSession: async (input) => {
                    ...
                    return {
                        ...
                        updateSessionGrants: session.updateSessionGrants,
                        addGrant: session.addGrant,
                        checkGrantInToken: session.checkGrantInToken,
                        fetchGrant: session.fetchGrant,
                        getSessionGrants: session.getSessionGrants,
                        removeGrant: session.removeGrant,
                        shouldRefetchGrant: session.shouldRefetchGrant,
                ...
                updateSessionGrants: originalImpl.updateSessionGrants,
