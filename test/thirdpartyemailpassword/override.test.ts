            ...
            functions: (oI) => {
              return {
                ...
                emailPasswordSignUp: async (input) => {
                  const response = await oI.emailPasswordSignUp(input)
            ...
            apis: (oI) => {
              return {
                ...
                emailPasswordSignInPOST: async (input) => {
                  const response = await oI.emailPasswordSignInPOST(input)
                  if (response.status === 'OK') {
                    user = response.user
                    newUser = false
                    type = 'emailpassword'
                ...
                emailPasswordEmailExistsGET: async (input) => {
                  const response = await oI.emailPasswordEmailExistsGET(input)
