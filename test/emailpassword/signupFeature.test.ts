...
describe(`signupFeature: ${printPath('[test/emailpassword/signupFeature.test.js]')}`, () => {
  ...
  it('test that if disable api, the default signup API does not work', async () => {
    await startST()
  ...
  it('test signUpAPI works when input is fine', async () => {
    await startST()
  ...
  it('test signUpAPI throws an error in case of a duplicate email', async () => {
    await startST()
  ...
  it('test signUpAPI throws an error for email and password with invalid syntax', async () => {
    await startST()
  ...
  /* pass a bad input to the /signup API and test that it throws a 400 error.
     ...
     * */
  it('test bad input, not a JSON to /signup API', async () => {
    await startST()
  ...
  it('test bad input, no POST body to /signup API', async () => {
    await startST()
  ...
  it('test bad input, Input is JSON, but wrong structure to /signup API', async () => {
    await startST()
  ...
  it('test bad input, formFields is not an array in /signup API', async () => {
    await startST()
  ...
  it('test bad input, formField elements have no id or no value field in /signup API', async () => {
    await startST()
  ...
  it('test that a successful signup yields a session', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
    ...
    const cookies = extractInfoFromResponse(signUpResponse)
  ...
  it('test that if not provided by the user, it should not result in an error', async () => {
    await startST()
  ...
  // - If provided by the user, and custom fields are there, only those should be sent
  it('test that if provided by the user, and custom fields are there, only those are sent, using handlePostSignUp', async () => {
    await startST()
  ...
  // If provided by the user, and no custom fields are there, then the formFields param must sbe empty
  it('test that if provided by the user, and no custom fields are there, then formFields must be empty, using handlePostSignUp', async () => {
    await startST()
  ...
  /* formField validation testing:
     ...
     */
  it('test formFields added in config but not in inout to signup, check error about it being missing', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // - Good test case without optional
  it('test valid formFields without optional', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // - Bad test case without optional (something is missing, and it's not optional)
  it('test bad case input to signup without optional', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // - Good test case with optionals
  it('test good case input to signup with optional', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // - Input formFields has no email field (and not in config)
  it('test input formFields has no email field', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Input formFields has no password field (and not in config
  it('test inut formFields has no password field', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Input form field has different number of custom fields than in config form fields)
  it('test input form field has a different number of custom fields than in config form fields', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Input form field has same number of custom fields as in config form field, but some ids mismatch
  it('test input form field has the same number of custom fields than in config form fields, but ids mismatch', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Test custom field validation error (one and two custom fields)
  it('test custom field validation error', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Test password field validation error
  it('test signup password field validation error', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Test email field validation error
  it('test signup email field validation error', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Make sure that the input email is trimmed
  it('test that input email is trimmed', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  // Pass a non string value in the formFields array and make sure it passes through the signUp API and is sent in the handlePostSignUp as that type
  it('test that non string value in formFields array and it passes through the signup API and it is sent to the handlePostSignUp', async () => {
    await startST()
