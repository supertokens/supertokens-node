...
describe(`signinFeature: ${printPath('[test/emailpassword/signinFeature.test.ts]')}`, () => {
  beforeEach(async () => {
    await killAllST()
    await setupST()
  ...
  /*
     */
  it('test that disabling api, the default signin API does not work', async () => {
    await startST()
    STExpress.init({
      supertokens: {
  ...
  /*
    ...
    */
  it('test singinAPI throws an error if password is incorrect', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  /*
    ...
    */
  it('test bad input, not a JSON to /signin API', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  /*
    ...
    */
  it('test bad input, no POST body to /signin API', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  /*
    ...
    setting valid JSON body to /singin API
    */
  it('test bad input, input is Json but incorrect structure to /signin API', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  /*
    ...
    */
  it('test that a successfull signin yields a session', async () => {
    await startST()
    STExpress.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
    ...
    const cookies = extractInfoFromResponse(response)
  ...
  /*
    ...
    */
  it('test custom password validators to sign up and make sure they are applied to sign in', async () => {
    await startST()
    ...
    const signUpResponse = await signUPRequest(app, 'random@gmail.com', 'valid')
    assert(JSON.parse(signUpResponse.text).status === 'OK')
    assert(signUpResponse.status === 200)
  ...
  /*
    ...
    */
  it('test password field validation error', async () => {
    await startST()
  ...
  it('test email field validation error', async () => {
    await startST()
  ...
  it('test formFields has no email field', async () => {
    await startST()
  ...
  it('test formFields has no password field', async () => {
    await startST()
  ...
  /*
    ...
    */
  it('test invalid email and wrong password', async () => {
    await startST()
  ...
  /*
     ...
     *    - User exists
     */
  it('test getUserByEmail when user does not exist', async () => {
    await startST()
    ...
    const emailpassword = EmailPasswordRecipe.getInstanceOrThrowError()
    ...
    const userInfo = await EmailPassword.getUserByEmail('random@gmail.com')
  ...
  it('test getUserById when user does not exist', async () => {
    ...
    const signUpUserInfo = JSON.parse(signUpResponse.text).user
    const userInfo = await EmailPassword.getUserById(signUpUserInfo.id)

    assert(userInfo.email === signUpUserInfo.email)
    assert(userInfo.id === signUpUserInfo.id)
  })

  it('test the handlePostSignIn function', async () => {
    await startST()
            ...
            apis: (oI) => {
              return {
                ...
                signInPOST: async (formFields, options) => {
                  const response = await oI.signInPOST(formFields, options)
