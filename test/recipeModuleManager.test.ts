...
import RecipeModule from 'supertokens-node/recipeModule'
import NormalisedURLPath from 'supertokens-node/normalisedURLPath'
import STError from 'supertokens-node/error'
...
import { cleanST, killAllST, printPath, resetAll, setupST, startST } from './utils'
...
describe(`recipeModuleManagerTest: ${printPath('[test/recipeModuleManager.test.js]')}`, () => {
  ...
  it('test that querier has been initiated when we call supertokens.init', async () => {
    await startST()
  ...
  // Failure condition: initalizing supertoknes before the the first try catch will fail the test
  it('test that modules have been initiated when we call supertokens.init', async () => {
    await startST()
  ...
  it('test various inputs to routing with default base path', async () => {
    await startST()
    ST.init({
      supertokens: {
        connectionURI: 'http://localhost:8080',
  ...
  it('test various inputs to routing when base path is /', async () => {
    await startST()
    {
      ST.init({
        supertokens: {
  ...
  it('test routing with multiple recipes', async () => {
    await startST()
  ...
  it('test various inputs to errorHandler', async () => {
    await startST()
  ...
  it('test that error thrown from APIs implemented by recipes must not go unhandled', async () => {
    await startST()
  ...
  it('test if you diable a default route, and then implement your own API, your own api is called', async () => {
    await startST()
  ...
  it('test if the error handler in a recipe throws an error, it goes to the user\'s error handler', async () => {
    await startST()
  ...
  it('test the getAllCORSHeaders function', async () => {
    await startST()
    ...
    const headers = await ST.getAllCORSHeaders()
