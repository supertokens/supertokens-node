...
describe(`config tests: ${printPath('[test/passwordless/config.test.ts]')}`, () => {
  ...
  /*
        contactMethod: EMAIL_OR_PHONE
            - minimal config
    */
  it('test minimum config with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
    ...
    const passwordlessRecipe = await PasswordlessRecipe.getInstanceOrThrowError()
  ...
  /*
    ...
    */
  it('test adding custom validators for phone and email with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test custom function to send email with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test custom function to send text SMS with EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  /*
        contactMethod: PHONE
            - minimal input works
    */
  it('test minimum config with phone contactMethod', async () => {
    await startST()
  ...
  it('test if validatePhoneNumber is called with phone contactMethod', async () => {
    await startST()
  ...
  it('test createAndSendCustomTextMessage with flowType: USER_INPUT_CODE and phone contact method', async () => {
    await startST()
  ...
  it('test createAndSendCustomTextMessage with flowType: MAGIC_LINK and phone contact method', async () => {
    await startST()
  ...
  /*  contactMethod: PHONE
    ...
    */
  it('test createAndSendCustomTextMessage with flowType: USER_INPUT_CODE_AND_MAGIC_LINK and phone contact method', async () => {
    await startST()
  ...
  it('test createAndSendCustomTextMessage, if error is thrown, it should contain a general error in the response', async () => {
    await startST()
  ...
  it('test minimum config with email contactMethod', async () => {
    await startST()
  ...
  it('test if validateEmailAddress is called with email contactMethod', async () => {
    await startST()
  ...
  it('test createAndSendCustomEmail with flowType: USER_INPUT_CODE and email contact method', async () => {
    await startST()
  ...
  it('test createAndSendCustomEmail with flowType: MAGIC_LINK and email contact method', async () => {
    await startST()
  ...
  /*  contactMethod: EMAIL
        If passed createAndSendCustomEmail, it gets called with the right inputs:
            - flowType: USER_INPUT_CODE_AND_MAGIC_LINK -> userInputCode !== undefined && urlWithLinkCode !== undefined
    */
  it('test createAndSendCustomTextMessage with flowType: USER_INPUT_CODE_AND_MAGIC_LINK and email contact method', async () => {
    await startST()
  ...
  it('test createAndSendCustomEmail, if error is thrown, the status in the response should be a general error', async () => {
    await startST()
  ...
  it('test missing compulsory configs throws an error', async () => {
    await startST()
  ...
  it('test passing getCustomUserInputCode using different codes', async () => {
    await startST()
  ...
  it('test passing getCustomUserInputCode using the same code', async () => {
    await startST()
    ...
    const createNewCodeForDeviceResponse = await Passwordless.createNewCodeForDevice({
      deviceId: createCodeResponse.deviceId,
  ...
  it('test basic override usage in passwordless', async () => {
    await startST()
