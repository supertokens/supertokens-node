...
describe(`apisFunctions: ${printPath('[test/passwordless/apis.test.js]')}`, () => {
  ...
  it('test the sign up /in flow with email using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test the sign up /in flow with phoneNumber using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  /**
     ...
     */
  it('test creating a code with email and then resending the code and check that the sending custom email function is called while using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  /**
     ...
     */
  it('test creating a code with phone and then resending the code and check that the sending custom SMS function is called while using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  /**
     ...
     */
  it('test invalid input to createCodeAPI while using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test adding phoneNumber to a users info and signing in will sign in the same user, using the EMAIL_OR_PHONE contactMethod', async () => {
    await startST()
  ...
  it('test not passing any fields to consumeCodeAPI', async () => {
    await startST()
  ...
  it('test consumeCodeAPI with magic link', async () => {
    await startST()
  ...
  it('test consumeCodeAPI with code', async () => {
    await startST()
  ...
  it('test consumeCodeAPI with expired code', async () => {
  ...
  it('test createCodeAPI with email', async () => {
    await startST()
  ...
  it('test createCodeAPI with phoneNumber', async () => {
    await startST()
  ...
  it('test magicLink format in createCodeAPI', async () => {
    await startST()
  ...
  it('test phoneNumberExistsAPI', async () => {
    await startST()
  ...
  it('test resendCodeAPI when changing contact method', async () => {
    await startST()
