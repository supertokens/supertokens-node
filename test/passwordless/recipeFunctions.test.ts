...
describe(`recipeFunctions: ${printPath('[test/passwordless/recipeFunctions.test.js]')}`, () => {
  ...
  it('getUser test', async () => {
...

    {
      ...
      const result = await Passwordless.getUserById({
        userId: user.id,
      })
...

    {
      ...
      const result = await Passwordless.getUserByEmail({
        email: user.email,
      })
...

    {
      ...
      const result = await Passwordless.getUserByPhoneNumber({
  ...
  it('createCode test', async () => {
    ...
    {
      const resp = await Passwordless.createCode({
        email: 'test@example.com',
      })
  ...
  it('createNewCodeForDevice test', async () => {
    await startST()
  ...
  it('consumeCode test', async () => {
...

    {
      ...
      const resp = await Passwordless.consumeCode({
  ...
  it('consumeCode test with EXPIRED_USER_INPUT_CODE_ERROR', async () => {
  ...
  // updateUser
  it('updateUser contactMethod email test', async () => {
    await startST()
    ...
    const userInfo = await Passwordless.signInUp({
      email: 'test@example.com',
    })
    ...
    }
    {
      ...
      const userInfo2 = await Passwordless.signInUp({
  ...
  it('updateUser contactMethod phone test', async () => {
    await startST()
  ...
  it('revokeAllCodes test', async () => {
    ...
    const codeInfo_1 = await Passwordless.createCode({
      email: 'test@example.com',
    })

    const codeInfo_2 = await Passwordless.createCode({
      email: 'test@example.com',
    })

    {
      const result = await Passwordless.revokeAllCodes({
        email: 'test@example.com',
      })
    ...
    {
      const result_1 = await Passwordless.consumeCode({
      ...
      const result_2 = await Passwordless.consumeCode({
  ...
  it('revokeCode test', async () => {
    ...
    {
      const result = await Passwordless.revokeCode({
  ...
  // listCodesByEmail
  it('listCodesByEmail test', async () => {
    await startST()
    ...
    const result = await Passwordless.listCodesByEmail({
      email: 'test@example.com',
    })
  ...
  it('listCodesByPhoneNumber test', async () => {
    await startST()
    ...
    const result = await Passwordless.listCodesByPhoneNumber({
      phoneNumber: '+1234567890',
    })
    assert(result.length === 2)
    result.forEach((element) => {
  ...
  it('listCodesByDeviceId and listCodesByPreAuthSessionId test', async () => {
    await startST()
    ...
    {
      const result = await Passwordless.listCodesByDeviceId({
        deviceId: codeInfo_1.deviceId,
      })
    ...
    {
      const result = await Passwordless.listCodesByPreAuthSessionId({
        preAuthSessionId: codeInfo_1.preAuthSessionId,
      })
      assert(result.codes[0].codeId === codeInfo_1.codeId)
    }
  ...
  it('createMagicLink test', async () => {
    ...
    const result = await Passwordless.createMagicLink({
      phoneNumber: '+1234567890',
    })
