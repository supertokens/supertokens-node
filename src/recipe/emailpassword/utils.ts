...
import {
  ...
  TypeNormalisedInputSignIn, TypeNormalisedInputSignUp,
} from './types'
...
export function validateAndNormaliseUserInput(
  ...
  const signInFeature = validateAndNormaliseSignInConfig(recipeInstance, appInfo, signUpFeature)

  const resetPasswordUsingTokenFeature = validateAndNormaliseResetPasswordUsingTokenConfig(signUpFeature)
...
function validateAndNormaliseResetPasswordUsingTokenConfig(
  ...
  const formFieldsForPasswordResetForm: NormalisedFormField[] = signUpConfig.formFields
  ...
  const formFieldsForGenerateTokenForm: NormalisedFormField[] = signUpConfig.formFields
...
function validateAndNormaliseSignInConfig(
  ...
  const formFields: NormalisedFormField[] = normaliseSignInFormFields(signUpConfig.formFields)
...
export function normaliseSignUpFormFields(formFields?: TypeInputFormField[]): NormalisedFormField[] {
  const normalisedFormFields: NormalisedFormField[] = []
