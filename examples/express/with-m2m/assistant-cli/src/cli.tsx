...
import { addEvent, getEvents, deleteEvent, AssistantEvent, updateEvent } from "./eventFunctions.js";
import { addNote, AssistantNote, deleteNote, getNotes, updateNote } from "./noteFunctions.js";
