...
-   Changes to emailpassword, emailverification and thirdparty functions to not return errors implicitly: https://github.com/supertokens/supertokens-node/issues/167
